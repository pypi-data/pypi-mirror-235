...
class Result(
    ...
    def recreate(self, target_bundle: "momotor.bundles.Bundle", *, step_id: str = None) -> "Result":
    ...
    def _create_from_node(self, node: ResultComplexType, results: ResultsComplexType = None, *,
