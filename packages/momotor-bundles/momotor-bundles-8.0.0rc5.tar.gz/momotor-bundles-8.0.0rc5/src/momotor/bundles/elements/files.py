...
class File(
    ...
    def _clone(self, other: Self, class_: typing.Optional[str], name: typing.Union[str, PurePosixPath, None]) -> Self:
    ...
    def recreate(self, target_bundle: "momotor.bundles.Bundle", *,
                 class_: str = None, name: typing.Union[str, PurePosixPath] = None) -> Self:
...
class FilesMixin(SrcAttachmentsMixin[File]):
    ...
    @files.setter
    def files(self: typing.Union[ElementMixinProtocol, Self],
