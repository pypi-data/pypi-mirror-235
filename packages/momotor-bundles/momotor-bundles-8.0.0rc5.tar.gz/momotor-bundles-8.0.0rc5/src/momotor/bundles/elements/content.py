...
class ContentElementBase(typing.Generic[CT, PCT, PT], NestedElement[CT, PCT], NameStrMixin, ABC):
    ...
    def _create_content(self, *, name: str = None, value: PT = NO_CONTENT) -> Self:
    ...
    def _clone_content(self, other: Self, *, name: str = None) -> Self:
    ...
    def _process_value(self) -> tuple[PT, typing.Optional[str]]:
...
class ContentFullElement(typing.Generic[CT, PCT], ContentElementBase[ContentFullProcessedType, CT, PCT], ABC):
    ...
    @type_.setter
    def type_(self, type_: typing.Optional[str]):
