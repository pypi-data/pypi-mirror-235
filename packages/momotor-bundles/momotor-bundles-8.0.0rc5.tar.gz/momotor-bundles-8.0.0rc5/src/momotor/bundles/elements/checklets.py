...
class Checklet(
    ...
    @typing.final
    @property
    def indices(self) -> typing.Optional[list[Link]]:
    ...
    def create(self,
               ...
               resources: typing.Iterable[Resource] = None) -> Self:
    ...
    def _create_from_node(self, node: CheckletComplexType, parent: CheckletsComplexType = None, *,
