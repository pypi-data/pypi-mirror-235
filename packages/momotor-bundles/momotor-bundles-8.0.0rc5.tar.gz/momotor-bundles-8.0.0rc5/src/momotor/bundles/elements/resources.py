...
class Resource(ContentBasicElement[ResourceComplexType, ResourcesComplexType]):
    ...
    def create(self, *, name: str, value: str = None) -> Self:
        self._create_content(name=name, value=value)
        return self

    def recreate(self, target_bundle: "momotor.bundles.Bundle", *, name: str = None) -> "Resource":
...
class ResourcesMixin:
    ...
    _resources_by_name: typing.Optional[dict[str, ResourcesType]] = None
    ...
    @resources.setter
    def resources(self: typing.Union[ElementMixinProtocol, Self],
