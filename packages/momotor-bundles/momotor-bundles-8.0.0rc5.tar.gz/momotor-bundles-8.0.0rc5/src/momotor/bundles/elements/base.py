...
class Element(typing.Generic[CT], ABC):
    ...
    def recreate_list(cls,
                      elements: typing.Optional[typing.Iterable[Self]],
                      target_bundle: "momotor.bundles.Bundle",
                      filter: typing.Callable[[Self], bool] = None,
                      **kwargs) -> typing.Optional[list[Self]]:
...
class NestedElement(Element[CT], typing.Generic[CT, PCT], ABC):
    ...
    @abc.abstractmethod
    def _create_from_node(self, node: CT, direct_parent: PCT, ref_parent: PCT = None, *,
                          args: BundleFactoryArguments) -> Self:
        """ Set this element's attributes from an XML dom node
    ...
    def _get_attr_base_parts(self, attr: str, node: CT, direct_parent: PCT, ref_parent: typing.Optional[PCT],
                             ...
                             base_attr: str = None,
                             allow_base_only=False) -> typing.Optional[tuple[str, ...]]:
