...
class SrcAttachmentMixin:
    ...
    @src.setter
    def src(self: typing.Union[ElementMixinProtocol, Self],
    ...
    # noinspection PyProtectedMember
    @property
    def absolute_path(self: typing.Union[ElementMixinProtocol, Self]) -> Path:
        path = self.src
        if path is None:
    ...
    def is_dir(self: typing.Union[ElementMixinProtocol, Self],
    ...
    @typing.overload
    def iterdir(self: typing.Union[ElementMixinProtocol, Self], *, include_empty_root: bool = False) \
            -> typing.Generator[PurePosixPath, None, None]:
        ...

    @typing.overload
    def iterdir(self: typing.Union[ElementMixinProtocol, Self], *, include_empty_root: bool = True) \
    ...
    def open(self: typing.Union[ElementMixinProtocol, Self],
    ...
    def _copy_file(self: typing.Union[ElementMixinProtocol, Self], dest_path: Path):
        self.__copy_file_obj(None, dest_path)

    def _copy_dir(self: typing.Union[ElementMixinProtocol, Self], dest_path: Path):
    ...
    def _copy_file_zip(self: typing.Union[ElementMixinProtocol, Self], dest_path: PurePath,
                       dst_zip_file: zipfile.ZipFile, args: FileConstructionArguments):
        self.__copy_file_obj_zip(None, dest_path, dst_zip_file, args)

    def _copy_dir_zip(self: typing.Union[ElementMixinProtocol, Self], dest_path: PurePath,
                      dst_zip_file: zipfile.ZipFile, args: FileConstructionArguments):
        for name in self.iterdir(include_empty_root=True):
            self.__copy_file_obj_zip(name, (dest_path / name) if name else dest_path, dst_zip_file, args)

    def file_size(self: typing.Union[ElementMixinProtocol, Self],
    ...
    def file_ctime(self: typing.Union[ElementMixinProtocol, Self],
    ...
    # noinspection PyProtectedMember
    def _export_path(self: typing.Union[ElementMixinProtocol, Self], path: PurePosixPath) \
            -> PurePosixPath:
