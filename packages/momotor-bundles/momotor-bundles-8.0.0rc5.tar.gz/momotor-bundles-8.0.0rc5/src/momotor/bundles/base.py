...
def _merge_args(cls: type[AT], args: typing.Optional[AT], kwargs: typing.Mapping) -> AT:
...
class Bundle(Element[CT], typing.Generic[CT], ABC):
    ...
    @classmethod
    def from_file_factory(cls, path: typing.Union[str, pathlib.Path], *,
                          args: BundleFactoryArguments = None, **kwargs) -> Self:
    ...
    @classmethod
    def from_bytes_factory(cls, data: typing.Union[bytes, memoryview], *,
                           args: BundleFactoryArguments = None, **kwargs) -> Self:
    ...
    def detect(cls, path_or_data: typing.Union[pathlib.Path, bytes, memoryview],
               *, args: BundleFactoryArguments = None, **kwargs) -> type["Bundle"]:
