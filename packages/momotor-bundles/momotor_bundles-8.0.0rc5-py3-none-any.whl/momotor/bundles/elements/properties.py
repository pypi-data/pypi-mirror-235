...
class Property(
    ...
    def _clone(self, other: Self, name: typing.Optional[str]) -> Self:
        self._clone_content(other, name=name)
        self.accept = other.accept
        self.attrs = other.attrs
        return self

    def recreate(self, target_bundle: "momotor.bundles.Bundle", *, name: str = None) -> "Property":
...
class PropertiesMixin:
    ...
    _properties_by_name: typing.Optional[dict[str, PropertiesType]] = None
    ...
    @properties.setter
    def properties(self: typing.Union[ElementMixinProtocol, Self],
