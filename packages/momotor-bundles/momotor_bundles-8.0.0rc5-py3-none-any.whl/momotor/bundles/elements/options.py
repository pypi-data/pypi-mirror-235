...
class Option(
    ...
    _domain: str = __unset
    _domain_parts: tuple[str, typing.Optional[str]] = __unset
    ...
    @property
    def domain_parts(self) -> tuple[str, typing.Optional[str]]:
    ...
    def create(self, *,
               ...
               attrs: typing.Mapping[str, str] = None) -> Self:
    ...
    def _clone(self, other: Self, name: typing.Optional[str], domain: typing.Optional[str]) -> Self:
    ...
    def recreate(self, target_bundle: "momotor.bundles.Bundle", *, name: str = None, domain: str = None) -> "Option":
...
class OptionsMixin:
    ...
    _options_by_domain_name: typing.Optional[dict[tuple[str, str], OptionsType]] = None
    ...
    @options.setter
    def options(self: typing.Union[ElementMixinProtocol, Self],
