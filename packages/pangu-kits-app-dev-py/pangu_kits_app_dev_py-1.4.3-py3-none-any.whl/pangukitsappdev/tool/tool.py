...
from typing import Optional, Type, List, Union, Callable, Any
from pydantic import BaseModel
from pangukitsappdev.prompt.prompt_tmpl import PromptTemplates
from pangukitsappdev.api.tool.base import AbstractTool, PanguFunction, MARK_PLUGIN, DEFAULT_SINGLE_ARG
...
class Tool(AbstractTool):
    ...
    def build_tool_schema(desc: str, class_type: Union[Type, BaseModel]):
        if class_type in [int, float, str, bool, List, dict]:
    ...
    def build_pangu_function(self):
        return PanguFunction(name=MARK_PLUGIN + self.get_tool_id(),
