...
class coef: 
    def __init__(self,year,lulucf=True):
        ...
        self.total_production_by_activity()
        self.coefficients()
    def leontief_inverse_matrix_67(self):
    	...
    	self.sys = sys
    def total_production_by_activity(self):
    ...
    def coefficients(self):   	
    	...
    	coef67['sum_carteira_ativa'] = (coef67['sum_carteira_ativa'] / 1000000)#transform brl to mi brl
    	if self.lulucf == True:
    	...
    	coef67.rename(columns={'Valor da produção': 'production_values_mi_brl'}, inplace=True)
    	coef67.rename(columns={'sum_carteira_ativa': 'active_loan_portfolio_mi_brl'}, inplace=True)
    	self.coef67 = coef67
