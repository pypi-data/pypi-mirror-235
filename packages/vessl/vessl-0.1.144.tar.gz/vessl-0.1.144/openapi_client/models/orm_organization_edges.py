...
class OrmOrganizationEdges(object):
    ...
    def __init__(self, artifacts=None, billing_histories=None, cluster_quotas=None, credit_earn_histories=None, default_storage=None, default_volume=None, groups=None, kernel_clusters=None, model_services=None, organization_credentials=None, organization_kernel_clusters=None, organization_policies=None, owner=None, pipeline_step_types=None, pricing_plan=None, primary_owner=None, root_organization_policies=None, stripe_billing_history=None, user_organization=None, withdraw_history_kernel_clusters=None, withdraw_history_organizations=None, workloads=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
