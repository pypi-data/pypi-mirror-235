...
from aimos._sdk.types import QueryReportMode
...
def runs_search_fn(repo,
    ...
    from aimos._sdk.sequence_collection import QueryRunSequenceCollection
...
def metrics_search_fn(repo,
                      ...
                      *,
                      ...
                      report_progress: Optional[bool] = True,
                      x_timezone_offset: int = Header(default=0),):
    from aimos._sdk.sequences.metric import Metric
    from aimos._sdk.sequence_collection import QuerySequenceCollection
