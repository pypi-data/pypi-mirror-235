...
def getglobalconfigspath(): os.path.join(gl.apphome, gl.analysesfolder, ANALYSES_CONFIGS_FOLDER)
def getglobalconfigsrelativepath(): os.path.join(gl.analysesfolder, ANALYSES_CONFIGS_FOLDER)
