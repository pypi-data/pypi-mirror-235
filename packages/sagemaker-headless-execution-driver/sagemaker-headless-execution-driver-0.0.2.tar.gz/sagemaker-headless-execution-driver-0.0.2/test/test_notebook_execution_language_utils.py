...
from headless_execution.notebookrunner import NotebookExecutionLanguageUtils
import json


class TestNotebookExecutionLanguageUtils(unittest.TestCase):
    @patch("headless_execution.notebookrunner.KernelSpecManager")
    ...
    @patch("headless_execution.notebookrunner.nbformat")
