...
class DatasetDataset(object):
    ...
    def __init__(self, name=None, dataset_id=None, project_ids=None, creator_id=None, creation_time=None, user_metadata=None, integration_id=None, data_info=None, ct_info=None, validity_status=None, marked_for_delete_at=None, validity_status_message=None):  # noqa: E501
