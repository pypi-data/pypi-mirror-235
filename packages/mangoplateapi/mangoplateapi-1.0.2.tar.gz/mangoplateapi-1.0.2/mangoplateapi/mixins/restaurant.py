...
class RestaurantMixin:
    def search_restaurants(self, keyword, page_no, page_size):
    ...
    def search_restaurants_count(self, keyword, page_no, page_size):
    ...
    def _parse_related_tags(self, code):
        """
