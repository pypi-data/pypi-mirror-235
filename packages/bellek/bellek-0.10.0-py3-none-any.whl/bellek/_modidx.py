  ...
  'syms': { 'bellek.ml.clip': { 'bellek.ml.clip.ClipClassificationHead': ('ml.clip.html#clipclassificationhead', 'bellek/ml/clip.py'),
            ...
            'bellek.ml.kg.cons': { 'bellek.ml.kg.cons.evaluate_joint_er_extraction': ( 'ml.kg.cons.html#evaluate_joint_er_extraction',
                                   ...
                                   'bellek.ml.kg.cons.evaluate_joint_er_extractions': ( 'ml.kg.cons.html#evaluate_joint_er_extractions',
                                                                                        'bellek/ml/kg/cons.py')},
            'bellek.ml.kg.dataset': { 'bellek.ml.kg.dataset._transform_webnlg': ( 'ml.kg.dataset.html#_transform_webnlg',
                                                                                  'bellek/ml/kg/dataset.py'),
                                      'bellek.ml.kg.dataset.transform_webnlg': ( 'ml.kg.dataset.html#transform_webnlg',
                                                                                 'bellek/ml/kg/dataset.py')},
