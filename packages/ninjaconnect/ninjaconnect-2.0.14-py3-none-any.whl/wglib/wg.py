...
class Wireguard:
    ...
    def configure(self):
        try:
            if self.isinstalled():
                print(
                    "[bold green1]:small_Blue_Diamond: Already WireGuard installed [/bold green1]:Thumbs_Up:"
                )
                print("[bold red1]:No_entry: Note : You Configure again the old configrations will be deleted[/bold red1]")
                reconf = Prompt.ask("[bold green1]:small_Blue_Diamond: Do you want to  configure again (Y/N) :[/bold green1]")
                if reconf == "y":
                    self.newconfigure()
                elif reconf == "n":
            ...
            print(f"Keyboard interrupted{e}")
    ...
    def add_device(self):
        ...
        print(f"[bold red1]:small_blue_diamond: No of connected device in labs {connected_device}[/bold red1]")
