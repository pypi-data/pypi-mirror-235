...
from azureml.metrics.common.import_utilities import \
    load_rag_evaluation_speaker, load_rag_evaluation_helper_methods
...
class RagEvaluationMetric(Metric):
    ...
    def init_config(self):
        ...
        init_llm, LLMMetrics = load_rag_evaluation_helper_methods()
