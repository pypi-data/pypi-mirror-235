...
SENTRY_IO_DSN = 'https://e6e783d6407e9e1d2b340f914dd88d60@desired-seasnail-discrete.ngrok-free.app/4'
...
class Envs(BaseEnum):
    ...
    METRICS_OFF = (
        f'{NAME.upper()}_METRICS_OFF',
        'If this is set, usage metrics and error reporting will be turned off. Metrics are on by default.'
    )
