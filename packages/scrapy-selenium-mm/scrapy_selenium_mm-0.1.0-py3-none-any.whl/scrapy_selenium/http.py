...
class SeleniumRequest(Request):
    ...
    def __init__(self, wait_time=None, wait_until=None, screenshot=False, script=None, script_execution_pause=None, *args, **kwargs):
        ...
        self.script = script
        self.script_execution_pause = script_execution_pause
