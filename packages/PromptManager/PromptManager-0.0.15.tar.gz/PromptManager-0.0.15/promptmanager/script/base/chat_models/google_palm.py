...
from promptmanager.script.base.pydantic_v1 import BaseModel, root_validator
...
def _response_to_result(
    ...
    """Converts a PaLM API response into a Promptmanager ChatResult."""
...
def _messages_to_prompt_dict(
    ...
    """Converts a list of Promptmanager messages into a PaLM API MessagePrompt structure."""
    import google.generativeai as genai
...
class ChatGooglePalm(BaseChatModel, BaseModel):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.chat_models import ChatGooglePalm
            chat = ChatGooglePalm()
