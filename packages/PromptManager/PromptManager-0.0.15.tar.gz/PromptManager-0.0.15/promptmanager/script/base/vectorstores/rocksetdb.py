...
class Rockset(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import Rockset
            ...
            collection_name = "promptmanager_demo"
    ...
    def __init__(
        ...
        Args:
            ...
            embeddings: Promptmanager Embeddings object to use to generate
        ...
        try:
            self._client.set_application("promptmanager")
