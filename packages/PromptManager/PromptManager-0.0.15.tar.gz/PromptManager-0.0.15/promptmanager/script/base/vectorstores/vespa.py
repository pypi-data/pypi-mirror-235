...
from promptmanager.script.base.vectorstores.base import PMVectorDB, VectorStoreRetriever


class VespaStore(PMVectorDB):
    """
    `Vespa` vector store.
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import VespaStore
            ...
            # You need to instruct Promptmanager on which fields to use for embeddings
            vespa_config = dict(
