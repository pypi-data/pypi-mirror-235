...
from promptmanager.script.base.docstore.base import AddableMixin, Docstore
...
class FAISS(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            texts = ["FAISS is an important library", "Promptmanager supports FAISS"]
