...
class Bagel(PMVectorDB):
    ...
    Example:
        .. code-block:: python
                ...
                from promptmanager.script.base.vectorstores import Bagel
                vectorstore = Bagel(cluster_name="promptmanager_store")
    """

    _PM_DEFAULT_CLUSTER_NAME = "promptmanager"

    def __init__(
        self,
        cluster_name: str = _PM_DEFAULT_CLUSTER_NAME,
