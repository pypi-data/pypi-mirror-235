...
from promptmanager.script.base.chains.query_constructor.base import load_query_constructor_chain
from promptmanager.script.base.chains.query_constructor.ir import StructuredQuery, Visitor
from promptmanager.script.base.chains.query_constructor.schema import AttributeInfo
from promptmanager.script.base.pydantic_v1 import BaseModel, Field, root_validator
from promptmanager.script.base.retrievers.self_query.chroma import ChromaTranslator
from promptmanager.script.base.retrievers.self_query.dashvector import DashvectorTranslator
from promptmanager.script.base.retrievers.self_query.deeplake import DeepLakeTranslator
from promptmanager.script.base.retrievers.self_query.elasticsearch import ElasticsearchTranslator
from promptmanager.script.base.retrievers.self_query.milvus import MilvusTranslator
from promptmanager.script.base.retrievers.self_query.myscale import MyScaleTranslator
from promptmanager.script.base.retrievers.self_query.opensearch import OpenSearchTranslator
from promptmanager.script.base.retrievers.self_query.pinecone import PineconeTranslator
from promptmanager.script.base.retrievers.self_query.qdrant import QdrantTranslator
from promptmanager.script.base.retrievers.self_query.redis import RedisTranslator
from promptmanager.script.base.retrievers.self_query.supabase import SupabaseVectorTranslator
from promptmanager.script.base.retrievers.self_query.timescalevector import TimescaleVectorTranslator
from promptmanager.script.base.retrievers.self_query.vectara import VectaraTranslator
from promptmanager.script.base.retrievers.self_query.weaviate import WeaviateTranslator
...
from promptmanager.script.base.vectorstores import (
    Chroma,
    DashVector,
    DeepLake,
    ElasticsearchStore,
...
def _get_builtin_translator(vectorstore: PMVectorDB) -> Visitor:
    """Get the translator class corresponding to the vector store class."""
    BUILTIN_TRANSLATORS: Dict[Type[PMVectorDB], Type[Visitor]] = {
