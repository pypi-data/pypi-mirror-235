...
from promptmanager.script.base.indexes.base import NAMESPACE_UUID, RecordManager
...
def index(
    ...
    *,
    ...
    if type(vector_store).delete == PMVectorDB.delete:
...
async def aindex(
    ...
    *,
    ...
    if type(vector_store).adelete == PMVectorDB.adelete:
        # Checking if the vectorstore has overridden the default delete method
        # implementation which just raises a NotImplementedError
        raise ValueError("Vectorstore has not implemented the delete method")
