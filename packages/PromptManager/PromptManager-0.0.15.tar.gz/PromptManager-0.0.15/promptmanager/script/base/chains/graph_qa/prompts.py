...
EXAMPLE
i'm trying to improve Promptmanager's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff.
Output: Promptmanager
END OF EXAMPLE

EXAMPLE
i'm trying to improve Promptmanager's interfaces, the UX, its integrations with various products the user might want ... a lot of stuff. I'm working with Sam.
Output: Promptmanager, Sam
END OF EXAMPLE
