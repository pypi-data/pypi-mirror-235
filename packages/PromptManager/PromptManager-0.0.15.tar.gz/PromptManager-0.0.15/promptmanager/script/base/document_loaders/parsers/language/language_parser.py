...
from promptmanager.script.base.document_loaders.parsers.language.javascript import JavaScriptSegmenter
from promptmanager.script.base.document_loaders.parsers.language.python import PythonSegmenter
from promptmanager.script.base.text_splitter import Language
...
class LanguageParser(BaseBlobParser):
    ...
    Examples:
       ...
       .. code-block:: python
            ...
            from promptmanager.script.base.text_splitter.Language
            from promptmanager.script.base.document_loaders.generic import GenericLoader
            from promptmanager.script.base.document_loaders.parsers import LanguageParser
