...
def _import_ai21() -> Any:
    from promptmanager.script.base.llms.ai21 import AI21

    return AI21


def _import_aleph_alpha() -> Any:
    from promptmanager.script.base.llms.aleph_alpha import AlephAlpha

    return AlephAlpha


def _import_amazon_api_gateway() -> Any:
    from promptmanager.script.base.llms.amazon_api_gateway import AmazonAPIGateway

    return AmazonAPIGateway


def _import_anthropic() -> Any:
    from promptmanager.script.base.llms.anthropic import Anthropic

    return Anthropic


def _import_anyscale() -> Any:
    from promptmanager.script.base.llms.anyscale import Anyscale

    return Anyscale


def _import_aviary() -> Any:
    from promptmanager.script.base.llms.aviary import Aviary

    return Aviary


def _import_azureml_endpoint() -> Any:
    from promptmanager.script.base.llms.azureml_endpoint import AzureMLOnlineEndpoint

    return AzureMLOnlineEndpoint


def _import_baidu_qianfan_endpoint() -> Any:
    from promptmanager.script.base.llms.baidu_qianfan_endpoint import QianfanLLMEndpoint

    return QianfanLLMEndpoint


def _import_bananadev() -> Any:
    from promptmanager.script.base.llms.bananadev import Banana

    return Banana


def _import_baseten() -> Any:
    from promptmanager.script.base.llms.baseten import Baseten

    return Baseten


def _import_beam() -> Any:
    from promptmanager.script.base.llms.beam import Beam

    return Beam


def _import_bedrock() -> Any:
    from promptmanager.script.base.llms.bedrock import Bedrock

    return Bedrock


def _import_bittensor() -> Any:
    from promptmanager.script.base.llms.bittensor import NIBittensorLLM

    return NIBittensorLLM


def _import_cerebriumai() -> Any:
    from promptmanager.script.base.llms.cerebriumai import CerebriumAI

    return CerebriumAI


def _import_chatglm() -> Any:
    from promptmanager.script.base.llms.chatglm import ChatGLM

    return ChatGLM


def _import_clarifai() -> Any:
    from promptmanager.script.base.llms.clarifai import Clarifai

    return Clarifai


def _import_cohere() -> Any:
    from promptmanager.script.base.llms.cohere import Cohere

    return Cohere


def _import_ctransformers() -> Any:
    from promptmanager.script.base.llms.ctransformers import CTransformers

    return CTransformers


def _import_ctranslate2() -> Any:
    from promptmanager.script.base.llms.ctranslate2 import CTranslate2

    return CTranslate2


def _import_databricks() -> Any:
    from promptmanager.script.base.llms.databricks import Databricks

    return Databricks


def _import_deepinfra() -> Any:
    from promptmanager.script.base.llms.deepinfra import DeepInfra

    return DeepInfra


def _import_deepsparse() -> Any:
    from promptmanager.script.base.llms.deepsparse import DeepSparse

    return DeepSparse


def _import_edenai() -> Any:
    from promptmanager.script.base.llms.edenai import EdenAI

    return EdenAI


def _import_fake() -> Any:
    from promptmanager.script.base.llms.fake import FakeListLLM

    return FakeListLLM


def _import_fireworks() -> Any:
    from promptmanager.script.base.llms.fireworks import Fireworks

    return Fireworks


def _import_forefrontai() -> Any:
    from promptmanager.script.base.llms.forefrontai import ForefrontAI

    return ForefrontAI


def _import_google_palm() -> Any:
    from promptmanager.script.base.llms.google_palm import GooglePalm

    return GooglePalm


def _import_gooseai() -> Any:
    from promptmanager.script.base.llms.gooseai import GooseAI

    return GooseAI


def _import_gpt4all() -> Any:
    from promptmanager.script.base.llms.gpt4all import GPT4All

    return GPT4All


def _import_gradient_ai() -> Any:
    from promptmanager.script.base.llms.gradient_ai import GradientLLM

    return GradientLLM


def _import_huggingface_endpoint() -> Any:
    from promptmanager.script.base.llms.huggingface_endpoint import HuggingFaceEndpoint

    return HuggingFaceEndpoint


def _import_huggingface_hub() -> Any:
    from promptmanager.script.base.llms.huggingface_hub import HuggingFaceHub
...
def _import_huggingface_text_gen_inference() -> Any:
    from promptmanager.script.base.llms.huggingface_text_gen_inference import (
...
def _import_javelin_ai_gateway() -> Any:
    from promptmanager.script.base.llms.javelin_ai_gateway import JavelinAIGateway

    return JavelinAIGateway


def _import_koboldai() -> Any:
    from promptmanager.script.base.llms.koboldai import KoboldApiLLM

    return KoboldApiLLM


def _import_llamacpp() -> Any:
    from promptmanager.script.base.llms.llamacpp import LlamaCpp

    return LlamaCpp


def _import_manifest() -> Any:
    from promptmanager.script.base.llms.manifest import ManifestWrapper
...
def _import_mlflow_ai_gateway() -> Any:
    from promptmanager.script.base.llms.mlflow_ai_gateway import MlflowAIGateway

    return MlflowAIGateway


def _import_modal() -> Any:
    from promptmanager.script.base.llms.modal import Modal

    return Modal


def _import_mosaicml() -> Any:
    from promptmanager.script.base.llms.mosaicml import MosaicML

    return MosaicML


def _import_nlpcloud() -> Any:
    from promptmanager.script.base.llms.nlpcloud import NLPCloud

    return NLPCloud


def _import_octoai_endpoint() -> Any:
    from promptmanager.script.base.llms.octoai_endpoint import OctoAIEndpoint

    return OctoAIEndpoint


def _import_ollama() -> Any:
    from promptmanager.script.base.llms.ollama import Ollama

    return Ollama


def _import_opaqueprompts() -> Any:
    from promptmanager.script.base.llms.opaqueprompts import OpaquePrompts

    return OpaquePrompts


def _import_azure_openai() -> Any:
    from promptmanager.script.base.llms.openai import AzureOpenAI
...
def _import_openai_chat() -> Any:
    from promptmanager.script.base.llms.openai import OpenAIChat

    return OpenAIChat


def _import_openllm() -> Any:
    from promptmanager.script.base.llms.openllm import OpenLLM

    return OpenLLM


def _import_openlm() -> Any:
    from promptmanager.script.base.llms.openlm import OpenLM

    return OpenLM


def _import_petals() -> Any:
    from promptmanager.script.base.llms.petals import Petals

    return Petals


def _import_pipelineai() -> Any:
    from promptmanager.script.base.llms.pipelineai import PipelineAI

    return PipelineAI


def _import_predibase() -> Any:
    from promptmanager.script.base.llms.predibase import Predibase

    return Predibase


def _import_predictionguard() -> Any:
    from promptmanager.script.base.llms.predictionguard import PredictionGuard

    return PredictionGuard


def _import_promptlayer() -> Any:
    from promptmanager.script.base.llms.promptlayer_openai import PromptLayerOpenAI

    return PromptLayerOpenAI


def _import_promptlayer_chat() -> Any:
    from promptmanager.script.base.llms.promptlayer_openai import PromptLayerOpenAIChat

    return PromptLayerOpenAIChat


def _import_replicate() -> Any:
    from promptmanager.script.base.llms.replicate import Replicate

    return Replicate


def _import_rwkv() -> Any:
    from promptmanager.script.base.llms.rwkv import RWKV

    return RWKV


def _import_sagemaker_endpoint() -> Any:
    from promptmanager.script.base.llms.sagemaker_endpoint import SagemakerEndpoint

    return SagemakerEndpoint


def _import_self_hosted() -> Any:
    from promptmanager.script.base.llms.self_hosted import SelfHostedPipeline

    return SelfHostedPipeline


def _import_self_hosted_hugging_face() -> Any:
    from promptmanager.script.base.llms.self_hosted_hugging_face import SelfHostedHuggingFaceLLM

    return SelfHostedHuggingFaceLLM


def _import_stochasticai() -> Any:
    from promptmanager.script.base.llms.stochasticai import StochasticAI

    return StochasticAI


def _import_symblai_nebula() -> Any:
    from promptmanager.script.base.llms.symblai_nebula import Nebula

    return Nebula


def _import_textgen() -> Any:
    from promptmanager.script.base.llms.textgen import TextGen

    return TextGen


def _import_titan_takeoff() -> Any:
    from promptmanager.script.base.llms.titan_takeoff import TitanTakeoff

    return TitanTakeoff


def _import_tongyi() -> Any:
    from promptmanager.script.base.llms.tongyi import Tongyi

    return Tongyi


def _import_vertex() -> Any:
    from promptmanager.script.base.llms.vertexai import VertexAI

    return VertexAI


def _import_vertex_model_garden() -> Any:
    from promptmanager.script.base.llms.vertexai import VertexAIModelGarden

    return VertexAIModelGarden


def _import_vllm() -> Any:
    from promptmanager.script.base.llms.vllm import VLLM

    return VLLM


def _import_vllm_openai() -> Any:
    from promptmanager.script.base.llms.vllm import VLLMOpenAI

    return VLLMOpenAI


def _import_writer() -> Any:
    from promptmanager.script.base.llms.writer import Writer

    return Writer


def _import_xinference() -> Any:
    from promptmanager.script.base.llms.xinference import Xinference
