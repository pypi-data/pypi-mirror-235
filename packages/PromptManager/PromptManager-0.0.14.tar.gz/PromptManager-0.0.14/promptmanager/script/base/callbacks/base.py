"""Base callback handler that can be used to handle callbacks in promptmanager."""
...
if TYPE_CHECKING:
    ...
    from promptmanager.script.base.schema.output import ChatGenerationChunk, GenerationChunk, LLMResult
...
class BaseCallbackHandler(
    ...
    """Base callback handler that handles callbacks from Promptmanager."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler that handles callbacks from Promptmanager."""
...
class BaseCallbackManager(CallbackManagerMixin):
    """Base callback manager that handles callbacks from Promptmanager."""
