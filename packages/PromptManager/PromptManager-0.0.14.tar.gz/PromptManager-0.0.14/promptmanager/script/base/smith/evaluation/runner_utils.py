...
from promptmanager.script.base.callbacks.manager import Callbacks
from promptmanager.script.base.callbacks.tracers.evaluation import (
...
from promptmanager.script.base.evaluation.loading import load_evaluator
from promptmanager.script.base.evaluation.schema import (
    EvaluatorType,
    PairwiseStringEvaluator,
    StringEvaluator,
)
from promptmanager.script.base.schema import ChatResult, LLMResult
from promptmanager.script.base.schema.language_model import BaseLanguageModel
from promptmanager.script.base.schema.messages import BaseMessage, messages_from_dict
from promptmanager.script.base.schema.runnable import Runnable, RunnableConfig, RunnableLambda
from promptmanager.script.base.schema.runnable import config as runnable_config
from promptmanager.script.base.schema.runnable import utils as runnable_utils
from promptmanager.script.base.smith import evaluation as smith_eval
from promptmanager.script.base.smith.evaluation import config as smith_eval_config
from promptmanager.script.base.smith.evaluation import name_generation, progress
...
def _construct_run_evaluator(
    ...
    if isinstance(evaluator_, StringEvaluator):
        ...
        raise NotImplementedError(
            ...
            "\nSee: https://python.promptmanager.com/docs/guides/evaluation/string/"
        )
...
_INPUT_MAPPER_DEP_WARNING = (
    ...
    "(See https://api.python.promptmanager.com/en/latest/schema/"
    "promptmanager.schema.runnable.base.RunnableLambda.html)"
)
...
.. code-block:: python
    ...
    from promptmanager.script.base.smith import smith_eval.RunEvalConfig, run_on_dataset
...
:class:`StringEvaluator <promptmanager.evaluation.schema.StringEvaluator>`
or LangSmith's `RunEvaluator` classes.

.. code-block:: python

    from typing import Optional
    from promptmanager.script.base.evaluation import StringEvaluator
