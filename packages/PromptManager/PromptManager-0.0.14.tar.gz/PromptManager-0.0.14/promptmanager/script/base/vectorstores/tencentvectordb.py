...
from promptmanager.script.base.utils import guard_import
...
class TencentVectorDB(PMVectorDB):
    ...
    def __init__(
        ...
        database_name: str = "PMDatabase",
        collection_name: str = "PMCollection",
    ...
    def _create_collection(self, collection_name: str) -> None:
        ...
        self.collection = self.database.create_collection(
            ...
            description="Collection for Promptmanager",
            index=index,
        )
