...
from promptmanager.script.base.utils import xor_args
...
class Chroma(PMVectorDB):
    ...
    Example:
        .. code-block:: python
                ...
                vectorstore = Chroma("promptmanager_store", embeddings)
    """
                ...
                try:
                    ...
                    if "Expected metadata value to be" in str(e):
                        msg = (
                            ...
                            "promptmanager.vectorstores.utils.filter_complex_metadata."
                        )
