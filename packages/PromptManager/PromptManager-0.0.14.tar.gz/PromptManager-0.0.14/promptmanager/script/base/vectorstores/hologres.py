...
_PM_DEFAULT_TABLE_NAME = "Promptmanager_pg_embedding"
...
class Hologres(PMVectorDB):
    ...
    - `table_name` is the name of the table to store embeddings and data.
        (default: Promptmanager_pg_embedding)
    ...
    def __init__(
        ...
        table_name: str = _PM_DEFAULT_TABLE_NAME,
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from promptmanager.script.base.vectorstores import Hologres
