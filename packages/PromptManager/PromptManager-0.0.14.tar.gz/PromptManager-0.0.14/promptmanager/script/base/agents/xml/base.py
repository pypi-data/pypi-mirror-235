...
from promptmanager.script.base.agents.xml.prompt import agent_instructions
from promptmanager.script.base.callbacks.base import Callbacks
from promptmanager.script.base.chains.llm import LLMChain
from promptmanager.script.base.prompts.chat import AIMessagePromptTemplate, ChatPromptTemplate
from promptmanager.script.base.schema import AgentAction, AgentFinish
...
class XMLAgent(BaseSingleActionAgent):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from promptmanager.script.base.agents import XMLAgent
            from promptmanager
