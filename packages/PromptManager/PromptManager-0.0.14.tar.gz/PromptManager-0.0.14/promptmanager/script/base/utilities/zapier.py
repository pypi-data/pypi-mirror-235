...
For use-cases where Promptmanager + Zapier NLA is powering a user-facing application, and
Promptmanager needs access to the end-user's connected accounts on Zapier.com, you'll need
...
from promptmanager.script.base.pydantic_v1 import BaseModel, Extra, root_validator
...
class ZapierNLAWrapper(BaseModel):
    ...
    For use-cases where Promptmanager + Zapier NLA is powering a user-facing application,
    and Promptmanager needs access to the end-user's connected accounts on Zapier.com,
