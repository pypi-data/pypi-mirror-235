...
from promptmanager.script.base.chains.question_answering.stuff_prompt import PROMPT_SELECTOR
...
class RetrievalQA(BaseRetrievalQA):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.chains import RetrievalQA
            from promptmanager.script.base.vectorstores import FAISS
            from promptmanager.script.base.schema.vectorstore import VectorStoreRetriever
...
class VectorDBQA(BaseRetrievalQA):
    ...
    vectorstore: PMVectorDB = Field(exclude=True, alias="vectorstore")
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from promptmanager.script.base.chains import RetrievalQA`"
        )
        return values
