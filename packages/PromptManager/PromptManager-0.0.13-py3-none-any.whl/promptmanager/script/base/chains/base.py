...
from promptmanager.script.base.pydantic_v1 import (
    BaseModel,
    Field,
    create_model,
    root_validator,
...
from promptmanager.script.base.schema import RUN_KEY, BaseMemory, RunInfo
...
class Chain(RunnableSerializable[Dict[str, Any], Dict[str, Any]], ABC):
    ...
    will be printed to the console. Defaults to `promptmanager.verbose` value."""
