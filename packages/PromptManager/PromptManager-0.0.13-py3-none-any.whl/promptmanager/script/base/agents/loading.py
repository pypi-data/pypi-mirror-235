...
from promptmanager.script.base.agents.agent import BaseMultiActionAgent, BaseSingleActionAgent
from promptmanager.script.base.agents.tools import Tool
from promptmanager.script.base.agents.types import AGENT_TO_CLASS
from promptmanager.script.base.chains.loading import load_chain, load_chain_from_config
...
def load_agent(
    ...
    """Unified method for loading an agent from PromptmanagerHub or local fs.
