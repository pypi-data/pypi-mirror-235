...
from promptmanager.script.base.evaluation.criteria.eval_chain import CRITERIA_TYPE
from promptmanager.script.base.evaluation.embedding_distance.base import (
    EmbeddingDistance as EmbeddingDistanceEnum,
)
from promptmanager.script.base.evaluation.schema import EvaluatorType, StringEvaluator
...
class RunEvalConfig(BaseModel):
    ...
    evaluators : List[Union[EvaluatorType, EvalConfig]]
        ...
        Each can be the string of an :class:`EvaluatorType <promptmanager.evaluation.schema.EvaluatorType>`, such
        as EvaluatorType.QA, the evaluator type string ("qa"), or a configuration for a
        given evaluator (e.g., :class:`RunEvalConfig.QA <promptmanager.smith.evaluation.config.RunEvalConfig.QA>`).
    ...
    :class:`EvaluatorType <promptmanager.evaluation.schema.EvaluatorType>`, such
    as `EvaluatorType.QA`, the evaluator type string ("qa"), or a configuration for a
    given evaluator
    (e.g., 
    :class:`RunEvalConfig.QA <promptmanager.smith.evaluation.config.RunEvalConfig.QA>`)."""  # noqa: E501
