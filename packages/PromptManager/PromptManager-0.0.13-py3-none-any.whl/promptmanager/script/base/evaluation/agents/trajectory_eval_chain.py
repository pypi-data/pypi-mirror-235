...
from promptmanager.script.base.evaluation.agents.trajectory_eval_prompt import (
    EVAL_CHAT_PROMPT,
    TOOL_FREE_EVAL_CHAT_PROMPT,
)
from promptmanager.script.base.evaluation.schema import AgentTrajectoryEvaluator, LLMEvalChain
from promptmanager.script.base.pydantic_v1 import Extra, Field
from promptmanager.script.base.schema import AgentAction, BaseOutputParser, OutputParserException
...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        from promptmanager.script.base.agents import AgentType, initialize_agent
        from promptmanager.script.base.chat_models import ChatOpenAI
        from promptmanager.script.base.evaluation import TrajectoryEvalChain
        from promptmanager.script.base.tools import tool
