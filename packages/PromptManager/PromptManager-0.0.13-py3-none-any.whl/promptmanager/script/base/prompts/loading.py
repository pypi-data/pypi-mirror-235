...
from promptmanager.script.base.schema import BaseLLMOutputParser, BasePromptTemplate, StrOutputParser
from promptmanager.script.base.utils.loading import try_load_from_hub
...
def load_prompt(path: Union[str, Path]) -> BasePromptTemplate:
    """Unified method for loading a prompt from PromptmanagerHub or local fs."""
