...
from promptmanager.script.base.vectorstores import PMVectorDB
...
class Qdrant(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import Qdrant
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        results = self.client.search(
            ...
            offset=offset,
            with_payload=True,
            with_vectors=False,  # Promptmanager does not expect vectors to be returned
            score_threshold=score_threshold,
            consistency=consistency,
            **kwargs,
        )
