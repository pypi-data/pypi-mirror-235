...
from promptmanager.script.base.pydantic_v1 import BaseSettings
...
class ClickhouseSettings(BaseSettings):
    ...
    Attribute:
        ...
        column_map (Dict) : Column type map to project column name onto promptmanager
...
class Clickhouse(PMVectorDB):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """ClickHouse Wrapper to Promptmanager
