...
class XinferenceEmbeddings(Embeddings):
    ...
    It will return a model UID. Then you can use Xinference Embedding with Promptmanager.

    Example:

    .. code-block:: python

        from promptmanager.script.base.embeddings import XinferenceEmbeddings
