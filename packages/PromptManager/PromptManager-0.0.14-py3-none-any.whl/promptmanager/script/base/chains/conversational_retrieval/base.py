...
from promptmanager.script.base.chains.combine_documents.base import BaseCombineDocumentsChain
from promptmanager.script.base.chains.combine_documents.stuff import StuffDocumentsChain
from promptmanager.script.base.chains.conversational_retrieval.prompts import CONDENSE_QUESTION_PROMPT
from promptmanager.script.base.chains.llm import LLMChain
from promptmanager.script.base.chains.question_answering import load_qa_chain
from promptmanager.script.base.pydantic_v1 import Extra, Field, root_validator
from promptmanager.script.base.schema import BasePromptTemplate, BaseRetriever, Document
...
class ConversationalRetrievalChain(BaseConversationalRetrievalChain):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.chains import (
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    vectorstore: PMVectorDB = Field(alias="vectorstore")
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from promptmanager.script.base.chains import ConversationalRetrievalChain`"
        )
        return values
