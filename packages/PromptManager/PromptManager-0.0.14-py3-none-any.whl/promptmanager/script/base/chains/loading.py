...
from promptmanager.script.base.chains import ReduceDocumentsChain
...
from promptmanager.script.base.llms.loading import load_llm, load_llm_from_config
from promptmanager.script.base.prompts.loading import (
    _load_output_parser,
    load_prompt,
    load_prompt_from_config,
)
from promptmanager.script.base.utilities.loading import try_load_from_hub
...
def _load_pal_chain(config: dict, **kwargs: Any) -> Any:
    from promptmanager_experimental.pal_chain import PALChain
...
def _load_sql_database_chain(config: dict, **kwargs: Any) -> Any:
    from promptmanager_experimental.sql import SQLDatabaseChain
...
def load_chain(path: Union[str, Path], **kwargs: Any) -> Chain:
    """Unified method for loading a chain from PromptmanagerHub or local fs."""
