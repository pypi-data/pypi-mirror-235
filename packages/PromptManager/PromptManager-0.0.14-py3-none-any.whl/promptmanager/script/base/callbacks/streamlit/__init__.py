...
from promptmanager.script.base.callbacks.streamlit.streamlit_callback_handler import (
...
def StreamlitCallbackHandler(
    ...
    *,
    ...
    use with a Promptmanager Agent; it displays the Agent's LLM and tool-usage "thoughts"
    ...
    try:
        from streamlit.external.promptmanager import (
