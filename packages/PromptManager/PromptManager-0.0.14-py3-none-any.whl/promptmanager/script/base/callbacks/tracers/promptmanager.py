"""A Tracer implementation that records to Promptmanager endpoint."""
...
from promptmanager.script.base.env import get_runtime_environment
...
_LOGGED = set()
_TRACERS: weakref.WeakSet[PMTracer] = weakref.WeakSet()
...
class PMTracer(BaseTracer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the Promptmanager tracer."""
        super().__init__(**kwargs)
        self.example_id = (
            UUID(example_id) if isinstance(example_id, str) else example_id
        )
        self.project_name = project_name or os.getenv(
            "PM_PROJECT", os.getenv("PM_SESSION", "default")
        )
