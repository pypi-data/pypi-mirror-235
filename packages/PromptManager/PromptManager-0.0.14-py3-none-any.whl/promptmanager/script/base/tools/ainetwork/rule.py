...
from promptmanager.script.base.tools.ainetwork.base import AINBaseTool, OperationType
...
## SET Example
- type: SET
- path: /apps/promptmanager_project_1/$from/$to/$img
- eval: auth.addr===$from&&!getValue('/apps/image_db/'+$img)

## GET Example
- type: GET
- path: /apps/promptmanager_project_1
"""  # noqa: E501
