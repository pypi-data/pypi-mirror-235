...
from promptmanager.script.base.utils.iter import batch_iterate
from promptmanager.script.base.vectorstores.utils import DistanceStrategy, maximal_marginal_relevance
...
class Pinecone(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import Pinecone
            ...
            index = pinecone.Index("promptmanager-demo")
