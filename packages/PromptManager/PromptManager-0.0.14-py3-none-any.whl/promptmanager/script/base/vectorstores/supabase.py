...
class SupabaseVectorStore(PMVectorDB):
    """`Supabase Postgres` vector store.

    It assumes you have the `pgvector`
    extension installed and a `match_documents` (or similar) function. For more details:
    https://integrations.promptmanager.com/vectorstores?integration_name=SupabaseVectorStore
    ...
    .. code-block:: python
        ...
        from promptmanager.script.base.vectorstores import SupabaseVectorStore
