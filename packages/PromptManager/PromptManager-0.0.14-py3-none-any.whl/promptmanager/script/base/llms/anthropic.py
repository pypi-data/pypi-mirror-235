...
from promptmanager.script.base.pydantic_v1 import Field, SecretStr, root_validator
...
from promptmanager.script.base.utils import (
...
class Anthropic(LLM, _AnthropicCommon):
    ...
    def raise_warning(cls, values: Dict) -> Dict:
        ...
        warnings.warn(
            ...
            "Please use `from promptmanager.script.base.chat_models import ChatAnthropic` instead"
        )
        return values
