...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    Examples:
        ...
        >>> from promptmanager.script.base.callbacks import ArgillaCallbackHandler
    ...
    def __init__(
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                " on how to create a `promptmanager`-compatible `FeedbackDataset` in"
        ...
        if supported_fields != [field.name for field in self.dataset.fields]:
            raise ValueError(
                ...
                f"`promptmanager` integration. Supported fields are: {supported_fields},"
                f" and the current `FeedbackDataset` fields are {[field.name for field in self.dataset.fields]}."  # noqa: E501
                " For more information on how to create a `promptmanager`-compatible"
        ...
        warnings.warn(
            (
                ...
                " change based on updates to `promptmanager`. Please report any issues to"
