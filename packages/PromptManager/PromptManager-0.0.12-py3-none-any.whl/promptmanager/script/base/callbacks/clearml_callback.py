...
class ClearMLCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project_name: Optional[str] = "promptmanager_callback_demo",
        ...
        warning = (
            ...
            "https://github.com/allegroai/clearml/issues with the tag `promptmanager`."
        )
        ...
        if promptmanager_asset:
            ...
            try:
                ...
                output_model = clearml.OutputModel(
                    task=self.task, config_text=load_json(promptmanager_asset_path)
                )
                output_model.update_weights(
                    weights_filename=str(promptmanager_asset_path),
