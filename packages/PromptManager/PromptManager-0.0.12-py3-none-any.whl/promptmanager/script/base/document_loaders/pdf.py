...
class UnstructuredPDFLoader(UnstructuredFileLoader):
    ...
    Examples
    --------
    from promptmanager.script.base.document_loaders import UnstructuredPDFLoader
...
class AmazonTextractPDFLoader(BasePDFLoader):
    ...
    Example:
        .. code-block:: python
            from promptmanager.script.base.document_loaders import AmazonTextractPDFLoader
