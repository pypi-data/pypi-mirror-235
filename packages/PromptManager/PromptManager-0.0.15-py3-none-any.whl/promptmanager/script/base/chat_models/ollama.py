...
from promptmanager.script.base.llms.ollama import _OllamaCommon
from promptmanager.script.base.schema import ChatResult
...
from promptmanager.script.base.schema.output import ChatGeneration, ChatGenerationChunk
...
class ChatOllama(BaseChatModel, _OllamaCommon):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.chat_models import ChatOllama
