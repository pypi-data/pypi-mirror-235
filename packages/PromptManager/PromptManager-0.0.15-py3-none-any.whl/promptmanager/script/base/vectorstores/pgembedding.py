...
class CollectionStore(BaseModel):
    ...
    __tablename__ = "promptmanager_pg_collection"
...
class EmbeddingStore(BaseModel):
    ...
    __tablename__ = "promptmanager_pg_embedding"
...
class PGEmbedding(PMVectorDB):
    ...
    - `collection_name` is the name of the collection to use. (default: promptmanager)
    ...
    def create_hnsw_index(
        ...
        create_index_query = sqlalchemy.text(
            "CREATE INDEX IF NOT EXISTS promptmanager_pg_embedding_idx "
            "ON promptmanager_pg_embedding USING hnsw (embedding) "
            "WITH ("
            "maxelements = {}, "
            "dims = {}, "
            "m = {}, "
