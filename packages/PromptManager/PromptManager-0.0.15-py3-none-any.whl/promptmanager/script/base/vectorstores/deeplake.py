...
class DeepLake(PMVectorDB):
    ...
    Example:
        .. code-block:: python
                ...
                from promptmanager.script.base.vectorstores import DeepLake
                from promptmanager.script.base.embeddings.openai import OpenAIEmbeddings

                embeddings = OpenAIEmbeddings()
                vectorstore = DeepLake("promptmanager_store", embeddings.embed_query)
    """

    _PM_DEFAULT_DEEPLAKE_PATH = "./deeplake/"

    def __init__(
        self,
        dataset_path: str = _PM_DEFAULT_DEEPLAKE_PATH,
        ...
        **kwargs: Any,
        ...
        Args:
            dataset_path (str): Path to existing dataset or where to create
                a new one. Defaults to _PM_DEFAULT_DEEPLAKE_PATH.
