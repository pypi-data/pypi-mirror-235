...
from promptmanager.script.base.schema import BaseChatMessageHistory
from promptmanager.script.base.schema.messages import BaseMessage, _message_to_dict, messages_from_dict
...
class RocksetChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(
        ...
        try:
            self.client.set_application("promptmanager")
