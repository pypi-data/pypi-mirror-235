...
from promptmanager.script.base.evaluation.schema import PairwiseStringEvaluator, StringEvaluator
...
class StringDistanceEvalChain(StringEvaluator, _RapidFuzzChainMixin):
    ...
    >>> from promptmanager.script.base.evaluation import StringDistanceEvalChain
