...
from promptmanager.script.base.llms.base import LLM, get_prompts
from promptmanager.script.base.load.dump import dumps
from promptmanager.script.base.load.load import loads
from promptmanager.script.base.schema import Generation
from promptmanager.script.base.schema.cache import RETURN_VAL_TYPE, BaseCache
...
from promptmanager.script.base.vectorstores.redis import Redis as RedisVectorstore
...
class SQLiteCache(SQLAlchemyCache):
    ...
    def __init__(self, database_path: str = ".promptmanager.db"):
...
class RedisSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            from promptmanager.script.base.cache import RedisSemanticCache
            from promptmanager.script.base.embeddings import OpenAIEmbeddings

            promptmanager.llm_cache = RedisSemanticCache(
...
class GPTCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            promptmanager.llm_cache = GPTCache(init_gptcache)
...
CASSANDRA_CACHE_DEFAULT_TABLE_NAME = "promptmanager_llm_cache"
...
CASSANDRA_SEMANTIC_CACHE_DEFAULT_TABLE_NAME = "promptmanager_llm_semantic_cache"
