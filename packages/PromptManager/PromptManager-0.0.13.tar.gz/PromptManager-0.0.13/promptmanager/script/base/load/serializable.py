...
class Serializable(BaseModel, ABC):
    ...
    def get_lc_namespace(cls) -> List[str]:
        """Get the namespace of the promptmanager object.

        For example, if the class is `promptmanager.llms.openai.OpenAI`, then the
        namespace is ["promptmanager", "llms", "openai"]
        """
