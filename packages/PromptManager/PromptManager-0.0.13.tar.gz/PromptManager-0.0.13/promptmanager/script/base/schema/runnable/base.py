...
if TYPE_CHECKING:
    ...
    from promptmanager.script.base.callbacks.tracers.log_stream import RunLog, RunLogPatch
    from promptmanager.script.base.schema.runnable.fallbacks import (
...
from promptmanager.script.base.pydantic_v1 import BaseModel, Field, create_model
from promptmanager.script.base.schema.runnable.config import (
    RunnableConfig,
...
from promptmanager.script.base.schema.runnable.utils import (
    AddableDict,
    ConfigurableField,
...
from promptmanager.script.base.utils.aiter import atee, py_anext
from promptmanager.script.base.utils.iter import safetee
...
class Runnable(Generic[Input, Output], ABC):
    ...
    * astream_log: Streams output and selected intermediate results from an input.
    ...
    The Promptmanager Expression Language (LCEL) is a declarative way to compose Runnables
    ...
    ..code-block:: python
        ...
        from promptmanager.script.base.schema.runnable import RunnableLambda
    ...
    async def astream_log(
        ...
        **kwargs: Optional[Any],
        ...
        from promptmanager.script.base.callbacks.tracers.log_stream import (
    ...
    def with_retry(
        ...
        *,
        ...
        from promptmanager.script.base.schema.runnable.retry import RunnableRetry
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    def configurable_fields(
        ...
        from promptmanager.script.base.schema.runnable.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Runnable[Input, Output],
        ...
        from promptmanager.script.base.schema.runnable.configurable import (
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    def batch(
        ...
        **kwargs: Optional[Any],
        ...
        from promptmanager.script.base.callbacks.manager import CallbackManager
