...
For example the following query:
    ...
    .. code-block:: python
        ...
        s = SearxSearchWrapper("promptmanager library", engines=['github'])

        # can also be written as:
        s = SearxSearchWrapper("promptmanager library !github")
        # or even:
        s = SearxSearchWrapper("promptmanager library !gh")
...
engines.
    ...
    .. code-block:: python
        ...
        s = SearchWrapper("promptmanager library", query_suffix="!gh")


        s = SearchWrapper("promptmanager library")
