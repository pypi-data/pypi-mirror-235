...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    promptmanager Document object. If you use "elements" mode, the unstructured
    ...
    Examples
    --------
    from promptmanager.script.base.document_loaders import UnstructuredFileLoader
...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    Examples
    ```python
    from promptmanager.script.base.document_loaders import UnstructuredAPIFileLoader
...
class UnstructuredFileIOLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from promptmanager.script.base.document_loaders import UnstructuredFileIOLoader
