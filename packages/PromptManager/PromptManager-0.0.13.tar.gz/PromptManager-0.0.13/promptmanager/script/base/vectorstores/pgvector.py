...
if TYPE_CHECKING:
    from promptmanager.script.base.vectorstores._pgvector_data_models import CollectionStore
...
_PM_DEFAULT_COLLECTION_NAME = "promptmanager"
...
class PGVector(PMVectorDB):
    ...
    Args:
        ...
        collection_name: The name of the collection to use. (default: promptmanager)
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import PGVector
    ...
    def __init__(
        ...
        collection_name: str = _PM_DEFAULT_COLLECTION_NAME,
    ...
    def __post_init__(
        ...
        from promptmanager.script.base.vectorstores._pgvector_data_models import (
            CollectionStore,
            EmbeddingStore,
        )
