...
_PM_DEFAULT_EMBEDDING_DIM = 1536
_PM_DEFAULT_COLLECTION_NAME = "promptmanager_document"

Base = declarative_base()  # type: Any


class AnalyticDB(PMVectorDB):
    ...
    def __init__(
        ...
        embedding_dimension: int = _PM_DEFAULT_EMBEDDING_DIM,
