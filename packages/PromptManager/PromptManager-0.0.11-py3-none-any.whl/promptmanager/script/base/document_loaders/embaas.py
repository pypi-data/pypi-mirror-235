...
from promptmanager.script.base.document_loaders.base import BaseBlobParser, BaseLoader
from promptmanager.script.base.document_loaders.blob_loaders import Blob
from promptmanager.script.base.pydantic_v1 import BaseModel, root_validator, validator
from promptmanager.script.base.text_splitter import TextSplitter
...
class EmbaasBlobLoader(BaseEmbaasLoader, BaseBlobParser):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from promptmanager.script.base.document_loaders.embaas import EmbaasBlobLoader
...
class EmbaasLoader(BaseEmbaasLoader, BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from promptmanager.script.base.document_loaders.embaas import EmbaasLoader
