...
# https://stackoverflow.com/questions/76469415/getting-embeddings-of-length-1-from-promptmanager-openaiembeddings
...
class LocalAIEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.embeddings import LocalAIEmbeddings
