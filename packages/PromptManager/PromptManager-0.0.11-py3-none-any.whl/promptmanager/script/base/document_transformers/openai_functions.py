...
from promptmanager.script.base.chains.openai_functions import create_tagging_chain
...
from promptmanager.script.base.schema import BaseDocumentTransformer, Document
...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                from promptmanager.script.base.document_transformers import OpenAIMetadataTagger
    ...
    *,
    ...
    Example:
        .. code-block:: python
                ...
                from promptmanager.script.base.chat_models import ChatOpenAI
                from promptmanager.script.base.document_transformers import create_metadata_tagger
                from promptmanager.script.base.schema import Document
