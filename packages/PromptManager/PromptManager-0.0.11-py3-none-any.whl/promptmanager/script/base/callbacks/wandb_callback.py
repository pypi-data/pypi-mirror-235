...
class WandbCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        project: Optional[str] = "promptmanager_callback_demo",
    ...
    def flush_tracker(
        ...
        if promptmanager_asset:
            ...
            try:
                ...
                model_artifact.add_file(str(promptmanager_asset_path))
                model_artifact.metadata = load_json_to_dict(promptmanager_asset_path)
            except ValueError:
