...
from promptmanager.script.base._api import deprecated
...
from promptmanager.script.base.schema.vectorstore import VectorStore, VectorStoreRetriever
from promptmanager.script.base.utilities.redis import (
    _array_to_buffer,
    _buffer_to_array,
...
from promptmanager.script.base.vectorstores.redis.constants import (
...
if TYPE_CHECKING:
    ...
    from promptmanager.script.base.vectorstores.redis.filters import RedisFilterExpression
    from promptmanager.script.base.vectorstores.redis.schema import RedisModel
...
class Redis(VectorStore):
    ...
    .. code-block:: python
        ...
        from promptmanager.script.base.vectorstores import Redis
    ...
    schema according to the following rules:
        ...
        - All lists of strings are indexed as tag fields (joined by
            promptmanager.vectorstores.redis.constants.REDIS_TAG_SEPARATOR)
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        always present in the promptmanager schema.
        ...
        try:
            ...
            from promptmanager.script.base.vectorstores.redis.schema import read_schema
    ...
    def _get_schema_with_defaults(
        ...
        from promptmanager.script.base.vectorstores.redis.schema import RedisModel, read_schema
