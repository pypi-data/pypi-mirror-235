...
class Reviver:
    ...
    def __init__(
        ...
        # By default only support promptmanager, but user can pass in additional namespaces
        self.valid_namespaces = (
            ["promptmanager", *valid_namespaces] if valid_namespaces else ["promptmanager"]
        )
    ...
    def __call__(self, value: Dict[str, Any]) -> Any:
        ...
        if (
            ...
            # The root namespace "promptmanager" is not a valid identifier.
            if len(namespace) == 1 and namespace[0] == "promptmanager":
                raise ValueError(f"Invalid namespace: {value}")
...
def loads(
    ...
    *,
    ...
    """Revive a Promptmanager class from a JSON string.
...
def load(
    ...
    *,
    ...
    """Revive a Promptmanager class from a JSON object. Use this if you already
