...
from promptmanager.script.base.evaluation.scoring.prompt import (
...
from promptmanager.script.base.schema import RUN_KEY, BaseOutputParser
...
class ScoreStringEvalChain(StringEvaluator, LLMEvalChain, LLMChain):
    ...
    Example:
        ...
        >>> from promptmanager.script.base.evaluation.scoring import ScoreStringEvalChain
