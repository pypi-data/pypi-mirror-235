...
class GradientEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.embeddings import GradientEmbeddings
            GradientEmbeddings(
                model="bge-large",
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            logging.warning(
                ...
                "`pip install gradientai` in future releases of promptmanager."
            )
        except Exception:
            pass
...
class TinyAsyncGradientEmbeddingClient:
    """A helper tool to embed Gradient. Not part of Promptmanager's or Gradients stable API.
