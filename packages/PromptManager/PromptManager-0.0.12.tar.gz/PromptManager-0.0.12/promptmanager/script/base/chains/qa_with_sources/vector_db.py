...
from promptmanager.script.base.chains.qa_with_sources.base import BaseQAWithSourcesChain
...
class VectorDBQAWithSourcesChain(BaseQAWithSourcesChain):
    ...
    vectorstore: PMVectorDB = Field(exclude=True)
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from promptmanager.script.base.chains import RetrievalQAWithSourcesChain`"
        )
        return values
