...
from promptmanager.script.base.chains.elasticsearch_database.prompts import ANSWER_PROMPT, DSL_PROMPT
from promptmanager.script.base.chains.llm import LLMChain
from promptmanager.script.base.output_parsers.json import SimpleJsonOutputParser
from promptmanager.script.base.pydantic_v1 import Extra, root_validator
from promptmanager.script.base.schema import BaseLLMOutputParser, BasePromptTemplate
...
class ElasticsearchDatabaseChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.chains import ElasticsearchDatabaseChain
