...
from promptmanager.script.base._api import warn_deprecated
...
from promptmanager.script.base.chains.llm_bash.prompt import PROMPT
from promptmanager.script.base.pydantic_v1 import Extra, Field, root_validator
from promptmanager.script.base.schema import BasePromptTemplate, OutputParserException
    ...
    def _call(
        ...
        warn_deprecated(
            ...
            message=(
                ...
                "will be moved to promptmanager-experimental"
            ),
            pending=True,
        )
