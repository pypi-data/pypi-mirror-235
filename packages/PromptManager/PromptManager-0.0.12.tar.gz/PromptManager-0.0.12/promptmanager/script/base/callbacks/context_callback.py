...
class ContextCallbackHandler(BaseCallbackHandler):
    ...
    Chat Example:
        >>> from promptmanager.script.base.llms import ChatOpenAI
        >>> from promptmanager.script.base.callbacks import ContextCallbackHandler
        ...
        ...     HumanMessage(content="I love programming with Promptmanager."),
        ... ]
        >>> chat(messages)
