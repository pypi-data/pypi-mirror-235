...
class DashVector(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import dashvector
            from promptmanager.script.base.embeddings.openai import OpenAIEmbeddings
            import dashvector

            client = dashvector.Client.init(api_key="***")
            client.create("promptmanager")
            collection = client.get("promptmanager")
    ...
    def from_texts(
        ...
        collection_name: str = "promptmanager",
        text_field: str = "text",
        batch_size: int = 25,
        ids: Optional[List[str]] = None,
        **kwargs: Any,
