...
_PM_DEFAULT_COLLECTION_NAME = "promptmanager_store"


class TimescaleVector(PMVectorDB):
    ...
    Args:
        ...
        collection_name: The name of the collection to use. (default: promptmanager_store)
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import TimescaleVector
