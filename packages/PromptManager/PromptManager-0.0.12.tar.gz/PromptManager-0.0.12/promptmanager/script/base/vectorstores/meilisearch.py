...
class Meilisearch(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import Meilisearch
    ...
    def __init__(
        ...
        url: Optional[str] = None,
        api_key: Optional[str] = None,
        index_name: str = "promptmanager-demo",
        text_key: str = "text",
