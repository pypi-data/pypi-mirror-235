...
class Typesense(PMVectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.embedding.openai import OpenAIEmbeddings
            from promptmanager.script.base.vectorstores import Typesense
            import typesense
            ...
            typesense_collection_name = "promptmanager-memory"
    ...
    def __init__(
        ...
        *,
        ...
        self._typesense_collection_name = (
            typesense_collection_name or f"promptmanager-{str(uuid.uuid4())}"
        )
