    ...
    def before_index_setup(
        ...
        if self.model_id:
            client.ingest.put_pipeline(
                ...
                description="Embedding pipeline for promptmanager vectorstore",
                processors=[
                    {
                        "inference": {
                            "model_id": self.model_id,
...
class ElasticsearchStore(PMVectorDB):
    """`Elasticsearch` vector store.

    Example:
        .. code-block:: python

            from promptmanager.script.base.vectorstores import ElasticsearchStore
    ...
    def get_user_agent() -> str:
        ...
        return f"promptmanager-py-vs/{__version__}"
