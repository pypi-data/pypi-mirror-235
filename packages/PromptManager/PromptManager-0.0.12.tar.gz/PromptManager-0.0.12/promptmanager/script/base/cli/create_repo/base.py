            ...
            if template_file_path.is_dir():
                ...
                project_file_path.write_text(
                    UnderscoreTemplate(template_file_path.read_text()).substitute(
                        ...
                        promptmanager_version=promptmanager.__version__,
                    )
                )
...
def create(
    ...
    """Create a new Promptmanager project.
    ...
    if not typer.confirm(
        f"\n"
        f"Creating a new Promptmanager project 🦜️🔗\n"
    ...
    typer.echo(
        ...
        f" Your new Promptmanager project"
