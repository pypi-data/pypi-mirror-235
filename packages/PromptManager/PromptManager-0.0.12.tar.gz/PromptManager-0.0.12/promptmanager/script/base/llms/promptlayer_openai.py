...
from promptmanager.script.base.llms.openai import OpenAI, OpenAIChat
from promptmanager.script.base.schema import LLMResult
...
class PromptLayerOpenAI(OpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.llms import PromptLayerOpenAI
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = promptlayer_api_request(
                "promptmanager.PromptLayerOpenAI",
                "promptmanager",
                [prompt],
                params,
                self.pl_tags,
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = await promptlayer_api_request_async(
                "promptmanager.PromptLayerOpenAI.async",
                "promptmanager",
                [prompt],
                params,
                self.pl_tags,
...
class PromptLayerOpenAIChat(OpenAIChat):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.llms import PromptLayerOpenAIChat
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = promptlayer_api_request(
                "promptmanager.PromptLayerOpenAIChat",
                "promptmanager",
                [prompt],
                params,
                self.pl_tags,
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = await promptlayer_api_request_async(
                "promptmanager.PromptLayerOpenAIChat.async",
                "promptmanager",
                [prompt],
                params,
                self.pl_tags,
