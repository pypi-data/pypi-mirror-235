...
from promptmanager.script.base.output_parsers.format_instructions import (
...
from promptmanager.script.base.schema import BaseOutputParser
...
class StructuredOutputParser(BaseOutputParser):
    ...
    def get_format_instructions(self, only_json: bool = False) -> str:
        ...
        example:
        ```python
        from promptmanager.script.base.output_parsers.structured import (
