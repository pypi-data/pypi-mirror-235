...
class Vectara(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.vectorstores import Vectara
    ...
    def add_files(
        ...
        **kwargs: Any,
        ...
        This method provides a way to use that API in Promptmanager
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        if doc_metadata:
            doc_metadata["source"] = "promptmanager"
        else:
            doc_metadata = {"source": "promptmanager"}
        doc = {
            "document_id": doc_id,
