...
class SelfHostedHuggingFaceEmbeddings(SelfHostedEmbeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.embeddings import SelfHostedHuggingFaceEmbeddings
...
class SelfHostedHuggingFaceInstructEmbeddings(SelfHostedHuggingFaceEmbeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from promptmanager.script.base.embeddings import SelfHostedHuggingFaceInstructEmbeddings
            import runhouse as rh
