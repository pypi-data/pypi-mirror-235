...
from promptmanager.PromptManager.settings.base import CUSTOM_SCRIPT_PATH, TEXT_SEGMENTATION_PATH, TEXT_TRUNCATION_PATH, \
    CHROMA_READER_PATH, DINGO_READER_PATH, FAISS_READER_PATH
...
def create_flow_node(request):
    ...
    elif type in ['script', 'vectordb', 'script_prompt']:
...
def __calculate_and_handle_nodes(flow_id, nodes):
    ...
    for node in nodes:
        ...
        elif node['module_type'] in ['script', 'vectordb', 'script_prompt']:
