...
class PointCloud:
    ...
    def EstimateNormals(self, radius: float, num_closest: int, parallelize: pydrake.common._module_py.Parallelism = ...) -> bool: ...
    ...
    def VoxelizedDownSample(self, voxel_size: float, parallelize: pydrake.common._module_py.Parallelism = ...) -> PointCloud: ...
