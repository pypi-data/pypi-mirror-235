...
class CollisionChecker:
    ...
    def CheckConfigsCollisionFree(self, configs: List[numpy.ndarray[numpy.float64[m,1]]], parallelize: pydrake.common._module_py.Parallelism = ...) -> List[int]: ...
    ...
    def CheckEdgeCollisionFreeParallel(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]], parallelize: pydrake.common._module_py.Parallelism = ...) -> bool: ...
    def CheckEdgesCollisionFree(self, edges: List[Tuple[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,1]]]], parallelize: pydrake.common._module_py.Parallelism = ...) -> List[int]: ...
    ...
    def MeasureEdgeCollisionFreeParallel(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]], parallelize: pydrake.common._module_py.Parallelism = ...) -> EdgeMeasure: ...
    def MeasureEdgesCollisionFree(self, edges: List[Tuple[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,1]]]], parallelize: pydrake.common._module_py.Parallelism = ...) -> List[EdgeMeasure]: ...
...
class CollisionCheckerParams:
    ...
    implicit_context_parallelism: pydrake.common._module_py.Parallelism
    model: RobotDiagram
...
def VisibilityGraph(checker: CollisionChecker, points: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], parallelize: bool = ...) -> scipy.sparse.csc_matrix[bool]: ...
