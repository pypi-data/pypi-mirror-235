...
class RoboCam():
    def __init__(self):
        if platform.system() == "Windows" and not os.path.exists(os.path.expanduser('~') + "\\Pictures\\roborobo"):
            os.makedirs(os.path.expanduser('~') + "\\Pictures\\roborobo") 
            os.makedirs(os.path.expanduser('~') + "\\Pictures\\roborobo\\face") 
            os.makedirs(os.path.expanduser('~') + "\\Pictures\\roborobo\\sketch") 
