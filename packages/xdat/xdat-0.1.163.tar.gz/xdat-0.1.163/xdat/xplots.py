...
def plot_model_reg_pred(df, target='target', title='', df_train=None, as_xpptx=None, show=True):
    with plot_wrapper(title=title, legend_loc='lower right', as_xpptx=as_xpptx, show=show):
