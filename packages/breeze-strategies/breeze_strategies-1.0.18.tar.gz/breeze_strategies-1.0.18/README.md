...
pip install breeze_strategies==1.0.18
...
#Configure the strategy using API Keys and set stoploss/takeprofit level.(in case you want to use max_profit and max_loss , enter those values and pass "-1" in max_profit and max_loss value)
...
#Configure the strategy using API Keys and set stoploss/takeprofit level. (in case you want to use trailing stoploss then pass "-1" in both max_profit and max_loss and enter your trailing stoploss value)
