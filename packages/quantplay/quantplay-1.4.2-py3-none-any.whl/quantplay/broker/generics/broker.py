...
class Broker:
    ...
    def square_off_all(self, dry_run=True, contains=None, sleep_time=0.1):
        ...
        for position in positions:
            ...
            freeze_quantity = self.symbol_freeze_quantity(exchange, tradingsymbol)
            split_into = int(math.ceil(quantity_in_lots / freeze_quantity))
    ...
    def symbol_freeze_quantity(self, exchange, symbol):
        try:
