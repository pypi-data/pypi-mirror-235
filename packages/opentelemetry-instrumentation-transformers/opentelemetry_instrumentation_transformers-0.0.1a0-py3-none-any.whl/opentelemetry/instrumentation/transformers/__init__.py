...
from opentelemetry.instrumentation.transformers.pipeline_wrapper import pipeline_wrapper
from opentelemetry.instrumentation.transformers.workflow_wrapper import workflow_wrapper

logger = logging.getLogger(__name__)

_instruments = ("transformers >= 0.0.200",)
__version__ = "0.0.1"
...
WRAPPED_METHODS = [
    {
        ...
        "object": "Pipeline",
        "method": "__call__",
        "span_name": "transformers_pipeline.call",
