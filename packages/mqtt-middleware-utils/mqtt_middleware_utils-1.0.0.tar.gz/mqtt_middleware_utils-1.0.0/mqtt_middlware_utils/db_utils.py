    ...
    try:
        ...
        if (result != "OK"):
            raise DatabasePersistenceError(
                "Persist operation resulted NOT OK for object [(object_name: " +
...
def create_index(conn, index_name, schema, definition, index_type):
    ...
    try:
        ...
        result = idx.create_index(schema, definition, index_type)
        if (result != "OK"):
            raise DatabaseCreateIndexError(
                "Create index operation resulted NOT OK for index [(index_name: " +
...
@db_exceptions_decorator
def search_from_index(index, query_string):
    '''
    ...
    try:
        ...
        raise DatabaseIndexSearchError(
            ...
            str(index.name) + ") (query_string: "+str(query_string)+")]: \n"+str(e))
