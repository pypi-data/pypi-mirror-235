...
def unicorn(init_hash,brute=None,dictionary=None,mask=None):
    print(CYAN + "")
    clear()
    words = []
    if brute != None:
        for _ in range(1,36):
            ...
            words = combinations_with_replacement("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",_)
            for word in words:
                new_word = "".join(word)
