...
class PaginatedInternshipListResults(BaseModel):
    data: typing.Optional[typing.List[Internship]]  = None
    error: typing.Optional[str]  = None

class PaginatedInternshipList(BaseModel):
    next: typing.Optional[typing.Union[int, None]]  = None
    results: typing.Optional[PaginatedInternshipListResults]  = None
