...
from fhnw_thermo_tools.globals import CW, CpL, CpW, hfg0
...
def get_theta_wet_bulb(theta: float, phi: float, p: float) -> float:
    """Berechnung der Nasskugeltemperatur in °C implements the method from
    https://github.com/smartlixx/WetBulb/tree/master
