...
class PowerBIDataflow:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataflow':
        ...
        workspace_id = from_union([from_str, from_none], obj.get("workspaceId"))
        return PowerBIDataflow(created_at, aspect_type, configured_by, content, power_bi_dataflow_created_at, dataflow_url, description, document, entity_id, id, modified_by, modified_date_time, name, refresh_schedule, workspace_id)
