...
class TableauDatasource:
    ...
    def from_dict(obj: Any) -> 'TableauDatasource':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return TableauDatasource(created_at, aspect_type, tableau_datasource_created_at, description, embedded, entity_id, fields, id, name, query, source_datasets, source_virtual_views, url)
