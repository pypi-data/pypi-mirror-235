...
from sarus_data_spec.transform import Transform, transform_id
...
class Scalar(Referring[sp.Scalar]):
    ...
    def is_fitted_model(self) -> bool:
        ...
        elif transform_id(transform) == "std.SUDO":
            args, kwargs = self.parents()
            parent = (list(args) + list(kwargs.values())).pop()
            return parent.is_fitted_model()
