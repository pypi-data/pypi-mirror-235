...
class Base(manager_typing.Manager):
    ...
    def infer_output_type(
        ...
        **named_arguments: t.Union[st.DataSpec, st.Transform],
        ...
        # sudo is same type as parent
        if transform_id(transform) == "std.SUDO":
            parent = (list(arguments) + list(named_arguments.values())).pop()
            return sp.type_name(parent.prototype()), attach_nothing
