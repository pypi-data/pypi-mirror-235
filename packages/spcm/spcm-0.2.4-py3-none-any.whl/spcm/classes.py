...
class Card(Device):
    ...
    def out_stop_level(self, channel_index : int, value : int) -> None:
        ...
        self.set(SPC_CH0_STOPLEVEL + channel_index * (SPC_CH1_STOPLEVEL - SPC_CH0_STOPLEVEL), value)
    ...
    def out_custom_stop(self, channel_index : int, value : int) -> None:
        ...
        self.set(SPC_CH0_CUSTOM_STOP + channel_index * (SPC_CH1_CUSTOM_STOP - SPC_CH0_CUSTOM_STOP), value)
