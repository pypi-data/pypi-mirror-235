...
from .path_utils import delete_file
...
def cmd_run(cmd: str, output_text: str = None,print_output:bool=False,delete_output_file:bool=True,save_output_file:bool=False,remove_output_file:bool=True) -> None:
    """
    ...
    if save_output_file:
        write_to_file(file_path=output_text, 'r') as f:
...
def pexpect_cmd_with_args(command: str, child_runs: list, output_text: str = os.getcwd(),print_output:bool=False,save_output_file:bool=False,remove_output_file:bool=True) -> int:
    """
    ...
    if delete_file_output:
        delete_file(get_output_text())
