...
"""
Auto-generated by CVXPYgen on October 09, 2023 at 20:30:27.
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["w", "R", "c", "f_min", "f_max"]
    ...
    par.R = list(param_dict["R"].value.flatten(order="F"))
    par.c = list(param_dict["c"].value.flatten(order="F"))
    par.f_min = list(param_dict["f_min"].value.flatten(order="F"))
    par.f_max = list(param_dict["f_max"].value.flatten(order="F"))
    ...
    prob.var_dict['f'].save_value(np.array(res.cpg_prim.f).reshape(100))
    prob.constraints[0].save_dual_value(np.array(res.cpg_dual.d0).reshape(10))
    prob.constraints[1].save_dual_value(np.array(res.cpg_dual.d1).reshape(100))
    prob.constraints[2].save_dual_value(np.array(res.cpg_dual.d2).reshape(100))
