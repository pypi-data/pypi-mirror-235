...
class AsyncBaseAPIView(AsyncAPIView, metaclass=ABCMeta):
    ...
    response_get: Dict[Union[str, int], Schema]
    response_post: Dict[Union[str, int], Schema]
    response_put: Dict[Union[str, int], Schema]
    response_delete: Dict[Union[str, int], Schema]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.swagger_type = SwaggerTypeBase(
            request_get=self.request_get,
            request_post=self.request_post,
            request_put=self.request_put,
