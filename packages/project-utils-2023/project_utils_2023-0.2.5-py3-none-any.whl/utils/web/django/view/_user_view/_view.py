...
class BaseUserLoginView(APIView, metaclass=ABCMeta):
    ...
    def create_exception(self, e: Exception):
    ...
    def post(self, request: Request) -> Response:
        ...
        try:
            ...
            _e: DjangoWebException = self.create_exception(e)
...
class AsyncBaseUserLoginView(AsyncView, metaclass=ABCMeta):
    ...
    async def create_exception(self, e: Exception):
        return ViewException(str(e), traceback.format_exc())
    ...
    async def post(self, request: Request) -> Response:
        ...
        try:
            ...
            _e: DjangoWebException = await self.create_exception(e)
