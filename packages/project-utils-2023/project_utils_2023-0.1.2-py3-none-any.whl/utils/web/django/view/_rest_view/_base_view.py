...
from utils.web.django.swagger import params, params_types
...
class BaseRestAPIView(APIView, metaclass=ABCMeta):
    ...
    response_schema: Dict[Union[str, int], Schema] = {
        200: params(params_types.object).schema({
            "errno": params(params_types.integer).schema()
        })
    }
