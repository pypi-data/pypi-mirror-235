...
class BaseRestAPIView(APIView, metaclass=ABCMeta):
    ...
    swagger_type: SwaggerTypeBase = SwaggerTypeBase()
    ...
    @swagger_auto_schema(manual_parameters=swagger_type.request_get, responses=response_get)
    ...
    @swagger_auto_schema(request_body=swagger_type.request_post, responses=response_post)
    ...
    @swagger_auto_schema(request_body=swagger_type.request_put, responses=response_put)
    ...
    @swagger_auto_schema(manual_parameters=swagger_type.request_delete["query"],
