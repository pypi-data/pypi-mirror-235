...
from utils.web.django.response._response_model import ResponseModel as WebResponse

REQUEST_TYPE = Union[HttpRequest, Request]
PARAMS_TYPE = Dict[str, Any]
USER_TYPE = Dict[str, str]
VIEW_TYPE = Callable[[WebRequest, Any, Any], WebResponse]
