...
from utils.web.django.view._types import REQUEST_TYPE, PARAMS_TYPE, USER_TYPE
...
class Base(metaclass=ABCMeta):
    ...
    def request_init(self) -> WebRequest:
        request: WebRequest = WebRequest(request=self.request)
        try:
    ...
    async def async_request_init(self):
        return self.request_init()
