    ...
    def calc_flux(self):
        ...
        perley = { 
            ...
            # An updated list of radio flux density calibrators, Astronomy & Astrophysics, 284, 1994, pp. 331-339.
                ...
                "3C48"   : {'range_from': 1408, 'range_to': 50000, 'a': 1.3253, 'b': -0.7553, 'c': -0.1914, 'd': 0, 'e': 0},
                "3C123"  : {'range_from': 1408, 'range_to': 50000, 'a': 1.8017, 'b': -0.7884, 'c': -0.0248, 'd': 0.0090, 'e': 0},
                "TAURUSA"   : {'range_from': 50, 'range_to': 4000, 'a': 2.9516, 'b': -0.2173, 'c':-0.0473, 'd':0, 'e':0},

                # "3C147"  : {'range_from': 1408, 'range_to': 23780, 'a': 2.806, 'b': -0.140, 'c': -0.1031, 'd': 0, 'e': 0},
                # "3C161"  : {'range_from': 1408, 'range_to': 10550, 'a': 1.250, 'b': 0.726, 'c': -0.2286, 'd': 0, 'e': 0},
                # "HYDRA A": {'range_from': 1408, 'range_to': 15000, 'a': 4.729, 'b': -1.025, 'c':  0.0130, 'd': 0, 'e': 0},
                # "3C218"  : {'range_from': 1408, 'range_to': 15000, 'a': 4.729, 'b': -1.025, 'c':  0.0130, 'd': 0, 'e': 0}, #aka HYDRA A
                # "3C218"  : {'range_from': 1408, 'range_to': 10550, 'a': 4.729, 'b': -1.025, 'c':  0.0130, 'd': 0, 'e': 0},
                # "3C227"  : {'range_from': 1408, 'range_to': 4750, 'a': 6.757, 'b': -2.801, 'c':  0.2969, 'd': 0, 'e': 0},
                # "3C249.1": {'range_from': 1408, 'range_to': 4750, 'a': 2.537, 'b': -0.565, 'c': -0.0404, 'd': 0, 'e': 0},
                # "3C286"  : {'range_from': 1408, 'range_to': 43200, 'a': 0.956, 'b': 0.584, 'c': -0.1644, 'd': 0, 'e': 0},
                # "3C295"  : {'range_from': 1408, 'range_to': 32000, 'a': 1.490, 'b': 0.756, 'c': -0.2545, 'd': 0, 'e': 0},
                # "3C348"  : {'range_from': 1408, 'range_to': 10550, 'a': 3.852, 'b': -0.361, 'c': -0.1053, 'd': 0, 'e': 0},
                # "3C353"  : {'range_from': 1408, 'range_to': 10550, 'a': 3.148, 'b': -0.157, 'c': -0.0911, 'd': 0, 'e': 0},
                # "VIRGO A": {'range_from': 4750, 'range_to': 10550, 'a': 4.484, 'b': -0.603, 'c': -0.0280, 'd': 0, 'e': 0}, 
                # "CYGNUSA": {'range_from': 20, 'range_to': 2000, 'a': 8.360, 'b': 1.565, 'c':0, 'd': 0, 'e': 0},
                # "NGC7027": {'range_from': 10550, 'range_to': 43200, 'a': 1.322, 'b': -0.134, 'c': 0, 'd': 0, 'e': 0}
                }
        ...
        if self.data['OBJECT'].upper() in perley.keys():
            if ott[self.data['OBJECT']]["range_from"] < self.data['CENTFREQ'] < ott[self.data['OBJECT']]["range_to"]:
                self.data['FLUX'] = (10**(ott[self.data['OBJECT']]["a0"] + ott[self.data['OBJECT']]
                            ["a1"]*self.data['LOGFREQ'] + ott[self.data['OBJECT']]["a2"]*self.data['LOGFREQ']**2 + ott[self.data['OBJECT']]["a3"]*self.data['LOGFREQ']**3 + ott[self.data['OBJECT']]["a4"]*self.data['LOGFREQ']**4) )
        elif self.data['OBJECT'].upper() in ott.keys():
            if ott[self.data['OBJECT']]["range_from"] < self.data['CENTFREQ'] < ott[self.data['OBJECT']]["range_to"]:
