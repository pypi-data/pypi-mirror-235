...
#    Copyright (C) 2018 - 2023  GNU Solidario <health@gnusolidario.org>
...
from fhir_server.common.extensions import tryton, login_manager, Api
from fhir_server.common.utils import recordConverter
