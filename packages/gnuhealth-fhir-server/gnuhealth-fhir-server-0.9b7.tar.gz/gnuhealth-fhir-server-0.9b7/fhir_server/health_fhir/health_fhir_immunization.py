...
from fhir_server.common import safe_attrgetter
...
class health_Immunization(supermod.Immunization, Immunization_Map, ExportXMLMixin):
    ...
    def set_route(self, route):
        ...
        from fhir_server.fhir.value_sets import immunizationRoute
        if route:
    ...
    def set_site(self, site):
        ...
        from fhir_server.fhir.value_sets import immunizationSite
        if site:
