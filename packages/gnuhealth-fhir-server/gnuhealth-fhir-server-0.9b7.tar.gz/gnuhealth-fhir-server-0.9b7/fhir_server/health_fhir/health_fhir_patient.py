...
import fhir_server.fhir as supermod
from .health_mixin import ExportXMLMixin
from fhir_server.common import get_address, safe_attrgetter
import sys
...
class health_Patient(supermod.Patient, Patient_Map, ExportXMLMixin):
    ...
    def set_gender(self, gender):
        ...
        from fhir_server.fhir.value_sets import administrativeGender as gender_codes
        if gender:
    ...
    def set_maritalStatus(self, marital_status):
        ...
        from fhir_server.fhir.value_sets import maritalStatus as ms
