...
class Requirements(object):
    ...
    def get_link():
        ...
        :return:
        """
        requirements = ['-e pylbfgs @ git+https://github.com/fzimmermann89/pylbfgs.git@fzimmermann89-cython']
        return requirements


version_dev='1.0.27'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.27',  # Required, Phần này cũng không được format file.
