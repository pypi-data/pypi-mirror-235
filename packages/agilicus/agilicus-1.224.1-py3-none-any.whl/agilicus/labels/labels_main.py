...
@click.command(name="add-labelled_object")
@click.option("--object_id", required=True)
@click.option("--object_type", required=True)
@click.option("--org-id", default=None)
@click.option("--label", multiple=True, default=None)
@click.pass_context
def cli_command_add_labelled_object(ctx, action, **kwargs):
    output_entry(ctx, labels.add_labelled_object(ctx, actions=action, **kwargs))


@click.command(name="list-labelled_objects")
@click.option("--org-id", default=None)
@click.option("--object-id", default=None)
@click.option("--object-d", default=None)
...
@click.command(name="get-labelled_object")
@click.option("--labelled_object-id", required=True)
@click.option("--org-id", default=None)
@click.pass_context
...
@click.command(name="delete-labelled_object")
@click.option("--labelled_object-id", required=True)
@click.option("--org-id", default=None)
@click.pass_context
...
@click.command(name="update-labelled_object")
@click.option("--object-id", required=True)
@click.option("--org-id", default=None)
@click.option("--label", multiple=True, default=None)
@click.pass_context
def cli_command_replace_labelled_object(ctx, action, **kwargs):
    output_entry(
        ctx, labels.replace_labelled_object(ctx, actions=action, **kwargs).to_dict()
    )
