...
class MergingProgress:
    ...
    def get_dataset_progress(self, dataset_name: str) -> Optional['DatasetProgress']:
        ...
        """
        return next((
            dp for dp in self.dataset_progresses
            if dp.get_trimmed_dataset_name() == dataset_name
        ), None)
    ...
    def to_dict(self) -> dict:
        ...
        return dict(
            app_progress=dict(
                ...
                dataset_progresses=dataset_progresses
            )
        )
