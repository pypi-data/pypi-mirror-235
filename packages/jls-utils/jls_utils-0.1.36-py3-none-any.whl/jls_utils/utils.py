...
def set_conn_url(conn_url: str) -> None:
    """analogue set_host_port; update conn_url for julius-core, example: \"http://localhost:8080/\""""
...
def get_app_info_by_real_id(id: str, auth: Optional[AUTH]=None, conn_url: Optional[str]=None) -> Alias.Json:
    """return json with functions app info, id is real id for app"""
    return f.get_app_info_by_real_id(id, auth=auth, conn_url=conn_url)
