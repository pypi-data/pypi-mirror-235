    ...
    def process_tests(self, datatype, section, **extra_kwargs):
        ...
        section.constants = {
            ...
            "links": {
                ...
                "latest_html": "https://{site_hostname}{BASE_HTML_URL}{pid_value}/latest",
                ...
                "self_html": "https://{site_hostname}{BASE_HTML_URL}{pid_value}/edit",
            ...
            "links_record": {
                ...
                "self_html": "https://{site_hostname}{BASE_HTML_URL}{pid_value}",
                "versions": "https://{site_hostname}/api{BASE_URL}{pid_value}/versions",
            },
        }
