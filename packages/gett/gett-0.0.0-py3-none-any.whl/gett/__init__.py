...
OG_Downloads: http://pypi.python.org/pypi/wget/
OG_Development: http://bitbucket.org/techtonik/python-wget/
Downloads: http://pypi.python.org/pypi/gett/
Development: http://github.com/franceme/gett/
...
def filename_fix_existing(filename):
    ...
    #Issue previously with files that had no extension
    #Switched raw rsplits with this, a check first then try running
    ...
    names = [get_name_ext(x)[0] for x in names]
