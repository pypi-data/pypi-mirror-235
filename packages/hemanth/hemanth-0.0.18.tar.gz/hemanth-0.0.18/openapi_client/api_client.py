...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ResumeParsingApi()
        api_instance.parse_by_file  # this is an instance of the class Endpoint
        api_instance.parse_by_file()  # this invokes api_instance.parse_by_file.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.parse_by_file.callable or self.callable in this class
