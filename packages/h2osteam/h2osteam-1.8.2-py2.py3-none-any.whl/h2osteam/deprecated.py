...
class SteamClient:
    """
        DEPRECATED!
        This class and its methods are deprecated and they will be removed in v1.8
    """

    def __init__(self, conn=None):
        self.conn = conn  # type: SteamConnection
    ...
    def show_profiles():
        ...
        """
        warnings.warn("'show_profiles' function is deprecated in favor of 'print_profiles' and will be removed in v1.8")
