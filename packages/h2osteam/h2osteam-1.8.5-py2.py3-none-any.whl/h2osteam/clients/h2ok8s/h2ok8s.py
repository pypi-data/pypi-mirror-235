...
class H2oKubernetesClient:
    ...
    def launch_cluster(name=None,
        ...
        """
        DEPRECATED! Launch new Driverless AI instance.
        """
    ...
    def get_cluster(name):
        """
        DEPRECATED! Get existing H2O cluster.
        """
        ...
        return H2oKubernetesClient().get_cluster(name)
    ...
    def get_clusters():
        """
        DEPRECATED! Get all existing H2O clusters.
        """
...
class H2oKubernetesCluster(object):
    def __init__(self, name, c=None, api=None):
