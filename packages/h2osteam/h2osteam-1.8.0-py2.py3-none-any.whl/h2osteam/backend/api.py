...
class SteamApi:
    ...
    def get_h2o_agents(self):
        ...
        Returns:
        agents: No description available (H2oAgent)
        """
        request = {
        }
        response = self.call("GetH2oAgents", request)
        return response['agents']
    
    def add_h2o_agent(self, h2o_agent_params):
        """
        Add new H2o agent

        Parameters:
        h2o_agent_params: No description available (AddH2oAgentParameters)

        Returns:None
        """
        request = {
            'h2o_agent_params': h2o_agent_params
        }
        response = self.call("AddH2oAgent", request)
        return 
    
    def remove_h2o_agent(self, agent_id):
        """
        Remove H2o agent

        Parameters:
        agent_id: No description available (int64)
        ...
        response = self.call("RemoveH2oAgent", request)
        return 
    ...
    def get_driverless_agent_engines(self):
        """
        Get engines for Driverless AI on H2O agent

        Parameters:

        Returns:
        engines: No description available (DriverlessAgentEngine)
        """
        request = {
        }
        response = self.call("GetDriverlessAgentEngines", request)
        return response['engines']
    
    def get_driverless_agent_servers(self):
        """
        Fetch Driverless agent servers

        Parameters:

        Returns:
        servers: No description available (DriverlessAgentServer)
        """
        request = {
        }
        response = self.call("GetDriverlessAgentServers", request)
        return response['servers']
    
    def add_driverless_agent_server(self, server_params):
        """
        Add new Driverless agent server parameter

        Parameters:
        server_params: No description available (AddDriverlessAgentServerParameters)
        ...
        response = self.call("AddDriverlessAgentServer", request)
        return 
    
    def remove_driverless_agent_server(self, server_id):
        """
        Remove Driverless agent server

        Parameters:
        server_id: No description available (int64)
        ...
        response = self.call("RemoveDriverlessAgentServer", request)
        return 
    
    def disable_driverless_agent_server(self, server_id):
        """
        Disable Driverless agent server
        ...
        response = self.call("DisableDriverlessAgentServer", request)
        return 
    
    def enable_driverless_agent_server(self, server_id):
        """
        Enable Driverless agent server
        ...
        response = self.call("EnableDriverlessAgentServer", request)
        return 
    ...
    def save_autodoc(self, parameters):
        """
        Save Autodoc

        Parameters:
        parameters: No description available (AutodocParameters)

        Returns:
        file_path: No description available (string)
        """
        request = {
            'parameters': parameters
        }
        response = self.call("SaveAutodoc", request)
        return response['file_path']
    
    def get_autodoc_progress(self, run_id):
        """
        Get progress of Autodoc report generator

        Parameters:
        run_id: No description available (string)

        Returns:
        progress: No description available (AutodocProgress)
        """
        request = {
            'run_id': run_id
        }
        response = self.call("GetAutodocProgress", request)
    ...
    def set_autodoc_config(self, config):
        """
        Set Autodoc configuration

        Parameters:
        config: No description available (AutodocConfig)
        ...
        response = self.call("SetAutodocConfig", request)
        return 
    
    def get_autodoc_config(self):
        """
        ...
        response = self.call("GetAutodocConfig", request)
        return response['config']
    ...
    def get_h2o_kubernetes_cluster_logs(self, instance_id):
        ...
        Returns:
        logs: No description available (string)
        """
        request = {
            'instance_id': instance_id
        }
    ...
    def dummy(self, a, b, c, d, e, f, g, h, i, j, k, l, m, n):
        """
        Does nothing
        ...
        e: No description available (ProfileDriverlessAgent)
