...
from traceml.events.schemas import V1EventSpanKind, V1SpanEvent
...
class RunProcessor:
    ...
    @classmethod
    def process_span(cls, run: Run) -> Optional["V1SpanEvent"]:
        """Converts a LangChain Run into a V1SpanEvent.
        :param run: The LangChain Run to convert.
        :return: The converted V1SpanEvent.
        """
        try:
    ...
    @classmethod
    def _convert_run_to_span(cls, run: Run) -> "V1SpanEvent":
    ...
    @classmethod
    def _convert_llm_run_to_span(cls, run: Run) -> "V1SpanEvent":
        """Converts a LangChain LLM Run into a V1SpanEvent.
    ...
    @classmethod
    def _convert_chain_run_to_span(cls, run: Run) -> "V1SpanEvent":
        """Converts a LangChain Chain Run into a V1SpanEvent.
    ...
    @classmethod
    def _convert_tool_run_to_span(cls, run: Run) -> "V1SpanEvent":
        """Converts a LangChain Tool Run into a V1SpanEvent.
    ...
    @classmethod
    def _convert_lc_run_to_span(cls, run: Run) -> "V1SpanEvent":
        """Utility to convert any generic LangChain Run into a V1SpanEvent.
        :param run: The LangChain Run to convert.
        :return: The converted V1SpanEvent.
        """
