...
class ZORO:
    ...
    def download_video(self):
        for data in self.video_sources:
            sub_or_dub = "JPN" if data["subOrDub"] == "sub" else "ENG"
            print(colored_text("[+] DOWNLOADING", "green"), colored_text(sub_or_dub, "blue"), colored_text("VIDEO SOURCE", "green"))
            print(data["url"])
            ...
            out_folder_structure = f"{self.complete_data['title']} - S{self.complete_data['season']}"
