...
class WindowCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.waveform.view.open.window.set() \n
		No command help available \n
		"""
		self._core.io.write(f'WAVeform:VIEW:OPEN:WINDow')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: WAVeform:VIEW:OPEN:WINDow \n
		Snippet: driver.waveform.view.open.window.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'WAVeform:VIEW:OPEN:WINDow', opc_timeout_ms)
