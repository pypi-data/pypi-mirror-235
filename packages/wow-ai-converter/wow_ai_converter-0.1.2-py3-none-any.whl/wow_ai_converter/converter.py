...
class Converter(object):
    ...
    def convert_to_json_cusomize_16102023(self, input_data, output_dir, is_dir=True):
        ...
        for idx, item in enumerate(_records):
            ...
            record[HOSTNAME+item['image']] =   _records_bbox
            customize_dataset.append(record)
        # print(customize_dataset[0]) 
        list= customize_dataset[0]
        list.remove("bbox")
        list.remove("transcription")
        list.remove("label")
        print(list)
        #====================
        with io.open(output_file, mode='w', encoding='utf8') as fout:
            json.dump(list, fout, indent=2, ensure_ascii=False)
