...
class MediaUploadRequest:
    ...
    def get_media(self):
        if not self.mime_type:
            self.mime_type = mimetypes.guess_type(self.file_name or self.path)[0] or "application/octet-stream"
        ...
        return {
            ...
            "downloadUrl": url,
            "thumbnailUrl": (self.file_to_url(self.thumbnail) if self.thumbnail != self.path else url) or url,
