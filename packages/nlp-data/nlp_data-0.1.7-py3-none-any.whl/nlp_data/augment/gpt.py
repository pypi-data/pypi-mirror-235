...
class GPTAugmentor:
    ...
    @validate_arguments
    def augment_nlu_by_localism(self, docs: NLUDocList[NLUDoc],  localism: Localism = Localism.guangdong, max_retry: int = 5):
        ...
        new_docs = NLUDocList[NLUDoc](docs=[])
    ...
    def augment_dialogue(self, docs: DialogueDocList, num_docs: int = 2, max_retry: int = 5):
        ...
        """
        new_docs = DialogueDocList[DialogueDoc]()
