...
from ...types.vital_token_exchange_response import VitalTokenExchangeResponse
...
class LinkClient:
    ...
    def generate(
        ...
        *,
        ...
        Parameters:
            - user_key: str. User id returned by vital create user request. This id should be stored in your database against the user and used for all interactions with the vital api.
    ...
    def create(self, *, user_id: str, expires_at: typing.Optional[dt.datetime] = None) -> VitalTokenCreatedResponse:
        """
    ...
    def exchange_token(self, *, code: str) -> VitalTokenExchangeResponse:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v2/link/code/exchange"),
            params=remove_none_from_dict({"code": code}),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(VitalTokenExchangeResponse, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
    ...
    def start(self, *, link_token: str, provider: Providers) -> typing.Dict[str, typing.Any]:
        """
        REQUEST_SOURCE: VITAL-LINK
    ...
    def oauth_provider(self, oauth_provider: OAuthProviders) -> Source:
        """
    ...
    def demo(self, *, user_id: str, provider: DemoProviders) -> DemoConnectionStatus:
        """
...
class AsyncLinkClient:
    ...
    async def exchange_token(self, *, code: str) -> VitalTokenExchangeResponse:
        """
        Redeem an invite token for an api key
    ...
    async def start(self, *, link_token: str, provider: Providers) -> typing.Dict[str, typing.Any]:
        """
        REQUEST_SOURCE: VITAL-LINK
        Start link token process
    ...
    async def state(self) -> typing.Dict[str, typing.Any]:
        """
        REQUEST_SOURCE: VITAL-LINK
        Check link token state - can be hit continuously used as heartbeat
        """
    ...
    async def oauth_provider(self, oauth_provider: OAuthProviders) -> Source:
        """
        This endpoint generates an OAuth link for oauth provider
    ...
    async def connect_ble_provider(
        self, provider: ManualProviders, *, user_id: str, provider_id: typing.Optional[str] = OMIT
    ) -> typing.Dict[str, bool]:
        """
        REQUEST_SOURCE: CUSTOMER
    ...
    async def demo(self, *, user_id: str, provider: DemoProviders) -> DemoConnectionStatus:
        """
        POST Connect the given Vital user to a demo provider.
