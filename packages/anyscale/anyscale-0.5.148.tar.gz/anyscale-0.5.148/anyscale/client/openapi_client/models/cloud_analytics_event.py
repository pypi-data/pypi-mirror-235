...
class CloudAnalyticsEvent(object):
    ...
    def __init__(self, trace_id=None, cloud_id=None, succeeded=None, command_name=None, raw_command_input=None, event_name=None, error=None, cloud_provider=None, local_vars_configuration=None):  # noqa: E501
