...
class DecoratedListServiceAPIModel(object):
    ...
    def __init__(self, id=None, name=None, created_at=None, project_id=None, current_state=None, endtime=None, type=None, service_observability_urls=None, creator=None, local_vars_configuration=None):  # noqa: E501
