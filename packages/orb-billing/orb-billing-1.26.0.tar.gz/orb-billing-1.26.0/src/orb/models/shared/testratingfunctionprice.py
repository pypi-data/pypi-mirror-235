...
class TestRatingFunctionPriceModelType(str, Enum):
...
class TestRatingFunctionPrice:
    ...
    model_type: TestRatingFunctionPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
