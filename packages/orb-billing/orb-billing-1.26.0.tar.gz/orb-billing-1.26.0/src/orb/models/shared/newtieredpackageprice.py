...
class NewTieredPackagePriceModelType(str, Enum):
...
class NewTieredPackagePrice:
    ...
    model_type: NewTieredPackagePriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
