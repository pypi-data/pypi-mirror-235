...
class PercentageDiscountIntervalDiscountType(str, Enum):
...
class PercentageDiscountInterval:
    ...
    discount_type: PercentageDiscountIntervalDiscountType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('discount_type') }})
