...
class OverrideTieredPackagePriceModelType(str, Enum):
...
class OverrideTieredPackagePrice:
    ...
    model_type: OverrideTieredPackagePriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
