...
class OverrideFivetranExamplePriceModelType(str, Enum):
    FIVETRAN_EXAMPLE = 'fivetran_example'
...
class OverrideFivetranExamplePrice:
    ...
    model_type: OverrideFivetranExamplePriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
