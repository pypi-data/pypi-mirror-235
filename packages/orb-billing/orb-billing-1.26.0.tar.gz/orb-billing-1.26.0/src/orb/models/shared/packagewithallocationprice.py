...
class PackageWithAllocationPriceModelType(str, Enum):
...
class PackageWithAllocationPrice:
    ...
    model_type: PackageWithAllocationPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
