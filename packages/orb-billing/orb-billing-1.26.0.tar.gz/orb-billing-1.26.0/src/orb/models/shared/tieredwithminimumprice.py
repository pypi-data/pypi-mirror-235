...
class TieredWithMinimumPriceModelType(str, Enum):
...
class TieredWithMinimumPrice:
    ...
    model_type: TieredWithMinimumPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
