...
class PerPriceCost:
    ...
    price_groups: Optional[list[shared_pricegroup.PriceGroup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_groups') }})
    ...
    quantity: Optional[Union[float, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quantity') }})
    r"""The price's quantity for the timeframe"""
