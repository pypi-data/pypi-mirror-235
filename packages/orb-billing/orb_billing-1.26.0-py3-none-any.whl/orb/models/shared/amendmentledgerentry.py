...
class AmendmentLedgerEntryEntryType(str, Enum):
    AMENDMENT = 'amendment'
...
class AmendmentLedgerEntry:
    ...
    entry_type: AmendmentLedgerEntryEntryType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
