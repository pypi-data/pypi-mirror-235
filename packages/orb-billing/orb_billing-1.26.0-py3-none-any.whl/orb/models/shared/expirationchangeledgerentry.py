...
class ExpirationChangeLedgerEntryEntryType(str, Enum):
...
class ExpirationChangeLedgerEntry:
    ...
    entry_type: ExpirationChangeLedgerEntryEntryType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
