...
class NewPackageWithAllocationPriceModelType(str, Enum):
...
class NewPackageWithAllocationPrice:
    ...
    model_type: NewPackageWithAllocationPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
