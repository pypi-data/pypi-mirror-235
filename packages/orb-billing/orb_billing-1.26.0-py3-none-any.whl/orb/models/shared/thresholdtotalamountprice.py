...
class ThresholdTotalAmountPriceModelType(str, Enum):
...
class ThresholdTotalAmountPrice:
    ...
    model_type: ThresholdTotalAmountPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
