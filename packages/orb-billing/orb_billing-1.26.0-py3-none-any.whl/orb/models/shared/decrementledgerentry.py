...
class DecrementLedgerEntryEntryType(str, Enum):
    DECREMENT = 'decrement'
...
class DecrementLedgerEntry:
    ...
    entry_type: DecrementLedgerEntryEntryType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
