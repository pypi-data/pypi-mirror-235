...
class TieredPackagePriceModelType(str, Enum):
...
class TieredPackagePrice:
    ...
    model_type: TieredPackagePriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
