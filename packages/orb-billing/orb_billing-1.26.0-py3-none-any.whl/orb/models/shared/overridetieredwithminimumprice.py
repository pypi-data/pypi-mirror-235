...
class OverrideTieredWithMinimumPriceModelType(str, Enum):
...
class OverrideTieredWithMinimumPrice:
    ...
    model_type: OverrideTieredWithMinimumPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
