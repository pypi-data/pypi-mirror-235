...
class KagAPIClient(APIClient):
    ...
    # Seems like requesting client/server files separately may require auth?
    ...
    def get_servers(
        self,
        filters: Optional[List[Dict[str, str]]] = None,
        # Limit/start do not work, despite documentation saying otherwise!
        # limit: Optional[int] = None,
        # start: Optional[int] = None,
    ) -> dict:
        """Get all servers known to api.

        Without any filters, may take a while.
        """
