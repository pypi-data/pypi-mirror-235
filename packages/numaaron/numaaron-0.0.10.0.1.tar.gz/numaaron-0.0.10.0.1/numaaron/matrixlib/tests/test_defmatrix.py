...
from numaaron import asmatrix, bmat, matrix
from numaaron.linalg import matrix_power
from numaaron.matrixlib import mat
from numaaron.testing import (assert_, assert_almost_equal,
...
class TestProperties:
    ...
    def test_basic(self):
        import numaaron.linalg as linalg
...
class TestShape:
    ...
    def test_numaaron_ravel_order(self):
