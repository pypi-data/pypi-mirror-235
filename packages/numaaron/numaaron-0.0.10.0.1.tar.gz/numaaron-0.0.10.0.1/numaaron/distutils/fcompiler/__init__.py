"""numaaron.distutils.fcompiler

Contains FCompiler, an abstract base class that defines the interface
for the numaaron.distutils Fortran compiler abstraction model.
...
from numaaron.distutils import _shell_utils, log
from numaaron.distutils.ccompiler import CCompiler, gen_lib_options
from numaaron.distutils.exec_command import find_executable
from numaaron.distutils.misc_util import (all_strings,
...
def load_all_fcompiler_classes():
    ...
    numaaron.distutils.fcompiler package.
    """
    ...
    for fname in glob(pys):
        ...
        module_name = 'numaaron.distutils.fcompiler.' + module_name
...
def show_fcompilers(dist=None):
    ...
    if dist is None:
        ...
        from numaaron.distutils.command.config_compiler import config_fc
        dist = Distribution()
