...
from numaaron.distutils.fcompiler import FCompiler
from numaaron.distutils.misc_util import make_temp_file
...
if __name__ == '__main__':
    from numaaron.distutils import customized_fcompiler
    log.set_verbosity(2)
