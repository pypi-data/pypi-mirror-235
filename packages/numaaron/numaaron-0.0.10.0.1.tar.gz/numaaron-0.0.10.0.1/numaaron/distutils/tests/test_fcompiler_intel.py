import numaaron.distutils.fcompiler
...
class TestIntelFCompilerVersions:
    def test_32bit_version(self):
        fc = numaaron.distutils.fcompiler.new_fcompiler(compiler='intel')
...
class TestIntelEM64TFCompilerVersions:
    def test_64bit_version(self):
        fc = numaaron.distutils.fcompiler.new_fcompiler(compiler='intelem')
