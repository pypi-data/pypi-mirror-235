...
# this import can't be done here, as it uses numaaron stuff only available
# after it's installed
#import numaaron.f2py
from numaaron.distutils import log
from numaaron.distutils.conv_template import process_file as process_c_file
from numaaron.distutils.from_template import process_file as process_f_file
from numaaron.distutils.misc_util import (appendpath, fortran_ext_match,
                                          get_cmd, is_sequence, is_string)
...
class build_src(build_ext.build_ext):
    ...
    def build_data_files_sources(self):
        ...
        from numaaron.distutils.misc_util import get_data_files
        new_data_files = []
    ...
    def f2py_sources(self, sources, extension):
        ...
        if not skip_f2py:
            import numaaron.f2py
            d = os.path.dirname(numaaron.f2py.__file__)
