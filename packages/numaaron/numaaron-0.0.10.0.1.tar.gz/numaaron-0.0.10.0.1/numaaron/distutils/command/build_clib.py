...
from numaaron.distutils.ccompiler_opt import new_ccompiler_opt
from numaaron.distutils.misc_util import (filter_sources, get_lib_source_files,
...
class build_clib(old_build_clib):
    ...
    def build_a_library(self, build_info, lib_name, libraries):
        ...
        include_dirs.extend(get_numaaron_include_dirs())
