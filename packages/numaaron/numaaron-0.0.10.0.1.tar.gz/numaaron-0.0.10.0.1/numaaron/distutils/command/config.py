...
from numaaron.distutils.command.autodist import (
...
from numaaron.distutils.mingw32ccompiler import generate_manifest
...
class config(old_config):
    ...
    def _check_compiler (self):
        ...
        from numaaron.distutils.fcompiler import FCompiler, new_fcompiler
