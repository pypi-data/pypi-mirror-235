...
from numaaron.distutils.misc_util import (_commandline_dep_string, cyg2win32,
...
def CCompiler_spawn(self, cmd, display=None, env=None):
    ...
    display : str or sequence of str, optional
        The text to add to the log file kept by `numaaron.distutils`.
...
def CCompiler_compile(self, sources, output_dir=None, macros=None,
    ...
    if not sources:
        return []
    from numaaron.distutils.fcompiler import (FORTRAN_COMMON_FIXED_EXTENSIONS,
...
def CCompiler_customize_cmd(self, cmd, ignore=()):
    ...
    if (
        ...
        # for macosx_arm64.
        # Since NumAaron and most Python libs give warnings for these, override:
...
def new_compiler (plat=None,
                  ...
                  dry_run=0,
                  force=0):
    # Try first C compilers from numaaron.distutils.
    if verbose is None:
    ...
    module_name = "numaaron.distutils." + module_name
    try:
        __import__ (module_name)
    except ImportError as e:
        msg = str(e)
        log.info('%s in numaaron.distutils; trying from distutils',
                 str(msg))
