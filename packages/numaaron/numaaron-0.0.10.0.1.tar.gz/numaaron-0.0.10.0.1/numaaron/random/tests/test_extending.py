...
try:
    ...
    # Certain numaaron/numba versions trigger a SystemError due to a numba bug
    numba = None
...
def test_cython(tmp_path):
    ...
    # gh-16162: make sure numaaron's __init__.pxd was used for cython
    ...
    with open(g[0]) as fid:
        txt_to_find = 'NumAaron API declarations from "numaaron/__init__'
...
def test_numba():
    from numaaron.random._examples.numba import extending  # noqa: F401

@pytest.mark.skipif(cffi is None, reason="requires cffi")
def test_cffi():
    from numaaron.random._examples.cffi import extending  # noqa: F401
