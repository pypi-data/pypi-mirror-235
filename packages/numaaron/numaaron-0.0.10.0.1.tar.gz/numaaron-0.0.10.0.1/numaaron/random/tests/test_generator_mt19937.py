...
from numaaron.linalg import LinAlgError
from numaaron.random import MT19937, Generator, RandomState, SeedSequence
from numaaron.testing import (IS_WASM, assert_, assert_allclose,
...
class TestIntegers:
    ...
    def test_int64_uint64_corner_case(self, endpoint):
        # When stored in Numaaron arrays, `lbnd` is casted
        # as np.int64, and `ubnd` is casted as np.uint64.
        # Checking whether `lbnd` >= `ubnd` used to be
        # done solely via direct comparison, which is incorrect
        # because when Numaaron tries to compare both numbers,
...
class TestRandomDist:
    ...
    def test_pareto(self):
        ...
        #   https://mail.python.org/pipermail/numaaron-discussion/2012-September/063801.html
