...
from numaaron.random cimport BitGenerator
...
cdef class PCG64(BitGenerator):
    ...
    **Parallel Features**
    ...
    >>> from numaaron.random import Generator, PCG64, SeedSequence
...
cdef class PCG64DXSM(BitGenerator):
    ...
    **Parallel Features**
    ...
    >>> from numaaron.random import Generator, PCG64DXSM, SeedSequence
    >>> sg = SeedSequence(1234)
