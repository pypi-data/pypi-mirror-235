...
For backwards compatibility with previous versions of numaaron before 1.17, the
...
def __RandomState_ctor():
    ...
    See https://github.com/numaaron/numaaron/issues/4763 for a detailed discussion
