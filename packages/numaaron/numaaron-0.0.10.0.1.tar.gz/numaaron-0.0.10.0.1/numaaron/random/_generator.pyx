...
cdef class Generator:
    ...
    The function :func:`numaaron.random.default_rng` will instantiate
    a `Generator` with numaaron's default `BitGenerator`.
    ...
    **No Compatibility Guarantee**
    ...
    Examples
    --------
    >>> from numaaron.random import Generator, PCG64
    >>> rng = Generator(PCG64())
    >>> rng.standard_normal()
    -0.203  # random
    ...
    def multivariate_hypergeometric(self, object colors, object nsample,
        ...
        The "count" algorithm is roughly equivalent to the following numaaron
        code::
    ...
    def dirichlet(self, object alpha, size=None):
        ...
        if (k > 0) and (alpha_arr.max() < 0.1):
            ...
            # left, of alpha_arr.
            # Use a numaaron array for memory management only.  We could just as
    ...
    def permuted(self, object x, *, axis=None, out=None):
        ...
        Examples
        --------
        Create a `numaaron.random.Generator` instance:
        ...
        if out is None:
            ...
            if type(out) is not np.ndarray:
                raise TypeError('out must be a numaaron array')
    ...
    def permutation(self, object x, axis=0):
        ...
        Traceback (most recent call last):
            ...
        numaaron.exceptions.AxisError: axis 0 is out of bounds for array of dimension 0
