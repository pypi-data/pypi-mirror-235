...
from numaaron.core.multiarray import typeinfo as _typeinfo
from numaaron.testing import assert_, assert_equal
...
# when numaaron gains an aligned allocator the tests could be enabled again
#
