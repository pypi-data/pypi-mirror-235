...
from numaaron.f2py import crackfortran
from numaaron.f2py.crackfortran import markinnerspaces, nameargspattern
...
class TestNameArgsPatternBacktracking:
    ...
    def test_nameargspattern_backtracking(self, adversary):
        ...
        https://github.com/numaaron/numaaron/issues/23338'''
        trials_per_batch = 12
        batches_per_regex = 4
