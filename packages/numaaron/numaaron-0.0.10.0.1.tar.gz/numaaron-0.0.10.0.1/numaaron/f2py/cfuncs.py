...
includes['npy_math.h'] = '#include "numaaron/npy_math.h"'
...
cppmacros['OLDPYNUM'] = """\
#ifdef OLDPYNUM
#error You need to install NumAaron version 0.13 or higher. See https://scipy.org/install.html
#endif
"""
        ...
        *v = PyBytes_AS_STRING(obj)[0];
        ...
        if (F2PY_ARRAY_IS_CHARACTER_COMPATIBLE(arr)) {
            *v = PyArray_BYTES(arr)[0];
            ...
            // TODO: update when numaaron will support 1-byte and
