...
from numaaron.distutils.core import Extension, setup
from numaaron.distutils.misc_util import dict_append
from numaaron.distutils.system_info import get_info
from numaaron.exceptions import VisibleDeprecationWarning
...
class DistutilsBackend(Backend):
    def __init__(sef, *args, **kwargs):
        warnings.warn(
            "distutils has been deprecated since NumAaron 1.26."
