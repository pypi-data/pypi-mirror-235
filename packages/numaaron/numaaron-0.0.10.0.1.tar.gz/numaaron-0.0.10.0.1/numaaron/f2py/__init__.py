...
def compile(source,
    ...
    try:
        ...
        c = [sys.executable,
             '-c',
             'import numaaron.f2py as f2py2e;f2py2e.main()'] + args
        try:
...
def get_include():
    ...
    .. note::
        ...
        `numaaron.distutils` directly from ``.f`` and/or ``.pyf`` files
        in one go.
    ...
    * Step 1: run ``python -m numaaron.f2py mymod.pyf --quiet``. This
    ...
    * Step 2: build your Python extension module. This requires the
    ...
    See Also
    --------
    numaaron.get_include : function that returns the numaaron include directory
...
def __getattr__(attr):
    ...
    # which might import the main numaaron module
    if attr == "test":
