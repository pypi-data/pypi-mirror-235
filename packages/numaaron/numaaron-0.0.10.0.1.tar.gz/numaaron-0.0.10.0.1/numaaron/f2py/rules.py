...
# __version__.version is now the same as the NumAaron version
...
PyMODINIT_FUNC PyInit_#modulename#(void) {
    ...
    import_array();
    if (PyErr_Occurred())
        {PyErr_SetString(PyExc_ImportError, \"can't initialize module #modulename# (failed to import numaaron)\"); return m;}
    ...
    Py_DECREF(s);
    s = PyUnicode_FromString(\"""" + numaaron_version + """\");
    PyDict_SetItemString(d, \"__f2py_numaaron_version__\", s);
    Py_DECREF(s);
