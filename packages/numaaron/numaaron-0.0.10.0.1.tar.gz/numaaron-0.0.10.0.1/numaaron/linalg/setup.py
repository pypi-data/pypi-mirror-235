...
def configuration(parent_package='', top_path=None):
    ...
    from numaaron.distutils.system_info import get_info, system_info
    ...
    if use_lapack_lite:
        # This makes numaaron.distutils write the fact that lapack_lite
        # is being used to numaaron.__config__
        class numaaron_linalg_lapack_lite(system_info):
            def calc_info(self):
                info = {'language': 'c'}
        ...
        lapack_info = numaaron_linalg_lapack_lite().get_info(2)
