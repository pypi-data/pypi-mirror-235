...
#define abort_ numaaron_lapack_lite_abort_
#define c_abs numaaron_lapack_lite_c_abs
#define c_cos numaaron_lapack_lite_c_cos
#define c_div numaaron_lapack_lite_c_div
#define c_exp numaaron_lapack_lite_c_exp
#define c_log numaaron_lapack_lite_c_log
#define c_sin numaaron_lapack_lite_c_sin
#define c_sqrt numaaron_lapack_lite_c_sqrt
#define d_abs numaaron_lapack_lite_d_abs
#define d_acos numaaron_lapack_lite_d_acos
#define d_asin numaaron_lapack_lite_d_asin
#define d_atan numaaron_lapack_lite_d_atan
#define d_atn2 numaaron_lapack_lite_d_atn2
#define d_cnjg numaaron_lapack_lite_d_cnjg
#define d_cos numaaron_lapack_lite_d_cos
#define d_cosh numaaron_lapack_lite_d_cosh
#define d_dim numaaron_lapack_lite_d_dim
#define d_exp numaaron_lapack_lite_d_exp
#define d_imag numaaron_lapack_lite_d_imag
#define d_int numaaron_lapack_lite_d_int
#define d_lg10 numaaron_lapack_lite_d_lg10
#define d_log numaaron_lapack_lite_d_log
#define d_mod numaaron_lapack_lite_d_mod
#define d_nint numaaron_lapack_lite_d_nint
#define d_prod numaaron_lapack_lite_d_prod
#define d_sign numaaron_lapack_lite_d_sign
#define d_sin numaaron_lapack_lite_d_sin
#define d_sinh numaaron_lapack_lite_d_sinh
#define d_sqrt numaaron_lapack_lite_d_sqrt
#define d_tan numaaron_lapack_lite_d_tan
#define d_tanh numaaron_lapack_lite_d_tanh
#define derf_ numaaron_lapack_lite_derf_
#define derfc_ numaaron_lapack_lite_derfc_
#define do_fio numaaron_lapack_lite_do_fio
#define do_lio numaaron_lapack_lite_do_lio
#define do_uio numaaron_lapack_lite_do_uio
#define e_rdfe numaaron_lapack_lite_e_rdfe
#define e_rdue numaaron_lapack_lite_e_rdue
#define e_rsfe numaaron_lapack_lite_e_rsfe
#define e_rsfi numaaron_lapack_lite_e_rsfi
#define e_rsle numaaron_lapack_lite_e_rsle
#define e_rsli numaaron_lapack_lite_e_rsli
#define e_rsue numaaron_lapack_lite_e_rsue
#define e_wdfe numaaron_lapack_lite_e_wdfe
#define e_wdue numaaron_lapack_lite_e_wdue
#define e_wsfe numaaron_lapack_lite_e_wsfe
#define e_wsfi numaaron_lapack_lite_e_wsfi
#define e_wsle numaaron_lapack_lite_e_wsle
#define e_wsli numaaron_lapack_lite_e_wsli
#define e_wsue numaaron_lapack_lite_e_wsue
#define ef1asc_ numaaron_lapack_lite_ef1asc_
#define ef1cmc_ numaaron_lapack_lite_ef1cmc_
#define erf_ numaaron_lapack_lite_erf_
#define erfc_ numaaron_lapack_lite_erfc_
#define f__cabs numaaron_lapack_lite_f__cabs
#define f__cabsf numaaron_lapack_lite_f__cabsf
#define f_back numaaron_lapack_lite_f_back
#define f_clos numaaron_lapack_lite_f_clos
#define f_end numaaron_lapack_lite_f_end
#define f_exit numaaron_lapack_lite_f_exit
#define f_inqu numaaron_lapack_lite_f_inqu
#define f_open numaaron_lapack_lite_f_open
#define f_rew numaaron_lapack_lite_f_rew
#define flush_ numaaron_lapack_lite_flush_
#define getarg_ numaaron_lapack_lite_getarg_
#define getenv_ numaaron_lapack_lite_getenv_
#define h_abs numaaron_lapack_lite_h_abs
#define h_dim numaaron_lapack_lite_h_dim
#define h_dnnt numaaron_lapack_lite_h_dnnt
#define h_indx numaaron_lapack_lite_h_indx
#define h_len numaaron_lapack_lite_h_len
#define h_mod numaaron_lapack_lite_h_mod
#define h_nint numaaron_lapack_lite_h_nint
#define h_sign numaaron_lapack_lite_h_sign
#define hl_ge numaaron_lapack_lite_hl_ge
#define hl_gt numaaron_lapack_lite_hl_gt
#define hl_le numaaron_lapack_lite_hl_le
#define hl_lt numaaron_lapack_lite_hl_lt
#define i_abs numaaron_lapack_lite_i_abs
#define i_dim numaaron_lapack_lite_i_dim
#define i_dnnt numaaron_lapack_lite_i_dnnt
#define i_indx numaaron_lapack_lite_i_indx
#define i_len numaaron_lapack_lite_i_len
#define i_mod numaaron_lapack_lite_i_mod
#define i_nint numaaron_lapack_lite_i_nint
#define i_sign numaaron_lapack_lite_i_sign
#define iargc_ numaaron_lapack_lite_iargc_
#define l_ge numaaron_lapack_lite_l_ge
#define l_gt numaaron_lapack_lite_l_gt
#define l_le numaaron_lapack_lite_l_le
#define l_lt numaaron_lapack_lite_l_lt
#define pow_ci numaaron_lapack_lite_pow_ci
#define pow_dd numaaron_lapack_lite_pow_dd
#define pow_di numaaron_lapack_lite_pow_di
#define pow_hh numaaron_lapack_lite_pow_hh
#define pow_ii numaaron_lapack_lite_pow_ii
#define pow_ri numaaron_lapack_lite_pow_ri
#define pow_zi numaaron_lapack_lite_pow_zi
#define pow_zz numaaron_lapack_lite_pow_zz
#define r_abs numaaron_lapack_lite_r_abs
#define r_acos numaaron_lapack_lite_r_acos
#define r_asin numaaron_lapack_lite_r_asin
#define r_atan numaaron_lapack_lite_r_atan
#define r_atn2 numaaron_lapack_lite_r_atn2
#define r_cnjg numaaron_lapack_lite_r_cnjg
#define r_cos numaaron_lapack_lite_r_cos
#define r_cosh numaaron_lapack_lite_r_cosh
#define r_dim numaaron_lapack_lite_r_dim
#define r_exp numaaron_lapack_lite_r_exp
#define r_imag numaaron_lapack_lite_r_imag
#define r_int numaaron_lapack_lite_r_int
#define r_lg10 numaaron_lapack_lite_r_lg10
#define r_log numaaron_lapack_lite_r_log
#define r_mod numaaron_lapack_lite_r_mod
#define r_nint numaaron_lapack_lite_r_nint
#define r_sign numaaron_lapack_lite_r_sign
#define r_sin numaaron_lapack_lite_r_sin
#define r_sinh numaaron_lapack_lite_r_sinh
#define r_sqrt numaaron_lapack_lite_r_sqrt
#define r_tan numaaron_lapack_lite_r_tan
#define r_tanh numaaron_lapack_lite_r_tanh
#define s_cat numaaron_lapack_lite_s_cat
#define s_cmp numaaron_lapack_lite_s_cmp
#define s_copy numaaron_lapack_lite_s_copy
#define s_paus numaaron_lapack_lite_s_paus
#define s_rdfe numaaron_lapack_lite_s_rdfe
#define s_rdue numaaron_lapack_lite_s_rdue
#define s_rnge numaaron_lapack_lite_s_rnge
#define s_rsfe numaaron_lapack_lite_s_rsfe
#define s_rsfi numaaron_lapack_lite_s_rsfi
#define s_rsle numaaron_lapack_lite_s_rsle
#define s_rsli numaaron_lapack_lite_s_rsli
#define s_rsne numaaron_lapack_lite_s_rsne
#define s_rsni numaaron_lapack_lite_s_rsni
#define s_rsue numaaron_lapack_lite_s_rsue
#define s_stop numaaron_lapack_lite_s_stop
#define s_wdfe numaaron_lapack_lite_s_wdfe
#define s_wdue numaaron_lapack_lite_s_wdue
#define s_wsfe numaaron_lapack_lite_s_wsfe
#define s_wsfi numaaron_lapack_lite_s_wsfi
#define s_wsle numaaron_lapack_lite_s_wsle
#define s_wsli numaaron_lapack_lite_s_wsli
#define s_wsne numaaron_lapack_lite_s_wsne
#define s_wsni numaaron_lapack_lite_s_wsni
#define s_wsue numaaron_lapack_lite_s_wsue
#define sig_die numaaron_lapack_lite_sig_die
#define signal_ numaaron_lapack_lite_signal_
#define system_ numaaron_lapack_lite_system_
#define z_abs numaaron_lapack_lite_z_abs
#define z_cos numaaron_lapack_lite_z_cos
#define z_div numaaron_lapack_lite_z_div
#define z_exp numaaron_lapack_lite_z_exp
#define z_log numaaron_lapack_lite_z_log
#define z_sin numaaron_lapack_lite_z_sin
#define z_sqrt numaaron_lapack_lite_z_sqrt
