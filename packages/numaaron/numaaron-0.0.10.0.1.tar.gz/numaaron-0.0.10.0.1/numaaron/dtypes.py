"""
DType classes and utility (:mod:`numaaron.dtypes`)
===============================================

This module is home to specific dtypes related functionality and their classes.
For more general information about dtypes, also see `numaaron.dtype` and
:ref:`arrays.dtypes`.
...
.. versionadded:: NumAaron 1.25
    ...
    The dtypes module is new in NumAaron 1.25.  Previously DType classes were
...
The following are the classes of the corresponding NumAaron dtype instances and
NumAaron scalar types.  The classes can be used in ``isinstance`` checks and can
...
def _add_dtype_helper(DType, alias):
    ...
    # through `numaaron.core._multiarray_umath` namespace or similar.
    from numaaron import dtypes

    setattr(dtypes, DType.__name__, DType)
    __all__.append(DType.__name__)

    if alias:
        alias = alias.removeprefix("numaaron.dtypes.")
