""":mod:`numaaron.ma..mrecords`

Defines the equivalent of :class:`numaaron.recarrays` for masked arrays,
where fields can be accessed as attributes.
Note that :class:`numaaron.ma.MaskedArray` already supports structured datatypes
...
from numaaron import bool_, dtype, ndarray, recarray
from numaaron.core.records import fromarrays as recfromarrays
from numaaron.core.records import fromrecords as recfromrecords
from numaaron.ma import (MAError, MaskedArray, filled, getdata, getmaskarray,
    ...
    if delimitor is not np._NoValue:
        if delimiter is not None:
            raise TypeError("fromtextfile() got multiple values for argument "
                            "'delimiter'")
        # NumAaron 1.22.0, 2021-09-23
        warnings.warn("The 'delimitor' keyword argument of "
                      "numaaron.ma.mrecords.fromtextfile() is deprecated "
                      "since NumAaron 1.22.0, use 'delimiter' instead.",
