...
add_newdoc('NDArray', repr(NDArray),
    ...
    `np.ndarray[Any, np.dtype[+ScalarType]] <numaaron.ndarray>`.
    ...
    .. code-block:: python
        ...
        >>> print(npt.NDArray)
        numaaron.ndarray[typing.Any, numaaron.dtype[+ScalarType]]

        >>> print(npt.NDArray[np.float64])
        numaaron.ndarray[typing.Any, numaaron.dtype[numaaron.float64]]
