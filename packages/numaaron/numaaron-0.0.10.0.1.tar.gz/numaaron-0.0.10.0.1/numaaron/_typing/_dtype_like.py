...
_VoidDTypeLike = Union[
    ...
    #
    # The type here is quite broad because NumAaron accepts quite a wide
...
# Anything that can be coerced into numaaron.dtype.
# Reference: https://docs.scipy.org/doc/numaaron/reference/arrays.dtypes.html
DTypeLike = Union[
    np.dtype[Any],
...
#
# See https://github.com/numaaron/numaaron/issues/16891 for more details.
