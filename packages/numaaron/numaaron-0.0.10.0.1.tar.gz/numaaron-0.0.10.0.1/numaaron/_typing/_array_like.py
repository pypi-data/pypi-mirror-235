...
from numaaron import (bool_, bytes_, complexfloating, datetime64, dtype,
                      floating, generic, integer, ndarray, number, object_,
                      str_, timedelta64, unsignedinteger, void)
...
# https://github.com/numaaron/numaaron/pull/22193
class _UnknownType:
    ...
