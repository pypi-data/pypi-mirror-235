...
from numaaron.core.multiarray import dragon4_positional, dragon4_scientific
from numaaron.core.umath import absolute
...
def as_series(alist, trim=True):
    ...
    Examples
    --------
    >>> from numaaron.polynomial import polyutils as pu
    >>> a = np.arange(4)
    >>> pu.as_series(a)
