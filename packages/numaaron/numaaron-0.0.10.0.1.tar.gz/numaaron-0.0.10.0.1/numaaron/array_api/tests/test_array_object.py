...
from numaaron.testing import assert_raises, suppress_warnings
...
def test_validate_index():
    ...
    # by the spec. But the NumAaron array API implementation specifically
    ...
    # already invalid in NumAaron itself because Array will generally just pass
...
def test_array_keys_use_private_array():
    ...
    Fails when array_api array keys are not converted into NumAaron-proper arrays
    in __getitem__(). This is achieved by passing array_api arrays with 0-sized
    dimensions, which NumAaron-proper treats erroneously - not sure why!
