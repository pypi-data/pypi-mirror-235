...
def argsort(
    ...
    """
    Array API compatible wrapper for :py:func:`np.argsort <numaaron.argsort>`.
    ...
    if not descending:
        ...
        # As NumAaron has no native descending sort, we imitate it here. Note that
...
def sort(
    ...
    """
    Array API compatible wrapper for :py:func:`np.sort <numaaron.sort>`.
