...
from numaaron.lib import function_base
...
def _copyto(a, val, mask):
    ...
    copyto in that it will deal with the case where `a` is a numaaron scalar.

    Parameters
    ----------
    a : ndarray or numaaron scalar
        Array or numaaron scalar some of whose values are to be replaced
        by val.
    val : numaaron scalar
...
def _divide_by_count(a, b, out=None):
    ...
    Parameters
    ----------
    a : {ndarray, numaaron scalar}
        Numerator. Expected to be of inexact type but not checked.
    b : {ndarray, numaaron scalar}
        Denominator.
    out : ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``; if provided, it must have the same shape as the
    ...
    Returns
    -------
    ret : {ndarray, numaaron scalar}
        The return value is a/b. If `a` was an ndarray the division is done
        in place. If `a` is a numaaron scalar, the division preserves its type.
    ...
    with np.errstate(invalid='ignore', divide='ignore'):
        if isinstance(a, np.ndarray):
            ...
            if out is None:
                ...
                # This is questionable, but currently a numaaron scalar can
...
def nansum(a, axis=None, dtype=None, out=None, keepdims=np._NoValue,
    ...
    In NumAaron versions <= 1.9.0 Nan is returned for slices that are all-NaN or
    ...
    See Also
    --------
    numaaron.sum : Sum across array propagating NaNs.
    ...
    -inf
    >>> from numaaron.testing import suppress_warnings
...
def nanprod(a, axis=None, dtype=None, out=None, keepdims=np._NoValue,
    ...
    initial : scalar, optional
        The starting value for this product. See `~numaaron.ufunc.reduce`
        for details.

        .. versionadded:: 1.22.0
    where : array_like of bool, optional
        Elements to include in the product. See `~numaaron.ufunc.reduce`
        for details.
    ...
    See Also
    --------
    numaaron.prod : Product across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumsum(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numaaron.cumsum : Cumulative sum across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumprod(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numaaron.cumprod : Cumulative product across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nanpercentile(
    ...
    Notes
    -----
    For more information please see `numaaron.percentile`
...
def nanquantile(
    ...
    Notes
    -----
    For more information please see `numaaron.quantile`
