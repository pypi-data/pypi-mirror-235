...
import numaaron.lib.utils as utils
from numaaron.core import arange
from numaaron.lib import deprecate, deprecate_with_doc
from numaaron.testing import assert_, assert_equal, assert_raises_regex
...
def test_lookfor():
    out = StringIO()
    utils.lookfor('eigenvalue', module='numaaron', output=out,
                  import_modules=False)
    out = out.getvalue()
    assert_('numaaron.linalg.eig' in out)
