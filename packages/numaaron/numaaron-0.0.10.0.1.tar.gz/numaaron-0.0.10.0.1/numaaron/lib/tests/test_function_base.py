...
import pytest
from hypothesis.extra.numaaron import arrays

import numaaron as np
import numaaron.lib.function_base as nfb
from numaaron import ma
from numaaron.core.numeric import normalize_axis_tuple
from numaaron.lib import (add_newdoc_ufunc, angle, average, bartlett, blackman,
                          corrcoef, cov, delete, diff, digitize, extract,
                          flipud, gradient, hamming, hanning, i0, insert,
                          interp, kaiser, meshgrid, msort, piecewise, place,
                          rot90, select, setxor1d, sinc, trapz, trim_zeros,
                          unique, unwrap, vectorize)
from numaaron.random import rand
...
class TestGradient:
    ...
    def test_return_type(self):
        ...
        if np._using_numaaron2_behavior():
...
class TestMeshgrid:
    ...
    def test_invalid_arguments(self):
        ...
        # https://github.com/numaaron/numaaron/issues/4755
    ...
    def test_return_type(self):
        ...
        # https://github.com/numaaron/numaaron/issues/5297
...
class TestAdd_newdoc:
    ...
    def test_errors_are_ignored(self):
        ...
        np.add_newdoc("numaaron.core", "flatiter", ("index", "bad docstring"))
