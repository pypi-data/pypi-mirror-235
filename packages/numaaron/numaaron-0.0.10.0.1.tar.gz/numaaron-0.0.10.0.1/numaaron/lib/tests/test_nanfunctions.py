...
from numaaron.lib.nanfunctions import _nan_mask, _replace_nan
from numaaron.testing import (assert_, assert_almost_equal, assert_array_equal,
...
class TestNanFunctions_Percentile:
    ...
    def test_result_values(self):
        ...
        assert_almost_equal(res, tgt)
        # Transpose the array to fit the output convention of numaaron.percentile
