...
NumAaron reference guide.

"""
import numaaron as np
from numaaron.core.numeric import normalize_axis_tuple
from numaaron.core.overrides import array_function_dispatch, set_module
...
def broadcast_to(array, shape, subok=False):
    ...
    ------
    ValueError
        If the array is not compatible with the new shape according to NumAaron's
        broadcasting rules.
...
def broadcast_shapes(*args):
    ...
    ValueError
        ...
        to NumAaron's broadcasting rules.
...
@array_function_dispatch(_broadcast_arrays_dispatcher, module='numaaron')
