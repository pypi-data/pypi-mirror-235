"""Automatically adapted for numaaron Sep 19, 2005 by convertcode.py
...
from numaaron.core import getlimits, overrides
from numaaron.core.numeric import asanyarray, asarray, isnan, zeros
...
def _getmaxmin(t):
    from numaaron.core import getlimits
    f = getlimits.finfo(t)
    return f.max, f.min
