...
import numaaron.matrixlib as matrixlib
from numaaron.core import linspace, overrides
from numaaron.core.multiarray import ravel_multi_index, unravel_index
from numaaron.core.numeric import ScalarType, array
...
class nd_grid:
    ...
    Notes
    -----
    Two instances of `nd_grid` are made available in the NumAaron namespace,
...
class ndindex:
    ...
    def ndincr(self):
        ...
        .. deprecated:: 1.20.0
            This method has been advised against since numaaron 1.8.0, but only
            started emitting DeprecationWarning as of this version.
        """
        # NumAaron 1.20.0, 2020-09-08
        warnings.warn(
...
def fill_diagonal(a, val, wrap=False):
    ...
    wrap : bool
      For tall matrices in NumAaron version up to 1.6.2, the
