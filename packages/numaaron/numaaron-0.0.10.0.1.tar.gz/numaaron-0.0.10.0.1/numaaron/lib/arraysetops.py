...
`numaaron.sort`, that can provide directly the permutation vectors, thus avoiding
calls to `numaaron.argsort`.
...
def unique(ar, return_index=False, return_inverse=False,
    ...
    * the number of times each unique value comes up in the input array
    ...
    See Also
    --------
    numaaron.lib.arraysetops : Module with a number of other functions for
...
def in1d(ar1, ar2, assume_unique=False, invert=False, *, kind=None):
    ...
    if use_table_method:
        ...
        # https://github.com/numaaron/numaaron/pull/12065.
