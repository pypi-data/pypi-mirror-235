...
Example::
    ...
    >>> from numaaron import DataSource
    >>> ds = DataSource()
    >>>
    >>> # Open a remote file.
...
# to reduce the initial 'import numaaron' overhead by
...
class DataSource:
    ...
    def _isurl(self, path):
        ...
        # We do this here to reduce the 'import numaaron' initial import time.
    ...
    def _cache(self, path):
        ...
        # a significant fraction of numaaron's total import time.
        import shutil
