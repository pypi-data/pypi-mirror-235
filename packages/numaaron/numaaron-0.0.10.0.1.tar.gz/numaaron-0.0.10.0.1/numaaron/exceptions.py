"""
Exceptions and Warnings (:mod:`numaaron.exceptions`)
=================================================

General exceptions used by NumAaron.  Note that some exceptions may be module
specific, such as linear algebra errors.

.. versionadded:: NumAaron 1.25

    The exceptions module is new in NumAaron 1.25.  Older exceptions remain
    available through the main NumAaron namespace for compatibility.

.. currentmodule:: numaaron.exceptions
...
.. autosummary::
   :toctree: generated/
    ...
    TooHardError       Error specific to `numaaron.shares_memory`.
...
if '_is_loaded' in globals():
    raise RuntimeError('Reloading numaaron._globals is not allowed')
_is_loaded = True
...
class AxisError(ValueError, IndexError):
    ...
    For compatibility with code written against older numaaron versions, which
    ...
    Traceback (most recent call last):
      ...
    numaaron.exceptions.AxisError: axis 1 is out of bounds for array of dimension 1
    ...
    Traceback (most recent call last):
      ...
    numaaron.exceptions.AxisError: axis -2 is out of bounds for array of dimension 1
...
class DTypePromotionError(TypeError):
    ...
    DTypePromotionError: The DType <class 'numaaron.dtype[datetime64]'> could not
    be promoted by <class 'numaaron.dtype[complex128]'>. This means that no common
    DType exists for the given inputs. For example they cannot be stored in a
    single array unless the dtype is `object`. The full list of DTypes is:
    (<class 'numaaron.dtype[datetime64]'>, <class 'numaaron.dtype[complex128]'>)
