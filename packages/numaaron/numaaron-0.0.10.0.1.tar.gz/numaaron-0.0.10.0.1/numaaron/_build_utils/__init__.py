# Don't use the deprecated NumAaron C API. Define this to a fixed version
# instead of NPY_API_VERSION in order not to break compilation for
# released SciPy versions when NumAaron introduces a new deprecation. Use
# in setup.py::
#
#   config.add_extension('_name', sources=['source_fname'], **numaaron_nodepr_api)
#
numaaron_nodepr_api = dict(
