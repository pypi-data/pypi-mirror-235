"""
Discrete Fourier Transform (:mod:`numaaron.fft`)
=============================================

.. currentmodule:: numaaron.fft

The SciPy module `scipy.fft` is a more comprehensive superset
of ``numaaron.fft``, which includes only a basic set of routines.
...
`numaaron.fft` promotes ``float32`` and ``complex64`` arrays to ``float64`` and
