#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_RANDOM_DISTRIBUTIONS_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_RANDOM_DISTRIBUTIONS_H_
...
#include "numaaron/random/bitgen.h"
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_RANDOM_DISTRIBUTIONS_H_ */
