 ...
 *              NPY_CPU_WASM
 */
#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_CPU_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_CPU_H_
...
#include "numaaronconfig.h"
    ...
    /* _M_ARM64 is defined in MSVC for ARM64 compilation on Windows */
        ...
        #endif
    #else
        # error Unknown ARM CPU, please report this to numaaron maintainers with \
    ...
    #define NPY_CPU_WASM
#else
    #error Unknown CPU, please report this to numaaron maintainers with \
    information about your platform (OS, CPU and compiler)
#endif
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_CPU_H_ */
