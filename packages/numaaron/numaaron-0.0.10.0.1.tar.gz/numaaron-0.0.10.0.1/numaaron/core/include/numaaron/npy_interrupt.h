...
#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_INTERRUPT_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_INTERRUPT_H_
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_INTERRUPT_H_ */
