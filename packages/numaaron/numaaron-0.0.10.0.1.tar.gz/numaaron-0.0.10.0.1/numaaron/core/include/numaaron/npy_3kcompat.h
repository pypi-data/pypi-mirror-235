...
#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_3KCOMPAT_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_3KCOMPAT_H_
...
npy_PyFile_Dup2(PyObject *file, char *mode, npy_off_t *orig_pos)
{
    ...
    if (handle == NULL) {
        PyErr_SetString(PyExc_IOError,
                        ...
                        "_fdopen failed. If you built NumAaron, you probably "
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_3KCOMPAT_H_ */
