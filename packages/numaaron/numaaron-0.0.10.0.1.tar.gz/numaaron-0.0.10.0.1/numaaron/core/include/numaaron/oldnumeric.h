#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_OLDNUMERIC_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_OLDNUMERIC_H_
...
#undef import_array
#define import_array() { if (_import_array() < 0) {PyErr_Print(); PyErr_SetString(PyExc_ImportError, "numaaron.core.multiarray failed to import"); } }

#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_OLDNUMERIC_H_ */
