#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_MATH_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_MATH_H_
 ...
 * only available if npy_config.h is available (= numaarons own build) */
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_MATH_H_ */
