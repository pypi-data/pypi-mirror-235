#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_ENDIAN_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_ENDIAN_H_
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_ENDIAN_H_ */
