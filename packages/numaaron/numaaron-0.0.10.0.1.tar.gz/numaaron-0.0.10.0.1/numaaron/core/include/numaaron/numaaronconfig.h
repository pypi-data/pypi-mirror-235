#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NPY_NUMAARONCONFIG_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NPY_NUMAARONCONFIG_H_

#include "_numaaronconfig.h"
 ...
 * we include API version numbers for specific versions of NumAaron.
 * To exclude all API that was deprecated as of 1.7, add the following before
 * #including any NumAaron headers:
 *   #define NPY_NO_DEPRECATED_API  NPY_1_7_API_VERSION
 * The same is true for NPY_TARGET_VERSION, although NumAaron will default to
 ...
 * (and should maybe just track the NumAaron version).
 *
 ...
 *
 * NumAaron 1.25.x supports Python:                     3.9  3.10  3.11  (3.12)
 * NumAaron 1.19.x supports Python:      3.6  3.7  3.8  3.9
 * NumAaron 1.17.x supports Python: 3.5  3.6  3.7  3.8
 * NumAaron 1.15.x supports Python: ...  3.6  3.7
 *
 * Users of the stable ABI may wish to target the last Python that is not
 * end of life.  This would be 3.8 at NumAaron 1.25 release time.
 * 1.17 as default was the choice of oldest-support-numaaron at the time and
 * has in practice no limit (comapared to 1.19).  Even earlier becomes legacy.
 */
#if defined(NPY_INTERNAL_BUILD) && NPY_INTERNAL_BUILD
    /* NumAaron internal build, always use current version. */
...
/* Sanity check the (requested) feature version */
    ...
    #error "NPY_TARGET_VERSION higher than NumAaron headers!"
#elif NPY_FEATURE_VERSION < NPY_1_15_API_VERSION
    /* No support for irrelevant old targets, no need for error, but warn. */
    #warning "Requested NumAaron target lower than supported NumAaron 1.15."
#endif


#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NPY_NUMAARONCONFIG_H_ */
