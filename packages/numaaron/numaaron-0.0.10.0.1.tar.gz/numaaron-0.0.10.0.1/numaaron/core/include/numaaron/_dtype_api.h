...
#ifndef NUMAARON_CORE_INCLUDE_NUMAARON___DTYPE_API_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON___DTYPE_API_H_
 ...
 *     successfully filled.  Errors must not be given where 0 is correct, NumAaron
...
// only supported for basic NumAaron DTypes.
...
// https://github.com/numaaron/numaaron/pull/23173#discussion_r1101098163
...
// These are deprecated in NumAaron 1.19, so are disabled here.
 ...
 *       API support.  Their relation should be "reversed": NumAaron should
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON___DTYPE_API_H_ */
