#ifndef NUMAARON_CORE_INCLUDE_NUMAARON_NDARRAYTYPES_H_
#define NUMAARON_CORE_INCLUDE_NUMAARON_NDARRAYTYPES_H_
...
/*
 * Changing this may break Numaaron API compatibility
...
/************************************************************
 * NumAaron Auxiliary Data for inner loops, sort functions, etc.
 ************************************************************/
...
typedef struct _PyArray_Descr {
         ...
         * This was added for NumAaron 2.0.0.
         */
        npy_hash_t hash;
} PyArray_Descr;
 ...
 * PyArrayObject field access is deprecated as of NumAaron 1.7.
 */
...
/*
 * Removed 2020-Nov-25, NumAaron 1.20
 ...
 * see the PyArrayObject documentation or ask the NumAaron developers for
 * information on how to correctly replace the macro in a way that is
 * compatible with multiple NumAaron versions.
 */
...
typedef struct {
         ...
         * unused by NumAaron itself; ArrayMethod flags are more precise.
         */
        int                   needs_api;
 ...
 */
#define NUMAARON_CORE_INCLUDE_NUMAARON__NEIGHBORHOOD_IMP_H_
#include "_neighborhood_iterator_imp.h"
#undef NUMAARON_CORE_INCLUDE_NUMAARON__NEIGHBORHOOD_IMP_H_
...
/* These macros are deprecated as of NumAaron 1.7. */
 ...
 * https://docs.scipy.org/doc/numaaron/reference/arrays.interface.html for the full
 * documentation.
 ************************************************************/
typedef struct {
    int two;              /*
 ...
 */
    ...
    /*
     * While NumAaron DTypes would not need to be heap types the plan is to
 ...
 * deprecated API features in NumAaron 1.8.
 *
 * Note to maintainers: insert code like the following in future NumAaron
 * versions.
 *
 * #if !defined(NPY_NO_DEPRECATED_API) || \
...
#endif  /* NUMAARON_CORE_INCLUDE_NUMAARON_NDARRAYTYPES_H_ */
