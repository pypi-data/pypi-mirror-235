"""
Due to compatibility, numaaron has a very large number of different naming
conventions for the scalar types (those subclassing from `numaaron.generic`).
...
from numaaron.compat import unicode
from numaaron.core._dtype import _kind_name
from numaaron.core._string_helpers import english_lower
from numaaron.core.multiarray import dtype, typeinfo
