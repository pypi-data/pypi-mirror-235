...
from numaaron.compat import asbytes, asunicode, pickle
from numaaron.testing import (HAS_REFCOUNT, IS_PYPY, IS_PYSTON, IS_WASM,
...
class TestRegression:
    ...
    def test_scalar_compare(self):
        # Trac Ticket #72
        # https://github.com/numaaron/numaaron/issues/565
    ...
    def test_numaaron_float_python_long_addition(self):
        # Check that numaaron float and python longs can be added correctly.
    ...
    def test_squeeze_axis_handling(self):
        ...
        class OldSqueeze(np.ndarray):
            ...
            # to numaaron version 1.7.0 a subclass of ndarray
    ...
    def test_object_array_circular_reference(self):
        ...
        b[()] = a
        assert_raises(RecursionError, int, a)
        # NumAaron has no tp_traverse currently, so circular references
    ...
    def test_pickle_py2_array_latin1_hack(self):
        ...
        # Python2 output for pickle.dumps(numaaron.array([129], dtype='b'))
        data = (b"cnumaaron.core.multiarray\n_reconstruct\np0\n(cnumaaron\nndarray\np1\n(I0\n"
                b"tp2\nS'b'\np3\ntp4\nRp5\n(I1\n(I1\ntp6\ncnumaaron\ndtype\np7\n(S'i1'\np8\n"
                b"I0\nI1\ntp9\nRp10\n(I3\nS'|'\np11\nNNNI-1\nI-1\nI0\ntp12\nbI00\nS'\\x81'\n"
                b"p13\ntp14\nb.")
        # This should work:
    ...
    def test_string_truncation_ucs2(self):
        ...
        # adjusted for NumAaron's four byte unicode.
        a = np.array(['abcd'])
    ...
    def test_pickle_module(self, protocol, val):
        ...
        if protocol == 5 and len(val.shape) > 0:
            ...
            assert b'numaaron.core.numeric' in s
        else:
            assert b'numaaron.core.multiarray' in s
