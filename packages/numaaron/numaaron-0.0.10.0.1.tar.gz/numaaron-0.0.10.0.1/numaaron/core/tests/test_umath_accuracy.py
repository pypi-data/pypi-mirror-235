...
from numaaron.core._multiarray_umath import __cpu_features__
from numaaron.testing import assert_array_max_ulp
...
# only run on linux with AVX, also avoid old glibc (numaaron/numaaron#20448).
