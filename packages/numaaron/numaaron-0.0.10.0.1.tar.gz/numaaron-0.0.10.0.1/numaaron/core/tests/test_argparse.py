"""
Tests for the private NumAaron argument parsing functionality.
They mainly exists to ensure good test coverage without having to try the
weirder cases on actual numaaron functions but test them in one place.
...
from numaaron.core._multiarray_tests import argparse_example_function as func
...
def test_string_fallbacks():
    # We can (currently?) use numaaron strings to test the "slow" fallbacks
