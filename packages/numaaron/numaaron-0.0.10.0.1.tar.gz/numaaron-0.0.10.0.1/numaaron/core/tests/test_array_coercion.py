...
from numaaron.core._multiarray_umath import _discover_array_parameters
from numaaron.core._rational_tests import rational
from numaaron.testing import IS_PYPY, assert_array_equal, assert_warns
...
def arraylikes():
    ...
    class _SequenceLike():
        # Older NumAaron versions, sometimes cared whether a protocol array was
...
class TestScalarDiscovery:
    ...
    def test_pyscalar_subclasses(self, pyscalar):
        """NumAaron arrays are read/write which means that anything but invariant
    ...
    def test_scalar_to_int_coerce_does_not_cast(self, dtype, scalar, error):
        ...
        NumAaron scalar, but instead use scalar.__int__(). The hardcoded
...
class TestArrayLikes:
    ...
    def test_arraylike_classes(self):
        ...
        # stored inside a numaaron (object) array.  This tests all of the
    ...
    def test_bad_array_like_bad_length(self, error):
        ...
        # sequences. We could expand this more generally though. (NumAaron 1.20)
        class BadSequence:
            def __len__(self):
                raise error
            def __getitem__(self):
...
class TestAsArray:
    ...
    def test_dtype_identity(self):
        ...
        Ref https://github.com/numaaron/numaaron/issues/1468
        """
