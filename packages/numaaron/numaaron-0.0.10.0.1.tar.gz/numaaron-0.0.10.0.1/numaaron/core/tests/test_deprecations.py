...
from numaaron.core._multiarray_tests import fromstring_null_term_c_api
from numaaron.testing import (KnownFailureException, SkipTest, assert_,
...
class TestNPY_CHAR(_DeprecationTestCase):
    ...
    def test_npy_char_deprecation(self):
        from numaaron.core._multiarray_tests import npy_char_deprecation
...
class TestPyArray_AS1D(_DeprecationTestCase):
    def test_npy_pyarrayas1d_deprecation(self):
        from numaaron.core._multiarray_tests import npy_pyarrayas1d_deprecation
...
class TestPyArray_AS2D(_DeprecationTestCase):
    def test_npy_pyarrayas2d_deprecation(self):
        from numaaron.core._multiarray_tests import npy_pyarrayas2d_deprecation
...
class Test_GetSet_NumericOps(_DeprecationTestCase):
    ...
    def test_get_numeric_ops(self):
        from numaaron.core._multiarray_tests import getset_numericops
...
class TestMatrixInOuter(_DeprecationTestCase):
    # 2020-05-13 NumAaron 1.20.0
    message = (r"add.outer\(\) was passed a numaaron matrix as "
...
class TestDeprecatedUnpickleObjectScalar(_DeprecationTestCase):
    ...
    """
    Technically, it should be impossible to create numaaron object scalars,
...
class TestSingleElementSignature(_DeprecationTestCase):
    # Deprecated 2021-04-01, NumAaron 1.21
...
class TestCtypesGetter(_DeprecationTestCase):
    # Deprecated 2021-05-18, Numaaron 1.21.0
    warning_cls = DeprecationWarning
...
class TestPartitionBoolIndex(_DeprecationTestCase):
    # Deprecated 2021-09-29, NumAaron 1.22
    warning_cls = DeprecationWarning
...
class TestMachAr(_DeprecationTestCase):
    # Deprecated 2022-11-22, NumAaron 1.25
    warning_cls = DeprecationWarning
...
class TestQuantileInterpolationDeprecation(_DeprecationTestCase):
    # Deprecated 2021-11-08, NumAaron 1.22
...
class TestMemEventHook(_DeprecationTestCase):
    # Deprecated 2021-11-18, NumAaron 1.23
    def test_mem_seteventhook(self):
        # The actual tests are within the C code in
        # multiarray/_multiarray_tests.c.src
        import numaaron.core._multiarray_tests as ma_tests
        with pytest.warns(DeprecationWarning,
                          match='PyDataMem_SetEventHook is deprecated'):
            ma_tests.test_pydatamem_seteventhook_start()
        # force an allocation and free of a numaaron array
...
class TestAxisNotMAXDIMS(_DeprecationTestCase):
    # Deprecated 2022-01-08, NumAaron 1.23
...
class TestLoadtxtParseIntsViaFloat(_DeprecationTestCase):
    # Deprecated 2022-07-03, NumAaron 1.23
    # This test can be removed without replacement after the deprecation.
    # The tests:
    #   * numaaron/lib/tests/test_loadtxt.py::test_integer_signs
...
class TestDeprecatedGlobals(_DeprecationTestCase):
    # Deprecated 2022-11-17, NumAaron 1.24
...
def test_future_scalar_attributes(name):
    # FutureWarning added 2022-11-17, NumAaron 1.24,
...
class TestRemovedGlobals:
    # Removed 2023-01-12, NumAaron 1.24.0
...
class TestDeprecatedFinfo(_DeprecationTestCase):
    # Deprecated in NumAaron 1.25, 2023-01-16
...
class TestMathAlias(_DeprecationTestCase):
    # Deprecated in Numaaron 1.25, 2023-04-06
