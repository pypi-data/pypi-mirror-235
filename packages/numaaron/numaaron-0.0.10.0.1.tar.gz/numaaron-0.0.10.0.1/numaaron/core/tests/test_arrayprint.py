...
from numaaron.core.arrayprint import _typelessdata
from numaaron.testing import (HAS_REFCOUNT, assert_, assert_equal,
...
class TestArray2String:
    ...
    def test_format_function(self):
        ...
        s = np.array(['abc', 'def'])
        assert_(np.array2string(s, formatter={'numaaronstr':lambda s: s*2}) ==
                '[abcabc defdef]')
