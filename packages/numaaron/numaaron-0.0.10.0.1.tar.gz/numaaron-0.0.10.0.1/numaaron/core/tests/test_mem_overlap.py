...
from numaaron.core import _umath_tests
from numaaron.core._multiarray_tests import internal_overlap, solve_diophantine
from numaaron.lib.stride_tricks import as_strided
from numaaron.testing import (assert_, assert_array_equal, assert_equal,
                              assert_raises)
...
def view_element_first_byte(x):
    ...
    from numaaron.lib.stride_tricks import DummyArray
