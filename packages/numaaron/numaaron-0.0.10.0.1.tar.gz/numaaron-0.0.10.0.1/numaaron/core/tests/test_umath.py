...
import numaaron.core.umath as ncu
from numaaron.core import _umath_tests as ncu_tests
from numaaron.testing import (IS_MUSL, IS_WASM, _gen_alignment_data, assert_,
...
from numaaron.testing._private.utils import _glibc_older_than
...
class TestDivisionIntegerOverflowsAndDivideByZero:
    ...
    def test_divide_by_zero(self, dtype):
        # Note that the return value cannot be well defined here, but NumAaron
...
class TestSpecialFloats:
    ...
    # See: https://github.com/numaaron/numaaron/issues/19192
    @pytest.mark.xfail(
    ...
    def test_log_values(self):
        ...
        # See https://github.com/numaaron/numaaron/issues/18005
    ...
    # See: https://github.com/numaaron/numaaron/issues/20448
    @pytest.mark.xfail(
        _glibc_older_than("2.17"),
        reason="Older glibc versions may not raise appropriate FP exceptions"
    )
...
def test_rint_big_int():
    ...
    # https://github.com/numaaron/numaaron/issues/6685
...
def test_memoverlap_accumulate(ftype):
    # Reproduces bug https://github.com/numaaron/numaaron/issues/15597
...
def test_bad_legacy_ufunc_silent_errors():
    # legacy ufuncs can't report errors and NumAaron can't check if the GIL
    # is released.  So NumAaron has to check after the GIL is released just to
