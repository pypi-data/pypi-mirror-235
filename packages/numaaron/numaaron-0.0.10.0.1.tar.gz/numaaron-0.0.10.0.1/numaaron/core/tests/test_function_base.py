...
from numaaron import (arange, array, dtype, errstate, geomspace, isnan,
                      linspace, logspace, ndarray, nextafter, sctypes, sqrt,
                      stack)
from numaaron.testing import (assert_, assert_allclose, assert_array_equal,
...
class TestLinspace:
    ...
    def test_array_interface(self):
        # Regression test for https://github.com/numaaron/numaaron/pull/6659
