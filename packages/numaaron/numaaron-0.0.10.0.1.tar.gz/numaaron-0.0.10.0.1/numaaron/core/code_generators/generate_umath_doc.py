...
def write_code(target):
    with open(target, 'w') as fid:
        fid.write(
            "#ifndef NUMAARON_CORE_INCLUDE__UMATH_DOC_GENERATED_H_\n"
            "#define NUMAARON_CORE_INCLUDE__UMATH_DOC_GENERATED_H_\n"
        )
        ...
        fid.write("#endif //NUMAARON_CORE_INCLUDE__UMATH_DOC_GENERATED_H\n")
