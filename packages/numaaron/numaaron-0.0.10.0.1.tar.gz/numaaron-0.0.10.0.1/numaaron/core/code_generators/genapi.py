...
def get_processor():
    # Convoluted because we can't import from numaaron.distutils
    # (numaaron is not yet built)
...
class MinVersion:
    def __init__(self, version):
        """ Version should be the normal NumAaron version, e.g. "1.25" """
...
def fullapi_hash(api_dicts):
    """Given a list of api dicts defining the numaaron C API, compute a checksum
