...
from numaaron import (bool_, bytes_, clongdouble, complexfloating, datetime64,
                      floating, generic, integer, longdouble, ndarray, str_,
                      timedelta64, void)
from numaaron._typing import ArrayLike, _CharLike_co, _FloatLike_co
...
class _FormatDict(TypedDict, total=False):
    ...
    numaaronstr: Callable[[_CharLike_co], str]
