#ifndef NUMAARON_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_ */
