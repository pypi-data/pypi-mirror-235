#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ARRAYFUNCTION_OVERRIDE_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ARRAYFUNCTION_OVERRIDE_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ARRAYFUNCTION_OVERRIDE_H_ */
