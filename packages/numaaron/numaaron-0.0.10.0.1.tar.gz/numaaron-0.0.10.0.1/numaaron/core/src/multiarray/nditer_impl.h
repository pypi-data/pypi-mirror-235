/*
 * This is a PRIVATE INTERNAL NumAaron header, intended to be used *ONLY*
 * by the iterator implementation code. All other internal NumAaron code
...
#ifndef NUMAARON_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_ */
