#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ITEM_SELECTION_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ITEM_SELECTION_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ITEM_SELECTION_H_ */
