#ifndef NUMAARON_CORE_SRC_MULTIARRAY_EINSUM_SUMPROD_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_EINSUM_SUMPROD_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_EINSUM_SUMPROD_H_ */
