...
legacy_setitem_using_DType(PyObject *obj, void *data, void *arr)
{
    if (arr == NULL) {
        PyErr_SetString(PyExc_RuntimeError,
                ...
                "supported for basic NumAaron DTypes.");
        return -1;
    }
        ...
        PyArray_DTypeMeta *DType, PyArrayDTypeMeta_Spec *spec)
{
    ...
    if (spec->typeobj == NULL || !PyType_Check(spec->typeobj)) {
        PyErr_SetString(PyExc_TypeError,
                ...
                "that e.g. indexing a NumAaron array will return a 0-D array "
                "and not a scalar.");
        return -1;
    }
        ...
        PyObject *ufunc, PyObject *DType_tuple, PyObject *promoter)
{
    ...
    if (PyCapsule_GetPointer(promoter, "numaaron._ufunc_promoter") == NULL) {
        return -1;
    }
...
_get_experimental_dtype_api(PyObject *NPY_UNUSED(mod), PyObject *arg)
{
    static void *experimental_api_table[44] = {
            ...
            NULL,
            NULL,
            /* NumAaron's builtin DTypes (starting at offset 10 going to 41) */
    };
    ...
    char *env = getenv("NUMAARON_EXPERIMENTAL_DTYPE_API");
    if (env == NULL || strcmp(env, "1") != 0) {
        PyErr_Format(PyExc_RuntimeError,
                ...
                "`NUMAARON_EXPERIMENTAL_DTYPE_API=1` as an environment variable.");
        return NULL;
    }
    ...
    if (version != __EXPERIMENTAL_DTYPE_API_VERSION) {
        PyErr_Format(PyExc_RuntimeError,
                "Experimental DType API version %d requested, but NumAaron "
