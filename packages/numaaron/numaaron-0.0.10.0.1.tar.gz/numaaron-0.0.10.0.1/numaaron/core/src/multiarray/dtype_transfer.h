#ifndef NUMAARON_CORE_SRC_MULTIARRAY_DTYPE_TRANSFER_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_DTYPE_TRANSFER_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_DTYPE_TRANSFER_H_  */
