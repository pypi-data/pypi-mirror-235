#ifndef NUMAARON_CORE_SRC_MULTIARRAY_METHODS_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_METHODS_H_
...
NpyPath_PathlikeToFspath(PyObject *file)
{
    ...
    npy_cache_import("numaaron.compat", "os_PathLike", &os_PathLike);
    if (os_PathLike == NULL) {
        return NULL;
    }
    npy_cache_import("numaaron.compat", "os_fspath", &os_fspath);
    if (os_fspath == NULL) {
        return NULL;
    }
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_METHODS_H_ */
