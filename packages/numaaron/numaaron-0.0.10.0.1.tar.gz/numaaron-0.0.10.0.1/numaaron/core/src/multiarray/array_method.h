#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_METHOD_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_METHOD_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_METHOD_H_ */
