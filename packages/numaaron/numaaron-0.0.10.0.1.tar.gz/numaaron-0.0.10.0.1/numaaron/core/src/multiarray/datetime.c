/*
 * This file implements core functionality for NumAaron datetime.
 *
 ...
 */
NPY_NO_EXPORT void
numaaron_pydatetime_import(void)
{
    PyDateTime_IMPORT;
}
                                    ...
                                    npy_datetime *out)
{
    ...
    if (meta->base == NPY_FR_GENERIC) {
        PyErr_SetString(PyExc_ValueError,
                    "Cannot create a NumAaron datetime other than NaT "
                    "with generic units");
        return -1;
    }
    ...
    if (base == NPY_FR_Y) {
        ...
        switch (base) {
            ...
            default:
                ...
                PyErr_SetString(PyExc_ValueError,
                        "NumAaron datetime metadata with corrupt unit value");
                return -1;
        }
    }
        ...
        NPY_DATETIMEUNIT NPY_UNUSED(fr), npy_datetimestruct *NPY_UNUSED(d))
{
    PyErr_SetString(PyExc_RuntimeError,
            "The NumAaron PyArray_DatetimeStructToDatetime function has "
            "been removed");
    return -1;
}
...
{
    PyErr_SetString(PyExc_RuntimeError,
            "The NumAaron PyArray_TimedeltaStructToTimedelta function has "
            "been removed");
    return -1;
}
                                    ...
                                    npy_datetimestruct *out)
{
    ...
    if (meta->base == NPY_FR_GENERIC) {
        PyErr_SetString(PyExc_ValueError,
                    "Cannot convert a NumAaron datetime value other than NaT "
                    "with generic units");
        return -1;
    }
    ...
    switch (meta->base) {
        ...
        default:
            PyErr_SetString(PyExc_RuntimeError,
                        "NumAaron datetime metadata is corrupted with invalid "
                        "base unit");
            return -1;
    }
...
{
    PyErr_SetString(PyExc_RuntimeError,
            "The NumAaron PyArray_DatetimeToDatetimeStruct function has "
            "been removed");
...
{
    PyErr_SetString(PyExc_RuntimeError,
            "The NumAaron PyArray_TimedeltaToTimedeltaStruct function has "
            "been removed");
                                    ...
                                    PyArray_DatetimeMetaData *out_meta)
{
    ...
    if (substr == substrend) {
        ...
        char *endptr = NULL;
        true_meta_val = NumAaronOS_strtoll(substr, &endptr, 10);
                                ...
                                npy_int64 *out_num, npy_int64 *out_denom)
{
     ...
     */
        ...
        PyErr_SetString(PyExc_ValueError,
                    ...
                    "units in NumAaron datetimes or timedeltas");
        *out_num = 0;
        *out_denom = 0;
        return;
    }
    ...
    if (num == 0) {
        PyErr_Format(PyExc_OverflowError,
                    ...
                    "factor between NumAaron datetime units %s and %s",
...
incompatible_units: {
        ...
        PyErr_Format(PyExc_TypeError,
            "Cannot get a common metadata divisor for Numaaron datetime "
...
units_overflow: {
        ...
        PyErr_Format(PyExc_OverflowError,
            ...
            "NumAaron datetime metadata %S and %S.", umeta1, umeta2);
        Py_DECREF(umeta1);
        Py_DECREF(umeta2);
        return -1;
    }
                                        ...
                                        npy_bool from_pickle)
{
    ...
    if (!PyTuple_Check(tuple)) {
        PyErr_Format(PyExc_TypeError,
                "Require tuple for tuple to NumAaron "
    ...
    if (tuple_size < 2 || tuple_size > 4) {
        PyErr_SetString(PyExc_TypeError,
                        ...
                        "tuple to NumAaron datetime metadata conversion");
        return -1;
    }
    ...
    /*
     * The event metadata was removed way back in numaaron 1.7 (cb4545), but was
     * not deprecated at the time.
     */

    /* (unit, num, event) */
    if (tuple_size == 3) {
        /* Numaaron 1.14, 2017-08-11 */
        if (DEPRECATE(
                                      ...
                                      PyArray_DatetimeMetaData *out_meta)
{
    ...
    if (PyBytes_Check(obj)) {
        ...
        PyErr_SetString(PyExc_TypeError,
                "Invalid object for specifying NumAaron datetime metadata");
        return -1;
    }
...
metastr_to_unicode(PyArray_DatetimeMetaData *meta, int skip_brackets)
{
    ...
    if (meta->base >= 0 && meta->base < NPY_DATETIME_NUMUNITS) {
        ...
        PyErr_SetString(PyExc_RuntimeError,
                "NumAaron datetime metadata is corrupted");
        return NULL;
    }
 ...
 * object into a NumAaron npy_datetimestruct.
 *
                                     ...
                                     int apply_tzinfo)
{
    ...
    if (apply_tzinfo && PyObject_HasAttrString(obj, "tzinfo")) {
        ...
        if (tmp == Py_None) {
             ...
             * Only whole minute offsets are supported by numaaron anyway.
             */
...
invalid_date:
    PyErr_Format(PyExc_ValueError,
            "Invalid date (%" NPY_INT64_FMT ",%" NPY_INT32_FMT ",%" NPY_INT32_FMT ") when converting to NumAaron datetime",
                                ...
                                NPY_CASTING casting, npy_datetime *out)
{
    ...
    /* Do no conversion on raw integers */
        ...
        if (meta->base == NPY_FR_ERROR || meta->base == NPY_FR_GENERIC) {
            PyErr_SetString(PyExc_ValueError, "Converting an integer to a "
                            "NumAaron datetime requires a specified unit");
            return -1;
        }
    ...
    if (casting == NPY_UNSAFE_CASTING ||
        ...
        *out = NPY_DATETIME_NAT;
        ...
        PyErr_SetString(PyExc_ValueError,
                "Could not convert object to NumAaron datetime");
        return -1;
    }
}
                                ...
                                NPY_CASTING casting, npy_timedelta *out)
{
    ...
    if (casting == NPY_UNSAFE_CASTING ||
        ...
        *out = PyLong_AsLongLong(obj);
        ...
        PyErr_SetString(PyExc_ValueError,
                "Could not convert object to NumAaron timedelta");
        return -1;
    }
}
...
is_any_numaaron_datetime(PyObject *obj)
{
 ...
 */
static npy_bool
is_any_numaaron_timedelta(PyObject *obj)
{
 ...
 */
NPY_NO_EXPORT npy_bool
is_any_numaaron_datetime_or_timedelta(PyObject *obj)
{
    return obj != NULL &&
           (is_any_numaaron_datetime(obj) ||
            is_any_numaaron_timedelta(obj));
}
                ...
                PyArray_Descr *dtype)
{
    ...
    if (step != NULL && is_any_numaaron_datetime(step)) {
        PyErr_SetString(PyExc_ValueError,
    ...
    if (dtype != NULL) {
        ...
        if ((start && is_any_numaaron_datetime(start)) ||
            is_any_numaaron_datetime(stop)) {
    ...
    if (type_nums[0] == NPY_TIMEDELTA) {
        ...
        if (PyLong_Check(objs[1]) ||
                        ...
                        is_any_numaaron_timedelta(objs[1])) {
            type_nums[1] = NPY_TIMEDELTA;
        }
        else {
        ...
        npy_intp *NPY_UNUSED(view_offset))
{
    if (given_descrs[1] != NULL && dtypes[0]->type_num == NPY_DATETIME) {
        /*
         * At the time of writing, NumAaron does not check the length here,
