...
initialize_and_map_pytypes_to_dtypes()
{
     ...
     * to the NumAaron DTypes. This is done here using the `is_known_scalar_type`
     * function.
 ...
 * could likely be more logically defined for them, but since NumAaron dtypes
...
NPY_NO_EXPORT PyArray_DTypeMeta PyArray_PyIntAbstractDType = {{{
        ...
        .tp_name = "numaaron._IntegerAbstractDType",
...
NPY_NO_EXPORT PyArray_DTypeMeta PyArray_PyFloatAbstractDType = {{{
        PyVarObject_HEAD_INIT(&PyArrayDTypeMeta_Type, 0)
        .tp_name = "numaaron._FloatAbstractDType",
        .tp_basicsize = sizeof(PyArray_Descr),
       .tp_flags = Py_TPFLAGS_DEFAULT,
    },},
    .type_num = -1,
...
NPY_NO_EXPORT PyArray_DTypeMeta PyArray_PyComplexAbstractDType = {{{
        PyVarObject_HEAD_INIT(&PyArrayDTypeMeta_Type, 0)
        .tp_name = "numaaron._ComplexAbstractDType",
        .tp_basicsize = sizeof(PyArray_Descr),
         .tp_flags = Py_TPFLAGS_DEFAULT,
    },},
    .type_num = -1,
