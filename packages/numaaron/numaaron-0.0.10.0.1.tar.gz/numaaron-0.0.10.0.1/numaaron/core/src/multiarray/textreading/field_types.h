...
#ifndef NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_
 ...
 *
 * @param descr The NumAaron descriptor of the field (may be byte-swapped, etc.)
...
typedef struct _field_type {
    ...
    /* The original NumAaron descriptor */
    PyArray_Descr *descr;
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_ */
