#ifndef NUMAARON_CORE_SRC_MULTIARRAY_COMPILED_BASE_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_COMPILED_BASE_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_COMPILED_BASE_H_ */
