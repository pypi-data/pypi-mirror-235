#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ABSTRACTDTYPES_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ABSTRACTDTYPES_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ABSTRACTDTYPES_H_ */
