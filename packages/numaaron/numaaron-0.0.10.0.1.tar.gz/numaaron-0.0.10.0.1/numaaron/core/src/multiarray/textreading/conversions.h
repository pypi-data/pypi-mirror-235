#ifndef NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_ */
