#ifndef NUMAARON_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_

NPY_VISIBILITY_HIDDEN extern int npy_numaaron2_behavior;
...
NPY_VISIBILITY_HIDDEN extern PyObject * npy_ma_str_numaaron;
NPY_VISIBILITY_HIDDEN extern PyObject * npy_ma_str_where;

#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_ */
