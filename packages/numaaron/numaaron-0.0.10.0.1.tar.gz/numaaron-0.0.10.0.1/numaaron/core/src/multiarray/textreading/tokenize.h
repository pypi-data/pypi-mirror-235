...
#ifndef NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_ */
