 ...
 * due to the value based logic NumAaron uses and the fact that NumAaron has
 ...
 * about all NumAaron dtypes, floats "know" about integers, integers "know"
 ...
 * If a user inserts more than one type into the NumAaron type hierarchy, this
 * can break. Given:
