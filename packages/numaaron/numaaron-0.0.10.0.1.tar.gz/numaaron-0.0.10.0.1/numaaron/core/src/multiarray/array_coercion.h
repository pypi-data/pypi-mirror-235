#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_COERCION_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_COERCION_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ARRAY_COERCION_H_ */
