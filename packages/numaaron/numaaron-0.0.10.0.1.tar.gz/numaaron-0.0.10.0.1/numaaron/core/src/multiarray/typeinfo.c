/*
 * Provides namedtuples for numaaron.core.multiarray.typeinfo
...
static PyStructSequence_Desc typeinfo_desc = {
    "numaaron.core.multiarray.typeinfo",         /* name          */
    "Information about a scalar numaaron type",  /* doc           */
    typeinfo_fields,                          /* fields        */
    5,                                        /* n_in_sequence */
};

static PyStructSequence_Desc typeinforanged_desc = {
    "numaaron.core.multiarray.typeinforanged",                /* name          */
    "Information about a scalar numaaron type with a range",  /* doc           */
