...
/*NUMAARON_API
 * return 1 if an object is exactly a numaaron scalar
 */
NPY_NO_EXPORT int
 ...
 *
 * This may not work right on narrow builds for NumAaron unicode scalars.
 */
NPY_NO_EXPORT int
...
PyArray_ScalarFromObject(PyObject *object)
{
    if (DEPRECATE(
            ...
            "please notify the NumAaron developers to look for solutions."
            "(Deprecated in NumAaron 1.23)") < 0) {
        return NULL;
    }
...
PyArray_FieldNames(PyObject *fields)
{
    ...
    tup = PyObject_CallMethod(_numaaron_internal, "_makenames_list", "OO", fields, Py_False);
