#ifndef NUMAARON_CORE_SRC_MULTIARRAY_DATETIME_BUSDAY_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_DATETIME_BUSDAY_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_DATETIME_BUSDAY_H_ */
