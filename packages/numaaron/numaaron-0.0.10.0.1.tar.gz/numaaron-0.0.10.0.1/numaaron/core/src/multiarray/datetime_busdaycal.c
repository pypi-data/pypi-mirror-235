 ...
 * calendar object for accelerating NumAaron datetime business day functions.
 *
...
busdaycalendar_init(NpyBusDayCalendar *self, PyObject *args, PyObject *kwds)
{
    ...
    if (self->busdays_in_weekmask == 0) {
        PyErr_SetString(PyExc_ValueError,
                "Cannot construct a numaaron.busdaycal with a weekmask of "
                "all zeros");
        return -1;
    }
...
NPY_NO_EXPORT PyTypeObject NpyBusDayCalendar_Type = {
    ...
    .tp_name = "numaaron.busdaycalendar",
