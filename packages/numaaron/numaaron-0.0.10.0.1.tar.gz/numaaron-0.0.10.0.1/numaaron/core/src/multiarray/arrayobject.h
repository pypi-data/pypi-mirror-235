...
#ifndef NUMAARON_CORE_SRC_MULTIARRAY_ARRAYOBJECT_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_ARRAYOBJECT_H_

extern NPY_NO_EXPORT npy_bool numaaron_warn_if_no_mem_policy;
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_ARRAYOBJECT_H_ */
