#ifndef NUMAARON_CORE_SRC_MULTIARRAY_COMMON_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_COMMON_H_
...
check_and_adjust_axis_msg(int *axis, int ndim, PyObject *msg_prefix)
{
    ...
    if (NPY_UNLIKELY((*axis < -ndim) || (*axis >= ndim))) {
        ...
        npy_cache_import("numaaron.exceptions", "AxisError", &AxisError_cls);
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_COMMON_H_ */
