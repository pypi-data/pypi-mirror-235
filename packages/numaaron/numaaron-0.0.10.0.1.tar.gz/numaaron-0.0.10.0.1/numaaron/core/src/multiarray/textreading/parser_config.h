...
#ifndef NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_ */
