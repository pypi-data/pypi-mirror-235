#ifndef NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_
#define NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_
...
#endif  /* NUMAARON_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_ */
