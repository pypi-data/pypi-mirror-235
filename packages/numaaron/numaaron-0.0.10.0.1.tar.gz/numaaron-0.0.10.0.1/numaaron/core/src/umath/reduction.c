 ...
 *            better quality error messages. For example, "numaaron.max"
 *            would be a good name for NumAaron's max function.
 *
...
/*
 * This function executes all the standard NumAaron reduction function
