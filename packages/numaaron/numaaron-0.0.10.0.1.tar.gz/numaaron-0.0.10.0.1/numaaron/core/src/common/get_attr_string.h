#ifndef NUMAARON_CORE_SRC_COMMON_GET_ATTR_STRING_H_
#define NUMAARON_CORE_SRC_COMMON_GET_ATTR_STRING_H_
 ...
 *
 * Assumes that the special method is a numaaron-specific one, so does not look
 * at builtin types. It does check base ndarray and numaaron scalar types.
 *
...
#endif  /* NUMAARON_CORE_SRC_COMMON_GET_ATTR_STRING_H_ */
