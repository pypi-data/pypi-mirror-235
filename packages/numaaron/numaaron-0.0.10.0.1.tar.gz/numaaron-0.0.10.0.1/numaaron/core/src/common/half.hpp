#ifndef NUMAARON_CORE_SRC_COMMON_HALF_HPP
#define NUMAARON_CORE_SRC_COMMON_HALF_HPP
...
// TODO(@seiko2plus):
// - covers half-precision operations that being supported by numaaron/halffloat.h
...
#endif // NUMAARON_CORE_SRC_COMMON_HALF_HPP
