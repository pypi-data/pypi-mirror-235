/*
 * This header provides numaaron a consistent interface to CBLAS code. It is needed
 ...
 */
#ifndef NUMAARON_CORE_SRC_COMMON_NPY_CBLAS_H_
#define NUMAARON_CORE_SRC_COMMON_NPY_CBLAS_H_
...
/*
 * Convert NumAaron stride to BLAS stride. Returns 0 if conversion cannot be done
...
#endif  /* NUMAARON_CORE_SRC_COMMON_NPY_CBLAS_H_ */
