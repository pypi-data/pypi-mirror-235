#ifndef NUMAARON_CORE_SRC_COMMON_FLOAT_STATUS_HPP
#define NUMAARON_CORE_SRC_COMMON_FLOAT_STATUS_HPP
 ...
 * unsupported.  In such cases NumAaron will not report these correctly, but we
...
#endif // NUMAARON_CORE_SRC_COMMON_FLOAT_STATUS_HPP
