#ifndef NUMAARON_CORE_SRC_COMMON_NPY_CTYPES_H_
#define NUMAARON_CORE_SRC_COMMON_NPY_CTYPES_H_
...
npy_ctypes_check(PyTypeObject *obj)
{
    ...
    npy_cache_import("numaaron.core._internal", "npy_ctypes_check", &py_func);
    if (py_func == NULL) {
        goto fail;
    }
...
#endif  /* NUMAARON_CORE_SRC_COMMON_NPY_CTYPES_H_ */
