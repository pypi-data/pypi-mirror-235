#ifndef NUMAARON_CORE_SRC_COMMON_LOWLEVEL_STRIDED_LOOPS_H_
#define NUMAARON_CORE_SRC_COMMON_LOWLEVEL_STRIDED_LOOPS_H_
#include "common.h"
...
#include "numaaron/ndarrayobject.h"
 ...
 *       probably. Although for NumAaron internal things this works decently,
 *       and exposing it there should be well thought out to be useful beyond
 *       NumAaron if possible.
 *
...
#endif  /* NUMAARON_CORE_SRC_COMMON_LOWLEVEL_STRIDED_LOOPS_H_ */
