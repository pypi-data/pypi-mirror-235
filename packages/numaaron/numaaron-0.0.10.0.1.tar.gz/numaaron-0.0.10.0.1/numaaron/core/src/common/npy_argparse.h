#ifndef NUMAARON_CORE_SRC_COMMON_NPY_ARGPARSE_H
#define NUMAARON_CORE_SRC_COMMON_NPY_ARGPARSE_H
 ...
 * argument clinic. NumAaron may well decide to use argument clinic or a different
...
#endif  /* NUMAARON_CORE_SRC_COMMON_NPY_ARGPARSE_H */
