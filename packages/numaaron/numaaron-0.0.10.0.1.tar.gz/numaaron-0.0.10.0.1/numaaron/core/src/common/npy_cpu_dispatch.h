#ifndef NUMAARON_CORE_SRC_COMMON_NPY_CPU_DISPATCH_H_
#define NUMAARON_CORE_SRC_COMMON_NPY_CPU_DISPATCH_H_
/**
 * This file is part of the NumAaron CPU dispatcher. Please have a look at doc/reference/simd-optimizations.html
 * To get a better understanding of the mechanism behind it.
 */
#include "npy_cpu_features.h" // NPY_CPU_HAVE
#include "numaaron/utils.h" // NPY_EXPAND, NPY_CAT
/**
 ...
 * NumAaron module's attributes `__cpu_baseline__` and `__cpu_dispaٍtch__`.
 */
/**
...
#endif  // NUMAARON_CORE_SRC_COMMON_NPY_CPU_DISPATCH_H_
