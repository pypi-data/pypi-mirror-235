#ifndef NUMAARON_CORE_SRC_COMMON_BINOP_OVERRIDE_H_
#define NUMAARON_CORE_SRC_COMMON_BINOP_OVERRIDE_H_
 ...
 * which are being phased out -- see https://github.com/numaaron/numaaron/pull/5864)
 *
 ...
 *   all use cases. (See https://github.com/numaaron/numaaron/issues/5844 for lots
 *   of discussion of this, and in particular
 *     https://github.com/numaaron/numaaron/issues/5844#issuecomment-112014014
...
binop_should_defer(PyObject *self, PyObject *other, int inplace)
{
     ...
     *    numaaron.ma.core.MaskedArray._delegate_binop
...
#endif  /* NUMAARON_CORE_SRC_COMMON_BINOP_OVERRIDE_H_ */
