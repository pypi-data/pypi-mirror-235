#ifndef NUMAARON_CORE_SRC_COMMON_NPY_NPY_FPMATH_H_
#define NUMAARON_CORE_SRC_COMMON_NPY_NPY_FPMATH_H_

#include "npy_config.h"

#include "numaaron/npy_os.h"
...
#endif  /* NUMAARON_CORE_SRC_COMMON_NPY_NPY_FPMATH_H_ */
