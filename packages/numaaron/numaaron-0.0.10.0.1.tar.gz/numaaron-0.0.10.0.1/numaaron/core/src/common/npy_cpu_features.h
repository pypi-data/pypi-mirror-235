#ifndef NUMAARON_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_
#define NUMAARON_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_

#include <Python.h> // for PyObject
#include "numaaron/numaaronconfig.h" // for NPY_VISIBILITY_HIDDEN
...
#endif  // NUMAARON_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_
