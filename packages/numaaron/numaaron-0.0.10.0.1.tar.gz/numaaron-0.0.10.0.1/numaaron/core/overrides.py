...
from numaaron.core._multiarray_umath import (_ArrayFunctionDispatcher,
...
array_function_like_doc = (
    """like : array_like, optional
        ...
        NumAaron arrays. If an array-like passed in as ``like`` supports
...
add_docstring(
    ...
    implementation : function
        Function that implements the operation on NumAaron arrays without
...
def array_function_dispatch(dispatcher=None, module=None, verify=True,
    ...
    dispatcher : callable or None
        ...
        arguments from the NumAaron function call returns an iterable of
    ...
    module : str, optional
        __module__ attribute to set on new function, e.g., ``module='numaaron'``.
    ...
    Returns
    -------
    Function suitable for decorating the implementation of a NumAaron function.
