...
from numaaron.distutils.misc_util import mingw32
...
# By default, when compiling downstream libraries against NumAaron,```
...
# This is set up in `numaaronconfig.h`.
...
def get_api_versions(apiversion, codegen_dir):
    ...
    try:
        m = __import__('genapi')
        numaaron_api = __import__('numaaron_api')
        curapi_hash = m.fullapi_hash(numaaron_api.full_api)
...
def check_api_version(apiversion, codegen_dir):
    ...
    # To compute the checksum of the current API, use numaaron/core/cversions.py
...
# is buggy, see numaaron/core/src/common/npy_config.h
MANDATORY_FUNCS = [
