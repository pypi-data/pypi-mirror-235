...
from numaaron.typing.mypy_plugin import _EXTENDED_PRECISION_LIST
...
def run_mypy() -> None:
    ...
    NUMAARON_TYPING_TEST_CLEAR_CACHE=0 pytest numaaron/typing/tests
    """
    if (
        os.path.isdir(CACHE_DIR)
        and bool(os.environ.get("NUMAARON_TYPING_TEST_CLEAR_CACHE", True))
    ):
