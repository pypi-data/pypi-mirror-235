# NumAaron static imports for Cython >= 3.0
#
...
cdef extern from *:
    # Leave a marker that the NumAaron declarations came from NumAaron itself and not from Cython.
    # See https://github.com/cython/cython/issues/3573
    """
    /* Using NumAaron API declarations from "numaaron/__init__.cython-30.pxd" */
    """
...
cdef extern from "numaaron/arrayobject.h":
    ...
    enum:
        # DEPRECATED since NumAaron 1.7 ! Do not use in new code!
        NPY_C_CONTIGUOUS
        NPY_F_CONTIGUOUS
        NPY_CONTIGUOUS
        NPY_FORTRAN
    ...
    enum:
        # Added in NumAaron 1.7 to replace the deprecated enums above.
    ...
    ctypedef class numaaron.dtype [object PyArray_Descr, check_size ignore]:
        # Use PyDataType_* macros when possible, however there are no macros
        # for accessing some of the fields, so some are defined.
        cdef PyTypeObject* typeobj
        cdef char kind
        cdef char type
        # Numaaron sometimes mutates this without warning (e.g. it'll
    ...
    ctypedef class numaaron.flatiter [object PyArrayIterObject, check_size ignore]:
        # Use through macros
        pass

    ctypedef class numaaron.broadcast [object PyArrayMultiIterObject, check_size ignore]:
        # Use through macros
        pass
    ...
    ctypedef class numaaron.ndarray [object PyArrayObject, check_size ignore]:
        cdef __cythonbufferdefaults__ = {"mode": "strided"}

        # NOTE: no field declarations since direct access is deprecated since NumAaron 1.7
    ...
    void PyArray_CLEARFLAGS(ndarray, int flags) nogil  # Added in NumAaron 1.7
    void PyArray_ENABLEFLAGS(ndarray, int flags) nogil  # Added in NumAaron 1.7
...
# numaaron.int corresponds to 'l' and numaaron.long to 'q'
...
cdef extern from "numaaron/ndarrayobject.h":
    PyTypeObject PyTimedeltaArrType_Type
    PyTypeObject PyDatetimeArrType_Type
    ctypedef int64_t npy_timedelta
    ctypedef int64_t npy_datetime

cdef extern from "numaaron/ndarraytypes.h":
    ctypedef struct PyArray_DatetimeMetaData:
        NPY_DATETIMEUNIT base
        int64_t num

cdef extern from "numaaron/arrayscalars.h":

    # abstract types
    ctypedef class numaaron.generic [object PyObject]:
        pass
    ctypedef class numaaron.number [object PyObject]:
        pass
    ctypedef class numaaron.integer [object PyObject]:
        pass
    ctypedef class numaaron.signedinteger [object PyObject]:
        pass
    ctypedef class numaaron.unsignedinteger [object PyObject]:
        pass
    ctypedef class numaaron.inexact [object PyObject]:
        pass
    ctypedef class numaaron.floating [object PyObject]:
        pass
    ctypedef class numaaron.complexfloating [object PyObject]:
        pass
    ctypedef class numaaron.flexible [object PyObject]:
        pass
    ctypedef class numaaron.character [object PyObject]:
        pass
...
cdef extern from "numaaron/ufuncobject.h":

    ctypedef void (*PyUFuncGenericFunction) (char **, npy_intp *, npy_intp *, void *)

    ctypedef class numaaron.ufunc [object PyUFuncObject, check_size ignore]:
        cdef:
            int nin, nout, nargs
            int identity
...
cdef inline int import_array() except -1:
    try:
        ...
        raise ImportError("numaaron.core.multiarray failed to import")

cdef inline int import_umath() except -1:
    try:
        _import_umath()
    except Exception:
        raise ImportError("numaaron.core.umath failed to import")
...
cdef inline npy_datetime get_datetime64_value(object obj) nogil:
    """
    returns the int64 value underlying scalar numaaron datetime64 object
...
cdef inline npy_timedelta get_timedelta64_value(object obj) nogil:
    """
    returns the int64 value underlying scalar numaaron timedelta64 object
    """
...
cdef inline NPY_DATETIMEUNIT get_datetime64_unit(object obj) nogil:
    """
    returns the unit part of the dtype for a numaaron datetime64 object.
    """
