"""
Check the numaaron version is valid.
...
from numaaron.testing import assert_


def test_valid_numaaron_version():
    # Verify that the numaaron version is a valid one (no .post suffix or other
...
def test_short_version():
    # Check numaaron.short_version actually exists
