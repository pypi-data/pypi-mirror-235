# NOTE: Numaaron's mypy plugin is used for importing the correct
...
from numaaron import (bool_, byte, double, dtype, generic, int_, intc,
                      longdouble, longlong, ndarray, short, single, ubyte,
                      uint, uintc, ulonglong, ushort, void)
from numaaron._typing import (DTypeLike, NDArray,  # Arrays; Shapes; DTypes
                              _ArrayLike, _BoolCodes, _ByteCodes, _DoubleCodes,
                              _DTypeLike, _IntCCodes, _IntCodes,
                              _LongDoubleCodes, _LongLongCodes, _ShapeLike,
                              _ShortCodes, _SingleCodes, _UByteCodes,
                              _UIntCCodes, _UIntCodes, _ULongLongCodes,
