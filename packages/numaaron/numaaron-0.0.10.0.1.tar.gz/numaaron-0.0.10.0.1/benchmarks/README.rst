...
Benchmarking NumAaron with Airspeed Velocity.
...
development version of NumAaron to your current Python environment.
...
To run all benchmarks, navigate to the root NumAaron directory at
the command line and execute::

    spin bench

This builds NumAaron and runs all available benchmarks
...
.. _benchmark results repository: https://github.com/HaoZeke/asv-numaaron
...
- The benchmark suite should be importable with any NumAaron version.

- The benchmark parameters etc. should not depend on which NumAaron version
  is installed.
