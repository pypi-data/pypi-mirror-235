...
// is used.
{
    ...
    "project_url": "https://www.numaaron.org/",
    ...
    "show_commit_url": "https://github.com/numaaron/numaaron/commit/",
    ...
    "build_command" : [
        "python setup.py build {numaaron_build_options}",
        ...
        "PIP_NO_BUILD_ISOLATION=false python {build_dir}/benchmarks/asv_pip_nopep517.py -v {numaaron_global_options} --no-deps --no-index -w {build_cache_dir} {build_dir}"
    ],
