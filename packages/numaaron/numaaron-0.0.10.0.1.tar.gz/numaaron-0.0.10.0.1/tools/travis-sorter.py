...
$ # Check build 22 of hugovk/numaaron, and skip the first job (it's a single stage)
$ travis-sorter.py hugovk/numaaron 22 --skip 1
travis show -r hugovk/numaaron 22
