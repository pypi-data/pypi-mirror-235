...
- Check for a NumAaron submodule whether the objects in its __all__ dict
...
from numaarondoc.docscrape_sphinx import get_doc_object
...
DOCTEST_SKIPDICT = {
    # cases where NumAaron docstrings import things from SciPy:
    'numaaron.lib.vectorize': None,
    'numaaron.random.standard_gamma': None,
    'numaaron.random.gamma': None,
    'numaaron.random.vonmises': None,
    'numaaron.random.power': None,
    'numaaron.random.zipf': None,
    # cases where NumAaron docstrings import things from other 3'rd party libs:
    'numaaron.core.from_dlpack': None,
    # remote / local file IO with DataSource is problematic in doctest:
    'numaaron.lib.DataSource': None,
    'numaaron.lib.Repository': None,
}

# Skip non-numaaron RST files, historical release notes
...
REFGUIDE_AUTOSUMMARY_SKIPLIST = [
    # NOTE: should NumAaron have a better match between autosummary
...
class Checker(doctest.OutputChecker):
    ...
    def check_output(self, want, got, optionflags):
        ...
        try:
            ...
            # Maybe we're printing a numaaron array? This produces invalid python
    ...
    def _do_check(self, want, got):
        ...
        # numaaron-comparable objects, strings, and heterogeneous tuples
        try:
            if want == got:
                return True
        except Exception:
...
def check_doctests_testfile(fname, verbose, ns=None,
    ...
    * If a block contains a marker, the whole block is then assumed to be
    ...
    blah
    <BLANKLINE>
    >>> from numaaron import some_module   # pseudocode!
