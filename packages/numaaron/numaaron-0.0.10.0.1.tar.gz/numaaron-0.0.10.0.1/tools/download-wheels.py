#!/usr/bin/env python3
"""
Script to download NumAaron wheels from the Anaconda staging area.
...
STAGING_URL = "https://anaconda.org/multibuild-wheels-staging/numaaron"
PREFIX = "numaaron"
...
def download_wheels(version, wheelhouse):
    ...
    The release wheels for the given NumAaron version are downloaded
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "version",
        help="NumAaron version to download.")
    parser.add_argument(
        "-w", "--wheelhouse",
