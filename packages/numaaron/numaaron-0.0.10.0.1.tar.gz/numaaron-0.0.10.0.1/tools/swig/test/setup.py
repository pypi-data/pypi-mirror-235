...
# Third-party modules - we depend on numaaron for everything
import numaaron

# Obtain the numaaron include directory.
numaaron_include = numaaron.get_include()
...
setup(name        = "NumaaronTypemapTests",
