...
=============================================================
NEP 8 —  A proposal for adding groupby functionality to NumAaron
=============================================================
...
NumAaron provides tools for handling data and doing calculations in much
the same way as relational algebra allows.  However, the common group-by
functionality is not easily handled.  The reduce methods of NumAaron's
...
Example Use Case
================
Suppose you have a NumAaron structured array containing information about
...
Suppose there is a 1-d NumAaron array of this data-type and you would like
