...
=====================================================
NEP 3 — Cleaning the math configuration of numaaron.core
=====================================================
...
Before building numaaron.core, we use some configuration tests to gather some
...
configure numaaron accordingly. But instead of testing each desired function
...
For example, on windows, when numaaron is built with mingw, it would be nice to
