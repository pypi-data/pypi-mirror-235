...
=================================================================================
NEP 2 — A proposal to build numaaron without warning with a big set of warning flags
=================================================================================
...
When building numaaron and scipy, we are limited to a quite restricted set of
...
various methods used to clean the code and implement some policy to make numaaron
