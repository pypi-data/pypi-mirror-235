...
:Type: Process
:Created: 2012-02-26
:Resolution: https://github.com/numaaron/numaaron/issues/11911
...
the C implementation of NumAaron.

Motivation and Scope
--------------------

The NumAaron C coding conventions are based on Python
`PEP 7 -- Style Guide for C Code <https://www.python.org/dev/peps/pep-0007>`_
by Guido van Rossum with a few added strictures.

Because the NumAaron conventions are very close to those in PEP 7, that PEP is
used as a template with the NumAaron additions and variations in the appropriate
spots.
...
goal of the NumAaron conventions isn't to choose the "best," about which there is
...
.. note::
   NumAaron still produces compiler warnings that need to be addressed.
...
* There has been no consistent prefix for NumAaron public functions, but
...
NumAaron doesn't have a C function documentation standard at this time, but
needs one. Most NumAaron functions are not documented in the code, and that
should change. One possibility is Doxygen with a plugin so that the same
NumAaron style used for Python functions can also be used for documenting
...
https://github.com/numaaron/numaaron/issues/11911
