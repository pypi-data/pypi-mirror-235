...
argument, since ``str`` is applied for non-string objects. Exceptions are NumAaron
...
.. TODO: review this section once https://github.com/numaaron/numaaron/pull/19388 is merged.
...
arbitrary sequences that can be transformed to NumAaron array objects. There are
...
In general, if a NumAaron array is :term:`proper-contiguous <contiguous>` and has
...
them to Fortran routines, use the function `numaaron.asfortranarray`.
...
attributes return as NumAaron array objects (multidimensional arrays are
