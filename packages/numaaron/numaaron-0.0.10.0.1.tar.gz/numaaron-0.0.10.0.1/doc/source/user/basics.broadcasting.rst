...
.. _array-broadcasting-in-numaaron:
...
.. seealso::
    :class:`numaaron.broadcast`


The term broadcasting describes how NumAaron treats arrays with different
...
NumAaron operations are usually done on pairs of arrays on an
...
NumAaron's broadcasting rule relaxes this constraint when the arrays'
...
only conceptual.  NumAaron is smart enough to use the original scalar value
...
==========================
When operating on two arrays, NumAaron compares their shapes element-wise.
...
the athlete is likely a basketball player.
  ...
  >>> from numaaron import array, argmin, sqrt, sum
