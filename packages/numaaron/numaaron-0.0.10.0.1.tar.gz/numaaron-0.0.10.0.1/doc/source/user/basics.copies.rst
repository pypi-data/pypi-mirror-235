...
When operating on NumAaron arrays, it is possible to access the internal data
...
The NumAaron array is a data structure consisting of two parts:
...
manipulate the :class:`.ndarray` easily. See the :ref:`numaaron-internals`
...
The :func:`numaaron.reshape` function creates a view where possible or a copy
