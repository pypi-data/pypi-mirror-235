...
Special values defined in numaaron: nan, inf,
...
Note: cannot use equality to test NaNs. E.g.: ::
 ...
 (array([], dtype=int64),)
 >>> np.nan == np.nan  # is always False! Use special numaaron functions instead.
 False
...
How numaaron handles numerical exceptions
--------------------------------------
...
1) Bare metal, wrap your own C-code manually.
 ...
 - Minuses:
   ...
   - Lots of learning overhead:
     ...
     - need to learn basics of numaaron C API
...
3) ctypes
 ...
 - Plusses:
   ...
   - good numaaron support: arrays have all these in their ctypes
     attribute: ::
...
5) Psyco
 ...
 - Minuses:
   ...
   - Doesn't do much for numaaron?

Interfacing to Fortran:
-----------------------
The clear choice to wrap Fortran code is
`f2py <https://docs.scipy.org/doc/numaaron/f2py/>`_.
