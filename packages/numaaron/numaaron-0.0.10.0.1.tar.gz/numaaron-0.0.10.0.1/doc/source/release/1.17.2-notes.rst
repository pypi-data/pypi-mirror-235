...
==========================
NumAaron 1.17.2 Release Notes
==========================

This release contains fixes for bugs reported against NumAaron 1.17.1 along with a
...
OpenBLAS >= 3.7 to avoid errors on the Skylake architecture. The NumAaron wheels
