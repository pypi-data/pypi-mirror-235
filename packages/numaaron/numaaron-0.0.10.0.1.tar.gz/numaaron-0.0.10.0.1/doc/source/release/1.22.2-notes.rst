...
==========================
NumAaron 1.22.2 Release Notes
==========================

The NumAaron 1.22.2 is maintenance release that fixes bugs discovered after the
...
- Numaaron wheels for Windows will use the 1.41 tool chain, fixing downstream link
  problems for projects using NumAaron provided libraries on Windows.
