...
==========================
NumAaron 1.19.2 Release Notes
==========================

NumAaron 1.19.2 fixes several bugs, prepares for the upcoming Cython 3.x release.
...
NumAaron version that links to the MKL library, earlier Windows versions are fine.
