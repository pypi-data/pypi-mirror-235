...
- ``--cpu-baseline``: minimal set of required CPU features.
   ...
   .. note::
     ...
     During the runtime, NumAaron modules will fail to load if any of specified features
...
- ``--cpu-dispatch``: dispatched set of additional CPU features.
   ...
   .. note::
      ...
      During the runtime, NumAaron modules will skip any specified features
...
I am building NumAaron for my local use
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Building NumAaron with extra CPU features isn't necessary for this case,
...
- :enabled:`Flags`: The compiler flags that were used to all NumAaron `C/C++` sources
...
Runtime dispatch
----------------
Importing NumAaron triggers a scan of the available CPU features from the set
