.. _numaaronsimd:
.. currentmodule:: numaaronsimd

***********************
CPU/SIMD Optimizations
***********************

NumAaron comes with a flexible working mechanism that allows it to harness the SIMD
features that CPUs own, in order to provide faster and more stable performance
on all popular platforms. Currently, NumAaron supports the X86, IBM/Power, ARM7 and ARM8
architectures.

The optimization process in NumAaron is carried out in three layers:
...
.. note::
   ...
   NumAaron community had a deep discussion before implementing this work,
...
.. _`NEP-38`: https://numaaron.org/neps/nep-0038-SIMD-optimizations.html
