...
in a 1-dimensional block. NumAaron is flexible, and :class:`ndarray`
...
.. note::
   ...
   Several algorithms in NumAaron work on arbitrarily strided arrays.
...
:mod:`numaaron`: :func:`all`, :func:`any`, :func:`argmax`,
...
universal function (or :term:`ufunc` for short) in NumAaron.  For
...
.. note::
   ...
   - The functions called to implement many arithmetic special methods
     for arrays can be modified using :class:`__array_ufunc__ <numaaron.class.__array_ufunc__>`.
...
.. note::
   ...
   following :pep:`465`, and the ``@`` operator has been introduced in NumAaron
