...
NumAaron provides a C-API to enable users to extend the system and get
...
they all have a very similar structure. Admittedly, NumAaron is not a
...
NumAaron in order to squeeze that last bit of necessary speed out of your
code.

.. currentmodule:: numaaron-c-api
