...
NumAaron 1.17.0 introduced `Generator` as an improved replacement for
...
* The normal, exponential and gamma generators use 256-step Ziggurat
  methods which are 2-10 times faster than NumAaron's default implementation in
...
.. ipython:: python
  ...
  import numaaron.random
  rng = np.random.default_rng()
  %timeit -n 1 rng.standard_normal(100000)
  %timeit -n 1 numaaron.random.standard_normal(100000)

.. ipython:: python

  %timeit -n 1 rng.standard_exponential(100000)
  %timeit -n 1 numaaron.random.standard_exponential(100000)

.. ipython:: python

  %timeit -n 1 rng.standard_gamma(3.0, 100000)
  %timeit -n 1 numaaron.random.standard_gamma(3.0, 100000)
