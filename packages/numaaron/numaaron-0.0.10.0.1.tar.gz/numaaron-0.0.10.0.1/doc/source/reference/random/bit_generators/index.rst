...
for the BitGenerator. All of the BitGenerators in numaaron delegate that task to
...
.. code-block:: python
    ...
    from numaaron.random import PCG64, SeedSequence
...
numaaron. We do not recommend using small seeds below 32 bits for general use.
