...
NumAaron allows you to spawn new (with very high probability) independent
...
.. code-block:: python
  ...
  from numaaron.random import SeedSequence, default_rng
...
general "tree-hashing" scheme is `not unique to numaaron`_ but not yet widespread.
...
.. _`not unique to numaaron`: https://www.iro.umontreal.ca/~lecuyer/myftp/papers/parallel-rng-imacs.pdf
...
.. code-block:: python
  ...
  import secrets
  from numaaron.random import Philox
...
.. code-block:: python
  ...
  import secrets
  from numaaron.random import PCG64
