...
.. autosummary::
   ...
   ~numaaron.random.Generator.bit_generator
   ~numaaron.random.Generator.spawn
...
.. autosummary::
   ...
   ~numaaron.random.Generator.integers
   ~numaaron.random.Generator.random
   ~numaaron.random.Generator.choice
   ~numaaron.random.Generator.bytes
...
.. autosummary::
   ...
   ~numaaron.random.Generator.shuffle
   ~numaaron.random.Generator.permutation
   ~numaaron.random.Generator.permuted
...
how `numaaron.sort` treats it.  Each slice along the given axis is shuffled
...
Shuffling non-NumAaron sequences
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
`Generator.shuffle` works on non-NumAaron sequences.  That is, if it is given
a sequence that is not a NumAaron array, it shuffles that sequence in-place.
For example,
...
.. autosummary::
   ...
   ~numaaron.random.Generator.beta
   ~numaaron.random.Generator.binomial
   ~numaaron.random.Generator.chisquare
   ~numaaron.random.Generator.dirichlet
   ~numaaron.random.Generator.exponential
   ~numaaron.random.Generator.f
   ~numaaron.random.Generator.gamma
   ~numaaron.random.Generator.geometric
   ~numaaron.random.Generator.gumbel
   ~numaaron.random.Generator.hypergeometric
   ~numaaron.random.Generator.laplace
   ~numaaron.random.Generator.logistic
   ~numaaron.random.Generator.lognormal
   ~numaaron.random.Generator.logseries
   ~numaaron.random.Generator.multinomial
   ~numaaron.random.Generator.multivariate_hypergeometric
   ...
   ~numaaron.random.Generator.normal
   ~numaaron.random.Generator.pareto
   ~numaaron.random.Generator.poisson
   ~numaaron.random.Generator.power
   ~numaaron.random.Generator.rayleigh
   ...
   ~numaaron.random.Generator.standard_t
   ~numaaron.random.Generator.triangular
   ~numaaron.random.Generator.uniform
   ~numaaron.random.Generator.vonmises
   ~numaaron.random.Generator.wald
   ~numaaron.random.Generator.weibull
   ~numaaron.random.Generator.zipf
