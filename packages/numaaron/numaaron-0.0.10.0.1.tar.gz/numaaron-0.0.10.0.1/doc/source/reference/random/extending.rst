...
.. literalinclude:: ../../../../numaaron/random/_examples/numba/extending.py
    :language: python
...
.. literalinclude:: ../../../../numaaron/random/_examples/cython/extending_distributions.pyx
    :language: cython
    :end-before: example 2
...
``numaaron/random/c_distributions.pxd``. This requires linking with the
``npyrandom`` library located in ``numaaron/random/lib``.
...
``include/numaaron/random/distributions.h``. Some "massaging" of the header
file is required:

.. literalinclude:: ../../../../numaaron/random/_examples/cffi/extending.py
    :language: python
    :end-before: dlopen
