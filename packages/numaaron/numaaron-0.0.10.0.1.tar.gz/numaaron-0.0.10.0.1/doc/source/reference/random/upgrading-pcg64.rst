...
release in numaaron 1.17. Most users will never observe this weakness and are
...
If you
  ...
  2. only use `RandomState` or the functions in `numaaron.random`,
...
`Empirically <https://github.com/numaaron/numaaron/issues/16313>`_, it has been
...
credit <https://github.com/numaaron/numaaron/issues/13635#issuecomment-506088698>`_,
she had developed a stronger output function in response to related discussions
during the long birth of the new `BitGenerator` system. We NumAaron developers
