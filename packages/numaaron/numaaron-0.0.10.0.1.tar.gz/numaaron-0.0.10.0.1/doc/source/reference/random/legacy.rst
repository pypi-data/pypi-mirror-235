...
as the final point release of NumAaron v1.16. These all depend on Box-Muller
...
would have been produced by previous versions of NumAaron.
...
.. code-block:: python
   ...
   from numaaron.random import RandomState
...
.. _functions-in-numaaron-random:

Functions in `numaaron.random`
===========================
Many of the RandomState methods above are exported as functions in
`numaaron.random` This usage is discouraged, as it is implemented via a global
