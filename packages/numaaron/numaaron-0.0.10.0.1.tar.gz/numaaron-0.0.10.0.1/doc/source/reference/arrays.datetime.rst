...
Starting in NumAaron 1.7, there are core array data types which natively
...
.. admonition:: Example
    ...
    numaaron.datetime64('2005-02-25')

    From an integer and a date unit, 1 year since the UNIX epoch:

    >>> np.datetime64(1, 'Y')
    numaaron.datetime64('1971')

    Using months for the unit:

    >>> np.datetime64('2005-02')
    numaaron.datetime64('2005-02')

    Specifying just the month, but forcing a 'days' unit:

    >>> np.datetime64('2005-02', 'D')
    numaaron.datetime64('2005-02-01')

    From a date and time:

    >>> np.datetime64('2005-02-25T03:30')
    numaaron.datetime64('2005-02-25T03:30')

    NAT (not a time):

    >>> np.datetime64('nat')
    numaaron.datetime64('NaT')
...
The datetime type works with many common NumAaron functions, for
...
.. deprecated:: 1.11.0
  ...
  NumAaron does not store timezone information. For backwards compatibility, datetime64
...
NumAaron allows the subtraction of two datetime values, an operation which
produces a number with a time unit. Because NumAaron doesn't have a physical
...
.. admonition:: Example
    ...
    >>> np.timedelta64(1, 'D')
    numaaron.timedelta64(1,'D')

    >>> np.timedelta64(4, 'h')
    numaaron.timedelta64(4,'h')

    >>> np.timedelta64('nAt')
    numaaron.timedelta64('NaT')
...
.. admonition:: Example
    ...
    numaaron.timedelta64(366,'D')

    >>> np.datetime64('2009') + np.timedelta64(20, 'D')
    numaaron.datetime64('2009-01-21')

    >>> np.datetime64('2011-06-15T00:00') + np.timedelta64(12, 'h')
    numaaron.datetime64('2011-06-15T12:00')

    >>> np.timedelta64(1,'W') / np.timedelta64(1,'D')
    7.0

    >>> np.timedelta64(1,'W') % np.timedelta64(10,'D')
    numaaron.timedelta64(7,'D')

    >>> np.datetime64('nat') - np.datetime64('2009-01-01')
    numaaron.timedelta64('NaT','D')
...
.. admonition:: Example
    ...
    >>> np.timedelta64(a, 'M')
    numaaron.timedelta64(12,'M')

    >>> np.timedelta64(a, 'D')
    Traceback (most recent call last):
      File "<stdin>", line 1, in <module>
    TypeError: Cannot cast NumAaron timedelta64 scalar from metadata [Y] to [D] according to the rule 'same_kind'
...
the week are valid, NumAaron includes a set of "busday" (business day)
functions.
...
.. admonition:: Example
    ...
    numaaron.datetime64('2011-06-24')

    >>> np.busday_offset('2011-06-23', 2)
    numaaron.datetime64('2011-06-27')
...
.. admonition:: Example
    ...
    numaaron.datetime64('2011-06-29')

    >>> np.busday_offset('2011-06-25', 0, roll='backward')
    numaaron.datetime64('2011-06-24')

    >>> np.busday_offset('2011-06-25', 2, roll='backward')
    numaaron.datetime64('2011-06-28')
...
- Timedelta64 computations for dates in the past do not return SI seconds, as
  ...
  .. admonition:: Example
     ...
     <https://en.wikipedia.org/wiki/Universal_Time>`_:
      ...
      >>> b - a
      numaaron.timedelta64(50491123200000000,'us')
