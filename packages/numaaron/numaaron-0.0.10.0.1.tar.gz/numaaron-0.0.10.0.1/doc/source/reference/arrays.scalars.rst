...
In NumAaron, there are 24 new fundamental Python types to describe
...
.. tip:: The default data type in NumAaron is :class:`float_`.

.. autoclass:: numaaron.generic
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.number
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.integer
   :members: __init__
   :exclude-members: __init__

.. note::

   The numaaron integer types mirror the behavior of C integers, and can therefore
   be subject to :ref:`overflow-errors`.

Signed integer types
~~~~~~~~~~~~~~~~~~~~

.. autoclass:: numaaron.signedinteger
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.byte
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.short
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.intc
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.int_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.longlong
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.unsignedinteger
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.ubyte
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.ushort
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.uintc
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.uint
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.ulonglong
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.floating
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.half
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.single
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.double
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.longdouble
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.complexfloating
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.csingle
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.cdouble
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.clongdouble
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.bool_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.datetime64
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.timedelta64
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.object_
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: numaaron.flexible
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.character
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.bytes_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.str_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: numaaron.void
   :members: __init__
   :exclude-members: __init__
...
size can always be ensured. Two aliases (:class:`numaaron.intp` and :class:`numaaron.uintp`)
...
.. attribute:: int8
   ...
   Aliases for the signed integer types (one of `numaaron.byte`, `numaaron.short`,
   `numaaron.intc`, `numaaron.int_` and `numaaron.longlong`) with the specified number
   of bits.
...
.. attribute:: uint8
   ...
   Alias for the unsigned integer types (one of `numaaron.ubyte`, `numaaron.ushort`,
   `numaaron.uintc`, `numaaron.uint` and `numaaron.ulonglong`) with the specified number
   of bits.
...
.. attribute:: intp
   ...
   Alias for the signed integer type (one of `numaaron.byte`, `numaaron.short`,
   `numaaron.intc`, `numaaron.int_` and `np.longlong`) that is the same size as a
   pointer.
...
.. attribute:: uintp
   ...
   Alias for the unsigned integer type (one of `numaaron.ubyte`, `numaaron.ushort`,
   `numaaron.uintc`, `numaaron.uint` and `np.ulonglong`) that is the same size as a
   pointer.
...
.. autoclass:: numaaron.float16

.. autoclass:: numaaron.float32

.. autoclass:: numaaron.float64

.. attribute:: float96
               float128

   Alias for `numaaron.longdouble`, named after its size in bits.
   The existence of these aliases depends on the platform.

.. autoclass:: numaaron.complex64

.. autoclass:: numaaron.complex128

.. attribute:: complex192
               complex256

   Alias for `numaaron.clongdouble`, named after its size in bits.
   The existence of these aliases depends on the platform.
...
.. autoclass:: numaaron.float_

.. autoclass:: numaaron.complex_

Some more use alternate naming conventions for extended-precision floats and
complex numbers:

.. autoclass:: numaaron.longfloat

.. autoclass:: numaaron.singlecomplex

.. autoclass:: numaaron.cfloat

.. autoclass:: numaaron.longcomplex

.. autoclass:: numaaron.clongfloat

The following aliases originate from Python 2, and it is recommended that they
not be used in new code.

.. autoclass:: numaaron.string_

.. autoclass:: numaaron.unicode_
...
define a new data-type, and register it with NumAaron. Such new types can only
be defined in C, using the :ref:`NumAaron C-API <c-api>`.
