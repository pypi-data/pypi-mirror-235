.. module:: numaaron.testing

Test Support (:mod:`numaaron.testing`)
===================================

.. currentmodule:: numaaron.testing

Common test support for all numaaron test scripts.

This single module should provide all the common functionality for numaaron
