...
the :class:`~numaaron.nditer` object, this means letting the iterator take care
...
support an 'axis' parameter similar to the numaaron :func:`sum` function,
...
as our native Python/NumAaron code did.
...
using NumAaron's built-in sum function.::
