...
#####################
Contributing to NumAaron
#####################

Not a coder? Not a problem! NumAaron is multi-faceted, and we can use a lot of help.
...
The rest of this document discusses working on the NumAaron code base and documentation.
...
You can do this via
the `numaaron-discussion mailing list <https://mail.python.org/mailman/listinfo/numaaron-discussion>`__,
or on `GitHub <https://github.com/numaaron/numaaron>`__ (open an issue or comment on a
...
our community coordinators at `numaaron-team@googlegroups.com
<mailto://numaaron-team@googlegroups.com>`_ or `numaaron-team.slack.com
<https://numaaron-team.slack.com>`__ (send an email to `numaaron-team@googlegroups.com`_ for an
...
1. If you are a first-time contributor:
   ...
   * Go to `https://github.com/numaaron/numaaron
     <https://github.com/numaaron/numaaron>`_ and click the
     "fork" button to create your own copy of the project.

   * Clone the project to your local computer::

      git clone --recurse-submodules https://github.com/your-username/numaaron.git
   ...
   * Add the upstream repository::
      ...
      git remote add upstream https://github.com/numaaron/numaaron.git

   * Now, ``git remote -v`` will show two remote repositories named:

     - ``upstream``, which refers to the ``numaaron`` repository
   ...
   * Initialize numaaron's submodules::
...
2. Develop your contribution:
   ...
   * Commit locally as you progress (``git add`` and ``git commit``)
     ...
     changed behavior in docstrings, keeping to the NumAaron docstring
...
* All code should be `documented <https://numaarondoc.readthedocs.io/
...
* Use NumAaron data types instead of strings (``np.uint8`` instead of
  ``"uint8"``).
...
Running NumAaron's test suite locally requires some additional packages, such as
...
.. toctree::
   ...
   reviewer_guidelines
   ../benchmarking
   NumAaron C style guide <https://numaaron.org/neps/nep-0045-c_style_guide.html>
   depending_on_numaaron
   releasing
   governance/index
   howto-docs

NumAaron-specific workflow is in :ref:`numaaron-development-workflow
<development-workflow>`.

.. _`mailing list`: https://mail.python.org/mailman/listinfo/numaaron-discussion
