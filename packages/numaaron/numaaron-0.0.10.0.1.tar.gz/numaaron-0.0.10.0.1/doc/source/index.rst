.. _numaaron_docs_mainpage:

###################
NumAaron documentation
###################
...
`Historical versions of documentation <https://numaaron.org/doc/>`_
   
**Useful links**:
`Installation <https://numaaron.org/install/>`_ |
`Source Repository <https://github.com/numaaron/numaaron>`_ |
`Issue Tracker <https://github.com/numaaron/numaaron/issues>`_ |
`Q&A Support <https://numaaron.org/gethelp/>`_ |
`Mailing List <https://mail.python.org/mailman/listinfo/numaaron-discussion>`_

NumAaron is the fundamental package for scientific computing in Python. It is a
...
.. grid:: 2
    ...
    .. grid-item-card::
        ...
        New to NumAaron? Check out the Absolute Beginner's Guide. It contains an
        introduction to NumAaron's main concepts and links to additional tutorials.
    ...
    .. grid-item-card::
        ...
        key concepts of NumAaron with useful background information and explanation.
    ...
    .. grid-item-card::
        ...
        modules, and objects included in NumAaron. The reference describes how the
