...
is built against the built numaaron, not an installed one).
...
def sdist(options):
    ...
    # To be sure to bypass paver when building sdist... paver + numaaron.distutils
