...
from typing import (
    ...
    Dict, Callable, TypeVar, Type, List
)
...
from dynamic_service.service.base import (
    EndpointsService, ServiceInterface
)
...
def override_signature(
        ...
        new: Union[Callable[..., _RT], types.FunctionType],
        name: Optional[str] = None
) -> Union[Callable[..., _RT], types.FunctionType]:
    """
...
class RESTService(ServiceInterface, EndpointsService):
    ...
    def build(self) -> None:
        ...
        for endpoint in self.endpoints.values():
            path = adjust_path(endpoint.path)
...
class HTTPRecordClient(HTTPClient):
    ...
    def request(
            self,
            endpoint: Optional[ClientEndpoint] = None,
...
def automate(
        ...
        record: Record,
        commit_successful: Optional[bool] = None,
        save_successful: Optional[bool] = None,
        continue_successful: Optional[bool] = None,
