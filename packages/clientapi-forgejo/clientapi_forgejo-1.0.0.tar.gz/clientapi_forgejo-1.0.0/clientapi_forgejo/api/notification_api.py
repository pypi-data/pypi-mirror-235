...
class NotificationApi:
    ...
    @validate_arguments
    def notify_get_thread(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], **kwargs) -> NotificationThread:  # noqa: E501
    ...
    @validate_arguments
    def notify_new_available(self, **kwargs) -> NotificationCount:  # noqa: E501
    ...
    @validate_arguments
    def notify_read_thread(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as")] = None, **kwargs) -> NotificationThread:  # noqa: E501
