...
class ActivitypubApi:
    ...
    @validate_arguments
    def activitypub_person(self, user_id : Annotated[StrictInt, Field(..., description="user ID of the user")], **kwargs) -> ActivityPub:  # noqa: E501
    ...
    @validate_arguments
    def activitypub_person_inbox(self, user_id : Annotated[StrictInt, Field(..., description="user ID of the user")], **kwargs) -> None:  # noqa: E501
