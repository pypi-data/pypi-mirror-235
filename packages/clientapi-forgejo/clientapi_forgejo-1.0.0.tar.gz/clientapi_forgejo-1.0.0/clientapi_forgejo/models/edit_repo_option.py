...
class EditRepoOption(BaseModel):
    ...
    has_actions: Optional[StrictBool] = Field(None, description="either `true` to enable actions unit, or `false` to disable them.")
    ...
    has_packages: Optional[StrictBool] = Field(None, description="either `true` to enable packages unit, or `false` to disable them.")
    ...
    has_releases: Optional[StrictBool] = Field(None, description="either `true` to enable releases unit, or `false` to disable them.")
