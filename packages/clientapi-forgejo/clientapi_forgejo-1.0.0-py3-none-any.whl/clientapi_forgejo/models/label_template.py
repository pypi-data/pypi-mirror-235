...
class LabelTemplate(BaseModel):
    """
    LabelTemplate info of a Label template  # noqa: E501
    """
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LabelTemplate:
        """Create an instance of LabelTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LabelTemplate.parse_obj(obj)

        _obj = LabelTemplate.parse_obj({
            "color": obj.get("color"),
