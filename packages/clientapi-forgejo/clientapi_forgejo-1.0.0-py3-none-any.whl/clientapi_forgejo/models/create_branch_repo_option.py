...
class CreateBranchRepoOption(BaseModel):
    ...
    old_branch_name: Optional[StrictStr] = Field(None, description="Deprecated: true Name of the old branch to create from")
    old_ref_name: Optional[StrictStr] = Field(None, description="Name of the old branch/tag/commit to create from")
    __properties = ["new_branch_name", "old_branch_name", "old_ref_name"]
