...
class IssueApi:
    ...
    @validate_arguments
    def issue_add_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> List[Label]:  # noqa: E501
    ...
    @validate_arguments
    def issue_add_subscription(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[StrictStr, Field(..., description="user to subscribe")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_add_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[AddTimeOption] = None, **kwargs) -> TrackedTime:  # noqa: E501
    ...
    @validate_arguments
    def issue_check_subscription(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> WatchInfo:  # noqa: E501
    ...
    @validate_arguments
    def issue_clear_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_create_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[CreateIssueCommentOption] = None, **kwargs) -> Comment:  # noqa: E501
    ...
    @validate_arguments
    def issue_create_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateIssueOption] = None, **kwargs) -> Issue:  # noqa: E501
    ...
    @validate_arguments
    def issue_create_issue_blocking(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> Issue:  # noqa: E501
        """Block the issue given in the body by the issue in path  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_create_issue_blocking(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_issue_blocking_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_create_issue_blocking_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_create_issue_blocking_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Block the issue given in the body by the issue in path  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_create_issue_blocking_with_http_info(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_create_issue_blocking" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_create_issue_dependencies(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> Issue:  # noqa: E501
        """Make the issue in the url depend on the issue in the form.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_create_issue_dependencies(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_issue_dependencies_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_create_issue_dependencies_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_create_issue_dependencies_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Make the issue in the url depend on the issue in the form.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_create_issue_dependencies_with_http_info(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_create_issue_dependencies" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_create_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateLabelOption] = None, **kwargs) -> Label:  # noqa: E501
    ...
    @validate_arguments
    def issue_create_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateMilestoneOption] = None, **kwargs) -> Milestone:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to delete")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of comment to delete")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_comment_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_issue_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to delete")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to delete, identified by ID and if not available by name")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_delete_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], id : Annotated[StrictInt, Field(..., description="id of time to delete")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_edit_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], body : Optional[EditIssueCommentOption] = None, **kwargs) -> Comment:  # noqa: E501
    ...
    @validate_arguments
    def issue_edit_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to edit")], body : Optional[EditIssueOption] = None, **kwargs) -> Issue:  # noqa: E501
    ...
    @validate_arguments
    def issue_edit_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to edit")], body : Optional[EditLabelOption] = None, **kwargs) -> Label:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> Comment:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_comment_reactions(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], **kwargs) -> List[Reaction]:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to get")], **kwargs) -> Issue:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to get")], **kwargs) -> Label:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> List[Label]:  # noqa: E501
    ...
    @validate_arguments
    def issue_get_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to get, identified by ID and if not available by name")], **kwargs) -> Milestone:  # noqa: E501
    ...
    @validate_arguments
    def issue_list_blocks(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Issue]:  # noqa: E501
        """List issues that are blocked by this issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_list_blocks(owner, repo, index, page, limit, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_blocks_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_list_blocks_with_http_info(owner, repo, index, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_list_blocks_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List issues that are blocked by this issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_list_blocks_with_http_info(owner, repo, index, page, limit, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_list_blocks" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_list_issue_attachments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> List[Attachment]:  # noqa: E501
    ...
    @validate_arguments
    def issue_list_issue_comment_attachments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> List[Attachment]:  # noqa: E501
    ...
    @validate_arguments
    def issue_list_issue_dependencies(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Issue]:  # noqa: E501
        """List an issue's dependencies, i.e all issues that block this issue.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_list_issue_dependencies(owner, repo, index, page, limit, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_issue_dependencies_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_list_issue_dependencies_with_http_info(owner, repo, index, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_list_issue_dependencies_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List an issue's dependencies, i.e all issues that block this issue.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_list_issue_dependencies_with_http_info(owner, repo, index, page, limit, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_list_issue_dependencies" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_post_comment_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> Reaction:  # noqa: E501
    ...
    @validate_arguments
    def issue_post_issue_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> Reaction:  # noqa: E501
    ...
    @validate_arguments
    def issue_remove_issue_blocking(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> Issue:  # noqa: E501
        """Unblock the issue given in the body by the issue in path  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_remove_issue_blocking(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_remove_issue_blocking_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_remove_issue_blocking_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_remove_issue_blocking_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Unblock the issue given in the body by the issue in path  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_remove_issue_blocking_with_http_info(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_remove_issue_blocking" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_remove_issue_dependencies(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> Issue:  # noqa: E501
        """Remove an issue dependency  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_remove_issue_dependencies(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_remove_issue_dependencies_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.issue_remove_issue_dependencies_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_remove_issue_dependencies_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictStr, Field(..., description="index of the issue")], body : Optional[IssueMeta] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Remove an issue dependency  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.issue_remove_issue_dependencies_with_http_info(owner, repo, index, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_remove_issue_dependencies" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def issue_replace_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> List[Label]:  # noqa: E501
    ...
    @validate_arguments
    def issue_reset_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to add tracked time to")], **kwargs) -> None:  # noqa: E501
    ...
    def issue_search_issues(self, state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names. Fetch only issues that have any of this milestones. Non existent are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, priority_repo_id : Annotated[Optional[StrictInt], Field(description="repository to prioritize in the results")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, assigned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) assigned to you, default is false")] = None, created : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) created by you, default is false")] = None, mentioned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) mentioning you, default is false")] = None, review_requested : Annotated[Optional[StrictBool], Field(description="filter pulls requesting your review, default is false")] = None, reviewed : Annotated[Optional[StrictBool], Field(description="filter pulls reviewed by you, default is false")] = None, owner : Annotated[Optional[StrictStr], Field(description="filter by owner")] = None, team : Annotated[Optional[StrictStr], Field(description="filter by team (requires organization owner parameter to be provided)")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Issue]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.issue_search_issues_with_http_info(state, labels, milestones, q, priority_repo_id, type, since, before, assigned, created, mentioned, review_requested, reviewed, owner, team, page, limit, **kwargs)  # noqa: E501
    ...
    def issue_search_issues_with_http_info(self, state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names. Fetch only issues that have any of this milestones. Non existent are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, priority_repo_id : Annotated[Optional[StrictInt], Field(description="repository to prioritize in the results")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, assigned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) assigned to you, default is false")] = None, created : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) created by you, default is false")] = None, mentioned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) mentioning you, default is false")] = None, review_requested : Annotated[Optional[StrictBool], Field(description="filter pulls requesting your review, default is false")] = None, reviewed : Annotated[Optional[StrictBool], Field(description="filter pulls reviewed by you, default is false")] = None, owner : Annotated[Optional[StrictStr], Field(description="filter by owner")] = None, team : Annotated[Optional[StrictStr], Field(description="filter by team (requires organization owner parameter to be provided)")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.issue_search_issues_with_http_info(state, labels, milestones, q, priority_repo_id, type, since, before, assigned, created, mentioned, review_requested, reviewed, owner, team, page, limit, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('reviewed') is not None:  # noqa: E501
            _query_params.append(('reviewed', _params['reviewed']))
    ...
    @validate_arguments
    def issue_start_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to create the stopwatch on")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def issue_stop_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def move_issue_pin(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue")], position : Annotated[StrictInt, Field(..., description="the new position")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the move_issue_pin_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.move_issue_pin_with_http_info(owner, repo, index, position, **kwargs)  # noqa: E501

    @validate_arguments
    def move_issue_pin_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue")], position : Annotated[StrictInt, Field(..., description="the new position")], **kwargs) -> ApiResponse:  # noqa: E501
        """Moves the Pin to the given Position  # noqa: E501
        ...
        if _params['position']:
            _path_params['position'] = _params['position']
    ...
    @validate_arguments
    def pin_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to pin")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the pin_issue_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.pin_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    def pin_issue_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to pin")], **kwargs) -> ApiResponse:  # noqa: E501
        """Pin an Issue  # noqa: E501
    ...
    @validate_arguments
    def unpin_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to unpin")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the unpin_issue_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.unpin_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    def unpin_issue_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to unpin")], **kwargs) -> ApiResponse:  # noqa: E501
        """Unpin an Issue  # noqa: E501
