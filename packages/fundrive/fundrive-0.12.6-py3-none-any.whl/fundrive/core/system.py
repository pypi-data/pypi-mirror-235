...
class DriveSystem:
    ...
    def get_file_list(self, *args, **kwargs) -> list[dict[AnyStr, Any]]:
        raise NotImplementedError()

    def get_dir_list(self, *args, **kwargs) -> list[dict[AnyStr, Any]]:
        raise NotImplementedError()

    def get_file_info(self, *args, **kwargs) -> dict[AnyStr, Any]:
        raise NotImplementedError()

    def get_dir_info(self, *args, **kwargs) -> dict[AnyStr, Any]:
        raise NotImplementedError()
