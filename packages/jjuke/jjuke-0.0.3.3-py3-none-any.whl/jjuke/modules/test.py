...
from diffusion.ldm import DenoiseDiffusion
from unet.unet_base import UnetBase
from unet.ldm_unet import UNetModel

from utils.ema import ema
from utils.sched import LinearWarmup, WarmupScheduler
...
def get_args():
    ...
    parser.add_argument("--loss_type", default="rescaled_kl") # ["l2", "rescaled_l2", "l1", "rescaled_l1", "kl", "rescaled_kl"]
...
def main_worker(rank: int, args: argparse.Namespace):
    ...
    args.result_dir = os.path.join(args.result_dir, "{}_{}_{}_{}_{}".format(
