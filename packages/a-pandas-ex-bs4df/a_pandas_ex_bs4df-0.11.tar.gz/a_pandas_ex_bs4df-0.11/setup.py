...
long_description_content_type="text/markdown",
    #packages=['beautifulsoup4', 'cchardet', 'lxml', 'pandas', 'regex', 'requests', 'useful_functions_easier_life'],
    keywords=['BeautifulSoup4', 'bs4', 'pandas', 'web scraping'],
    classifiers=['Development Status :: 4 - Beta', 'Programming Language :: Python :: 3 :: Only', 'Programming Language :: Python :: 3.10', 'Topic :: Software Development :: Libraries :: Python Modules', 'Topic :: Utilities'],
    install_requires=['beautifulsoup4', 'cchardet', 'lxml', 'pandas', 'regex', 'requests', 'useful_functions_easier_life'],
