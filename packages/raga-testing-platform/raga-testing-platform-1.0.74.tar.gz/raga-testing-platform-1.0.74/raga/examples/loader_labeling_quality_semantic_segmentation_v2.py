...
def image_url(x):
    return f"https://ragatesitng-dev-storage.s3.ap-south-1.amazonaws.com/1/semantic_segmentation_demo_rgb/{x}"

def gt_mask_url(x):
    tif = x.split("/")[1]
    return f"https://ragatesitng-dev-storage.s3.ap-south-1.amazonaws.com/1/semantic_segmentation_demo_label/{tif}"

def model_mask_url(x):
    tif = x.split("/")[1]
    return f"https://ragatesitng-dev-storage.s3.ap-south-1.amazonaws.com/1/semantic_segmentation_demo_output/{tif}"
...
data_frame = csv_parser("./assets/failure_mode_analysis.csv")
...
test_ds = Dataset(test_session=test_session, 
                  name="test_demo_semantic_segmentation-v2", 
