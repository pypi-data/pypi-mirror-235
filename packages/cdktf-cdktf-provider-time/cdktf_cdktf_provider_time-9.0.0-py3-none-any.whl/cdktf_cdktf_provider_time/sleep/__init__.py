...
class Sleep(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Sleep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.9.1/docs/resources/sleep#import import section} in the documentation of this resource for the id to use
