...
class Chatbot:
    ...
    def __init__(
        ...
        self.max_tokens: int = max_tokens or (
            31000 if engine == "gpt-4-32k" else 7000 if engine == "gpt-4" else 15500 if engine=="gpt-3.5-turbo-16k-0613" else 4000
        )
        self.truncate_limit: int = truncate_limit or (
            30500 if engine == "gpt-4-32k" else 6500 if engine == "gpt-4" else 15250 if engine=="gpt-3.5-turbo-16k-0613" else 3500
        )
