...
class TypeaheadApi(object):
    ...
    def typeahead_for_workspace_with_http_info(self, workspace_gid, resource_type, opts, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'resource_type' in opts:
            query_params.append(('resource_type', opts['resource_type']))  # noqa: E501
        if 'type' in opts:
            query_params.append(('type', opts['type']))  # noqa: E501
        if 'query' in opts:
            query_params.append(('query', opts['query']))  # noqa: E501
        if 'count' in opts:
            query_params.append(('count', opts['count']))  # noqa: E501
