...
class GoalsApi(object):
    ...
    def get_goals_with_http_info(self, opts, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'portfolio' in opts:
            query_params.append(('portfolio', opts['portfolio']))  # noqa: E501
        if 'project' in opts:
            query_params.append(('project', opts['project']))  # noqa: E501
        if 'is_workspace_level' in opts:
            query_params.append(('is_workspace_level', opts['is_workspace_level']))  # noqa: E501
        if 'team' in opts:
            query_params.append(('team', opts['team']))  # noqa: E501
        if 'workspace' in opts:
            query_params.append(('workspace', opts['workspace']))  # noqa: E501
        if 'time_periods' in opts:
            query_params.append(('time_periods', opts['time_periods']))  # noqa: E501
        if 'limit' in opts:
