...
class AuditLogAPIApi(object):
    ...
    def get_audit_log_events_with_http_info(self, workspace_gid, opts, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'start_at' in opts:
            query_params.append(('start_at', opts['start_at']))  # noqa: E501
        if 'end_at' in opts:
            query_params.append(('end_at', opts['end_at']))  # noqa: E501
        if 'event_type' in opts:
            query_params.append(('event_type', opts['event_type']))  # noqa: E501
        if 'actor_type' in opts:
            query_params.append(('actor_type', opts['actor_type']))  # noqa: E501
        if 'actor_gid' in opts:
            query_params.append(('actor_gid', opts['actor_gid']))  # noqa: E501
        if 'resource_gid' in opts:
            query_params.append(('resource_gid', opts['resource_gid']))  # noqa: E501
        if 'limit' in opts:
