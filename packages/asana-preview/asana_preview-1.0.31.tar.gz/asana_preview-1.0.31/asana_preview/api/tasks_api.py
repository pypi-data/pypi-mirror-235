...
class TasksApi(object):
    ...
    def get_tasks_with_http_info(self, opts, **kwargs):  # noqa: E501
        ...
        if 'offset' in opts:
            query_params.append(('offset', opts['offset']))  # noqa: E501
        if 'assignee' in opts:
            query_params.append(('assignee', opts['assignee']))  # noqa: E501
        if 'project' in opts:
            query_params.append(('project', opts['project']))  # noqa: E501
        if 'section' in opts:
            query_params.append(('section', opts['section']))  # noqa: E501
        if 'workspace' in opts:
            query_params.append(('workspace', opts['workspace']))  # noqa: E501
        if 'completed_since' in opts:
            query_params.append(('completed_since', opts['completed_since']))  # noqa: E501
        if 'modified_since' in opts:
            query_params.append(('modified_since', opts['modified_since']))  # noqa: E501
        if 'opt_fields' in opts:
            query_params.append(('opt_fields', opts['opt_fields']))  # noqa: E501
    ...
    def search_tasks_for_workspace_with_http_info(self, workspace_gid, opts, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'text' in opts:
            query_params.append(('text', opts['text']))  # noqa: E501
        if 'resource_subtype' in opts:
            query_params.append(('resource_subtype', opts['resource_subtype']))  # noqa: E501
        if 'assignee.any' in opts:
            query_params.append(('assignee.any', opts['assignee.any']))  # noqa: E501
        if 'assignee.not' in opts:
            query_params.append(('assignee.not', opts['assignee.not']))  # noqa: E501
        if 'portfolios.any' in opts:
            query_params.append(('portfolios.any', opts['portfolios.any']))  # noqa: E501
        if 'projects.any' in opts:
            query_params.append(('projects.any', opts['projects.any']))  # noqa: E501
        if 'projects.not' in opts:
            query_params.append(('projects.not', opts['projects.not']))  # noqa: E501
        if 'projects.all' in opts:
            query_params.append(('projects.all', opts['projects.all']))  # noqa: E501
        if 'sections.any' in opts:
            query_params.append(('sections.any', opts['sections.any']))  # noqa: E501
        if 'sections.not' in opts:
            query_params.append(('sections.not', opts['sections.not']))  # noqa: E501
        if 'sections.all' in opts:
            query_params.append(('sections.all', opts['sections.all']))  # noqa: E501
        if 'tags.any' in opts:
            query_params.append(('tags.any', opts['tags.any']))  # noqa: E501
        if 'tags.not' in opts:
            query_params.append(('tags.not', opts['tags.not']))  # noqa: E501
        if 'tags.all' in opts:
            query_params.append(('tags.all', opts['tags.all']))  # noqa: E501
        if 'teams.any' in opts:
            query_params.append(('teams.any', opts['teams.any']))  # noqa: E501
        if 'followers.not' in opts:
            query_params.append(('followers.not', opts['followers.not']))  # noqa: E501
        if 'created_by.any' in opts:
            query_params.append(('created_by.any', opts['created_by.any']))  # noqa: E501
        if 'created_by.not' in opts:
            query_params.append(('created_by.not', opts['created_by.not']))  # noqa: E501
        if 'assigned_by.any' in opts:
            query_params.append(('assigned_by.any', opts['assigned_by.any']))  # noqa: E501
        if 'assigned_by.not' in opts:
            query_params.append(('assigned_by.not', opts['assigned_by.not']))  # noqa: E501
        if 'liked_by.not' in opts:
            query_params.append(('liked_by.not', opts['liked_by.not']))  # noqa: E501
        if 'commented_on_by.not' in opts:
            query_params.append(('commented_on_by.not', opts['commented_on_by.not']))  # noqa: E501
        if 'due_on.before' in opts:
            query_params.append(('due_on.before', opts['due_on.before']))  # noqa: E501
        if 'due_on.after' in opts:
            query_params.append(('due_on.after', opts['due_on.after']))  # noqa: E501
        if 'due_on' in opts:
            query_params.append(('due_on', opts['due_on']))  # noqa: E501
        if 'due_at.before' in opts:
            query_params.append(('due_at.before', opts['due_at.before']))  # noqa: E501
        if 'due_at.after' in opts:
            query_params.append(('due_at.after', opts['due_at.after']))  # noqa: E501
        if 'start_on.before' in opts:
            query_params.append(('start_on.before', opts['start_on.before']))  # noqa: E501
        if 'start_on.after' in opts:
            query_params.append(('start_on.after', opts['start_on.after']))  # noqa: E501
        if 'start_on' in opts:
            query_params.append(('start_on', opts['start_on']))  # noqa: E501
        if 'created_on.before' in opts:
            query_params.append(('created_on.before', opts['created_on.before']))  # noqa: E501
        if 'created_on.after' in opts:
            query_params.append(('created_on.after', opts['created_on.after']))  # noqa: E501
        if 'created_on' in opts:
            query_params.append(('created_on', opts['created_on']))  # noqa: E501
        if 'created_at.before' in opts:
            query_params.append(('created_at.before', opts['created_at.before']))  # noqa: E501
        if 'created_at.after' in opts:
            query_params.append(('created_at.after', opts['created_at.after']))  # noqa: E501
        if 'completed_on.before' in opts:
            query_params.append(('completed_on.before', opts['completed_on.before']))  # noqa: E501
        if 'completed_on.after' in opts:
            query_params.append(('completed_on.after', opts['completed_on.after']))  # noqa: E501
        if 'completed_on' in opts:
            query_params.append(('completed_on', opts['completed_on']))  # noqa: E501
        if 'completed_at.before' in opts:
            query_params.append(('completed_at.before', opts['completed_at.before']))  # noqa: E501
        if 'completed_at.after' in opts:
            query_params.append(('completed_at.after', opts['completed_at.after']))  # noqa: E501
        if 'modified_on.before' in opts:
            query_params.append(('modified_on.before', opts['modified_on.before']))  # noqa: E501
        if 'modified_on.after' in opts:
            query_params.append(('modified_on.after', opts['modified_on.after']))  # noqa: E501
        if 'modified_on' in opts:
            query_params.append(('modified_on', opts['modified_on']))  # noqa: E501
        if 'modified_at.before' in opts:
            query_params.append(('modified_at.before', opts['modified_at.before']))  # noqa: E501
        if 'modified_at.after' in opts:
            query_params.append(('modified_at.after', opts['modified_at.after']))  # noqa: E501
        if 'is_blocking' in opts:
            query_params.append(('is_blocking', opts['is_blocking']))  # noqa: E501
        if 'is_blocked' in opts:
            query_params.append(('is_blocked', opts['is_blocked']))  # noqa: E501
        if 'has_attachment' in opts:
            query_params.append(('has_attachment', opts['has_attachment']))  # noqa: E501
        if 'completed' in opts:
            query_params.append(('completed', opts['completed']))  # noqa: E501
        if 'is_subtask' in opts:
            query_params.append(('is_subtask', opts['is_subtask']))  # noqa: E501
        if 'sort_by' in opts:
            query_params.append(('sort_by', opts['sort_by']))  # noqa: E501
        if 'sort_ascending' in opts:
            query_params.append(('sort_ascending', opts['sort_ascending']))  # noqa: E501
        if 'opt_fields' in opts:
            query_params.append(('opt_fields', opts['opt_fields']))  # noqa: E501
