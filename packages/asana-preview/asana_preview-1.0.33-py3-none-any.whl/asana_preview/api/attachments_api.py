...
class AttachmentsApi(object):
    ...
    def create_attachment_for_object_with_http_info(self, opts, **kwargs):  # noqa: E501
        ...
        query_params = []
        query_params = [(k, v) for k, v in opts.items()]
