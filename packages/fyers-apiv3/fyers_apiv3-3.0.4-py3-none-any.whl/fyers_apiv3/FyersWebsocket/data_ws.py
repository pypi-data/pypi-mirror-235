    ...
    def On_message(self, message: dict) -> None:
        ...
        try:
            ...
            if self.OnError is not None:
                error_message = f"KeyError: The key '{key_name}' is missing in the dictionary."
                self.OnError(error_message)
            else:
                print(f"KeyError: The key '{key_name}' is missing in the dictionary.")
        except Exception as e:
            self.data_logger.exception(e)
            if self.OnError is not None:
                self.OnError(e)
