...
from genomixhub import frame as ghub
...
class TestProdGenomixHub(unittest.TestCase):
    @mock.patch.dict(
        os.environ,
        {
            ...
            "GENOMIXHUB_BACKEND_USERNAME": "user",
            "GENOMIXHUB_BACKEND_PASSWORD": "pass",
            "GENOMIXHUB_BACKEND_USERID": "123",
        },
        clear=True,
    )
    ...
    def test_load_frame_valid(self, mock_post):
        ...
        self.assertEqual("pass", function_call.kwargs["auth"].password)
        self.assertEqual("user", function_call.kwargs["auth"].username)
        self.assertEqual("123", function_call.kwargs["data"]["user_id"])
        self.assertEqual(
    ...
    @mock.patch.dict(
        ...
        {
            "GENOMIXHUB_ENVIRONMENT": "PROD",
            "GENOMIXHUB_BACKEND_URL": "http://localhost:6666",
            "GENOMIXHUB_BACKEND_USERNAME": "user",
            "GENOMIXHUB_BACKEND_PASSWORD": "pass",
            "GENOMIXHUB_BACKEND_USERID": "123",
        },
