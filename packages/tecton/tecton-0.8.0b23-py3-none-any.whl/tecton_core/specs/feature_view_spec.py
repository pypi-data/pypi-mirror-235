            ...
            if aggregation_secondary_key:
                secondary_key_rollup_outputs = tuple(
                    SecondaryKeyOutputColumn(
                        name=output_col.name, time_window=TimeWindowWrapper.from_data(output_col.time_window)
                    )
    ...
    def from_args_proto(
        ...
        if is_aggregate:
            ...
            if aggregation_secondary_key:
                secondary_key_rollup_outputs = tuple(
                    SecondaryKeyOutputColumn(
                        name=output_col.name, time_window=TimeWindowWrapper.from_args(output_col.time_window)
                    )
