...
@click.option("--port", required=False, default=49167, type=click.INT, show_default=True, help="Test server port")
@click.option(
...
def simulator(
    ...
    """
    asyncio.run(start_publisher(config, port, period, min, max, rand, asset_count, asset_parameter))
