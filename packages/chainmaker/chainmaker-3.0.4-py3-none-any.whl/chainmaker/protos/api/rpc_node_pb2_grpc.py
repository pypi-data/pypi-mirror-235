...
class RpcNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendRequest = channel.unary_unary(
                ...
                response_deserializer=common_dot_result__pb2.TxResponse.FromString,
                )
        self.Subscribe = channel.unary_stream(
                '/api.RpcNode/Subscribe',
                request_serializer=common_dot_request__pb2.TxRequest.SerializeToString,
                response_deserializer=common_dot_result__pb2.SubscribeResult.FromString,
                )
        self.SubscribeWS = channel.unary_stream(
                '/api.RpcNode/SubscribeWS',
                request_serializer=common_dot_request__pb2.RawTxRequest.SerializeToString,
                response_deserializer=common_dot_result__pb2.SubscribeResult.FromString,
                )
        self.UpdateDebugConfig = channel.unary_unary(
                '/api.RpcNode/UpdateDebugConfig',
                request_serializer=config_dot_local__config__pb2.DebugConfigRequest.SerializeToString,
                response_deserializer=config_dot_local__config__pb2.DebugConfigResponse.FromString,
                )
        self.RefreshLogLevelsConfig = channel.unary_unary(
                '/api.RpcNode/RefreshLogLevelsConfig',
                request_serializer=config_dot_log__config__pb2.LogLevelsRequest.SerializeToString,
                response_deserializer=config_dot_log__config__pb2.LogLevelsResponse.FromString,
                )
        self.GetChainMakerVersion = channel.unary_unary(
                '/api.RpcNode/GetChainMakerVersion',
                request_serializer=config_dot_chainmaker__server__pb2.ChainMakerVersionRequest.SerializeToString,
                response_deserializer=config_dot_chainmaker__server__pb2.ChainMakerVersionResponse.FromString,
                )
        self.CheckNewBlockChainConfig = channel.unary_unary(
                '/api.RpcNode/CheckNewBlockChainConfig',
                request_serializer=config_dot_local__config__pb2.CheckNewBlockChainConfigRequest.SerializeToString,
                response_deserializer=config_dot_local__config__pb2.CheckNewBlockChainConfigResponse.FromString,
                )
        self.GetPoolStatus = channel.unary_unary(
                '/api.RpcNode/GetPoolStatus',
                request_serializer=txpool_dot_transaction__pool__pb2.GetPoolStatusRequest.SerializeToString,
                response_deserializer=txpool_dot_transaction__pool__pb2.TxPoolStatus.FromString,
                )
        self.GetTxIdsByTypeAndStage = channel.unary_unary(
                '/api.RpcNode/GetTxIdsByTypeAndStage',
                request_serializer=txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageRequest.SerializeToString,
                response_deserializer=txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageResponse.FromString,
                )
        self.GetTxsInPoolByTxIds = channel.unary_unary(
                '/api.RpcNode/GetTxsInPoolByTxIds',
                request_serializer=txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsRequest.SerializeToString,
                response_deserializer=txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsResponse.FromString,
                )
        self.GetTxStatus = channel.unary_unary(
                '/api.RpcNode/GetTxStatus',
                request_serializer=txpool_dot_transaction__pool__pb2.GetTxStatusRequest.SerializeToString,
                response_deserializer=txpool_dot_transaction__pool__pb2.GetTxStatusResponse.FromString,
                )
        self.GetConsensusStateJSON = channel.unary_unary(
                '/api.RpcNode/GetConsensusStateJSON',
                request_serializer=consensus_dot_consensus__pb2.GetConsensusStatusRequest.SerializeToString,
        ...
        self.GetConsensusValidators = channel.unary_unary(
                ...
                request_serializer=consensus_dot_consensus__pb2.GetConsensusStatusRequest.SerializeToString,
                response_deserializer=consensus_dot_consensus__pb2.Validators.FromString,
                )
...
def add_RpcNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=common_dot_result__pb2.TxResponse.SerializeToString,
            ),
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=common_dot_request__pb2.TxRequest.FromString,
                    response_serializer=common_dot_result__pb2.SubscribeResult.SerializeToString,
            ),
            'SubscribeWS': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeWS,
                    request_deserializer=common_dot_request__pb2.RawTxRequest.FromString,
                    response_serializer=common_dot_result__pb2.SubscribeResult.SerializeToString,
            ),
            'UpdateDebugConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateDebugConfig,
                    request_deserializer=config_dot_local__config__pb2.DebugConfigRequest.FromString,
                    response_serializer=config_dot_local__config__pb2.DebugConfigResponse.SerializeToString,
            ),
            'RefreshLogLevelsConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.RefreshLogLevelsConfig,
                    request_deserializer=config_dot_log__config__pb2.LogLevelsRequest.FromString,
                    response_serializer=config_dot_log__config__pb2.LogLevelsResponse.SerializeToString,
            ),
            'GetChainMakerVersion': grpc.unary_unary_rpc_method_handler(
                    servicer.GetChainMakerVersion,
                    request_deserializer=config_dot_chainmaker__server__pb2.ChainMakerVersionRequest.FromString,
                    response_serializer=config_dot_chainmaker__server__pb2.ChainMakerVersionResponse.SerializeToString,
            ),
            'CheckNewBlockChainConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckNewBlockChainConfig,
                    request_deserializer=config_dot_local__config__pb2.CheckNewBlockChainConfigRequest.FromString,
                    response_serializer=config_dot_local__config__pb2.CheckNewBlockChainConfigResponse.SerializeToString,
            ),
            'GetPoolStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPoolStatus,
                    request_deserializer=txpool_dot_transaction__pool__pb2.GetPoolStatusRequest.FromString,
                    response_serializer=txpool_dot_transaction__pool__pb2.TxPoolStatus.SerializeToString,
            ),
            'GetTxIdsByTypeAndStage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTxIdsByTypeAndStage,
                    request_deserializer=txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageRequest.FromString,
                    response_serializer=txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageResponse.SerializeToString,
            ),
            'GetTxsInPoolByTxIds': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTxsInPoolByTxIds,
                    request_deserializer=txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsRequest.FromString,
                    response_serializer=txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsResponse.SerializeToString,
            ),
            'GetTxStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTxStatus,
                    request_deserializer=txpool_dot_transaction__pool__pb2.GetTxStatusRequest.FromString,
                    response_serializer=txpool_dot_transaction__pool__pb2.GetTxStatusResponse.SerializeToString,
            ),
            'GetConsensusStateJSON': grpc.unary_unary_rpc_method_handler(
                    servicer.GetConsensusStateJSON,
                    request_deserializer=consensus_dot_consensus__pb2.GetConsensusStatusRequest.FromString,
            ...
            'GetConsensusValidators': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=consensus_dot_consensus__pb2.GetConsensusStatusRequest.FromString,
                    response_serializer=consensus_dot_consensus__pb2.Validators.SerializeToString,
            ),
...
class RpcNode(object):
    ...
    def SendRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/SendRequest',
            ...
            common_dot_result__pb2.TxResponse.FromString,
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/api.RpcNode/Subscribe',
            common_dot_request__pb2.TxRequest.SerializeToString,
            common_dot_result__pb2.SubscribeResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SubscribeWS(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/api.RpcNode/SubscribeWS',
            common_dot_request__pb2.RawTxRequest.SerializeToString,
            common_dot_result__pb2.SubscribeResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateDebugConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/UpdateDebugConfig',
            config_dot_local__config__pb2.DebugConfigRequest.SerializeToString,
            config_dot_local__config__pb2.DebugConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RefreshLogLevelsConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/RefreshLogLevelsConfig',
            config_dot_log__config__pb2.LogLevelsRequest.SerializeToString,
            config_dot_log__config__pb2.LogLevelsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetChainMakerVersion(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetChainMakerVersion',
            config_dot_chainmaker__server__pb2.ChainMakerVersionRequest.SerializeToString,
            config_dot_chainmaker__server__pb2.ChainMakerVersionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CheckNewBlockChainConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/CheckNewBlockChainConfig',
            config_dot_local__config__pb2.CheckNewBlockChainConfigRequest.SerializeToString,
            config_dot_local__config__pb2.CheckNewBlockChainConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetPoolStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetPoolStatus',
            txpool_dot_transaction__pool__pb2.GetPoolStatusRequest.SerializeToString,
            txpool_dot_transaction__pool__pb2.TxPoolStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTxIdsByTypeAndStage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetTxIdsByTypeAndStage',
            txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageRequest.SerializeToString,
            txpool_dot_transaction__pool__pb2.GetTxIdsByTypeAndStageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTxsInPoolByTxIds(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetTxsInPoolByTxIds',
            txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsRequest.SerializeToString,
            txpool_dot_transaction__pool__pb2.GetTxsInPoolByTxIdsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTxStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetTxStatus',
            txpool_dot_transaction__pool__pb2.GetTxStatusRequest.SerializeToString,
            txpool_dot_transaction__pool__pb2.GetTxStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetConsensusStateJSON(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetConsensusStateJSON',
            consensus_dot_consensus__pb2.GetConsensusStatusRequest.SerializeToString,
    ...
    def GetConsensusValidators(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.RpcNode/GetConsensusValidators',
            consensus_dot_consensus__pb2.GetConsensusStatusRequest.SerializeToString,
            consensus_dot_consensus__pb2.Validators.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
