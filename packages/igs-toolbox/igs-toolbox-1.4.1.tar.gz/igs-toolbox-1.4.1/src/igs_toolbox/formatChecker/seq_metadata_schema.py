...
seq_metadata_schema = {
    ...
    "properties": {
        ...
        SeqMetadataKeys.SPECIES: {"type": "string", "pattern": "[A-z,0-9,-,_]*"},
        ...
        SeqMetadataKeys.IGS_ID: {
            "type": "string",
            "pattern": "IGS-[0-9]{5}-[A-Z]{4}-[A-z,0-9,-,_]*",
        },
        ...
        SeqMetadataKeys.SEQUENCING_REASON: {
            "enum": ["random", "requested", "other", "clinical"]
        },
        ...
        SeqMetadataKeys.PRIME_DIAGNOSTIC_LAB_FEDERAL_STATE: {
            "$ref": "#/$defs/federalStates"
        },
