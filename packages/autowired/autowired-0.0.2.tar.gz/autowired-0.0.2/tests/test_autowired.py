...
from autowired import Dependency, NotInstantiableException
...
def test_derived_context():
    ...
    assert isinstance(derived_context.service_x, ServiceX)


def test_unresolvable_dependency():
    class TestContext(Context):
        service1: Service4 = autowired()
...
def test_not_instantiable():
    ...
    try:
        ...
        cause = e.__cause__
        assert isinstance(cause, NotInstantiableException)
