...
class MRFSegmentation :public LatticeModel<T, container_type, nDim>
{
	using LatticeIterator = typename container_type::iterator;
	using LatticeConstIterator = typename container_type::const_iterator;
	
	using LatticeModel<T, container_type, nDim>::mLabels;
	using LatticeModel<T, container_type, nDim>::mWidth;
	using LatticeModel<T, container_type, nDim>::mHeight;
	using LatticeModel<T, container_type, nDim>::mDepth;
	using LatticeModel<T, container_type, nDim>::means;
	using LatticeModel<T, container_type, nDim>::vars;
