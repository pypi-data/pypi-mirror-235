...
class HessianWindowedSegmantation : public LatticeModel<T, container_type, nDim>
{
public:
	...
	HessianWindowedSegmantation(const HWSSettings &pref) :
		LatticeModel<T, container_type, nDim>(pref.nLabels), mT0(pref.TStart), mDeltaT(pref.FreezingSpeed)
	{
		//mean = new double[this->mLabels];
		//	var = new double[this->mLabels];
		mEnergyThresh = 0.01;
