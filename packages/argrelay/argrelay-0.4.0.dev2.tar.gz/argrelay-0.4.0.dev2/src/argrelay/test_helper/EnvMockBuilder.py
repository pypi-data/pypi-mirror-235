    ...
    *   ...
    ...
    def build(self):
        ...
        if self.mock_client_config_file_read:
            ...
            self.file_mock.path_to_data[client_config_desc.get_adjusted_file_path()] = json.dumps(self.client_config_dict)
        ...
        if self.mock_server_config_file_read:
            ...
            self.file_mock.path_to_data[server_config_desc.get_adjusted_file_path()] = yaml.dump(self.server_config_dict)
