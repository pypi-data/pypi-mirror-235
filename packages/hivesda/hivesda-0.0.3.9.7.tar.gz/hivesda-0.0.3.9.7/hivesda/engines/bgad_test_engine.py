...
def test(args):
    ...
    # checkpoint = "output/bgad_fas/weights/custom_tf_efficientnet_b6_conditional_flow_model_none.pt"
    checkpoint = "output/bgad_fas/weights/mvtec_tf_efficientnet_b6_conditional_flow_model_bottle.pt"
    print(checkpoint)
    if args.checkpoint:
