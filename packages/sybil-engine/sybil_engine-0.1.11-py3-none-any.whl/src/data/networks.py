from core.engine.config.app_config import get_network, get_gas_prices
...
def get_rpcs(network):
    if network == 'MAIN':
        return load_json_resource("../../../resources/main/networks.json")
    elif network == 'LOCAL':
        return load_json_resource("../../../resources/local/networks.json")
    elif network == 'GOERLI':
        return load_json_resource("../../../resources/goerli/networks.json")
    else:
