...
class MainWindow(QMainWindow):    
    ...
    def aboutButtonClicked(self, event):
        QtWidgets.QMessageBox.about(self, "About", "This is a program to calibrate the magnified pixel size for cryoEM data collected on gold foilsand other test specimens. Documentation and source code is availbale at www.mrc-lmb.cam.ac.uk/crusso/       Please cite...")
