...
class api(object):
    ...
    def set_access_token(self, _gpt, _apk):
        ...
        -----------
            response:
                {gi_destination, dcat_bbox, dcat_centroid, dct_language_sm, gbl_mdmodified_dt, locn_geometry, dct_description_sm, dct_creator_sm, dct_publisher_sm, schema_provider_s, gbl_resourceclass_sm, gbl_resourcetype_sm, dcat_theme_sm, dcat_keyword_sm, dct_spatial_sm, pcdm_memberof_sm, id, dct_title_s, dct_alternative_sm, dct_ispartof_sm, dct_rights_sm, dct_temporal_sm, dct_issued_s, gbl_indexyear_im, gbl_daterange_drsim, dct_license_sm, dct_accessrights_s, dct_format_s, dct_references_s, dct_identifier_sm, gbl_mdversion_s} response object
    ...
    def atlas_source_overview(self):
        ...
        -----------
            response:
                {gbl_mdmodified_dt, gi_destination, dct_accessrights_s, gbl_resourceclass_sm, dct_title_s, id} response object
    ...
    def auth_get_rt(self):
        ...
        -----------
            response:
                {auth0_refresh_token, auth0_user_id, date_inserted, id} response object
    ...
    def destination_source_overview(self):
        ...
        -----------
            response:
                {source_id, destination_id} response object
    ...
    def isea3h_data_destination(self):
        ...
        -----------
            response:
                {col_dtype, col_pkey, col_name, id} response object
    ...
    def isea3h_stats(self):
        ...
        -----------
            response:
                {cells, cls, spacing, resolution, area} response object
    ...
    def task_common_status_codes(self):
        ...
        -----------
            response:
                {code_description, code_status, code_id, task_tool} response object
    ...
    def task_gendggs_overview(self):
        ...
        -----------
            response:
                {priority, task_id, status} response object
    ...
    def task_gendggs_view(self):
        ...
        -----------
            response:
                {dggrid_operation, task_id, priority, status, verbosity, update_frequency, coord_precision, dggs_aperture, dggs_res_spec, clip_cell_res, dggs_type, longitude_wrap_mode, unwrap_points, clip_subset_type, input_address_type, clip_cell_addresses, output_cell_label_type, output_address_type, cell_output_type, point_output_type, children_output_type, neighbor_output_type, collection_output_gdal_format} response object
    ...
    def task_logging_view(self):
        ...
        -----------
            response:
                {tool, status, event, occurred, task_id} response object
    ...
    def task_pipeline_overview(self):
        ...
        -----------
            response:
                {status, processor, priority, pipe, s3_bucket, task_id} response object
    ...
    def task_pipeline_view(self):
        ...
        -----------
            response:
                {processor, license, comment, resolution, end_date, start_date, pipe, status, priority, task_id, description, s3_bucket, value, format, nodata, ts_interval, ts, bands} response object
    ...
    def task_ras2dggs_overview(self):
        ...
        -----------
            response:
                {task_id, status, priority} response object
    ...
    def task_ras2dggs_view(self):
        ...
        -----------
            response:
                {task_id, res, pipeline_id, clip_gid, statistic, clip_gid_res, status, priority} response object
    ...
    def isea3h_data_destination_data_upsert(self, _table_name, _values):
        """ POST isea3h_data_destination_data_upsert
    ...
    def isea3h_data_destination_delete(self, _id):
        """ POST isea3h_data_destination_delete
    ...
    def isea3h_data_destination_insert(self, _id, _col_name, _col_dtype, _col_pkey=[]):
        """ POST isea3h_data_destination_insert
