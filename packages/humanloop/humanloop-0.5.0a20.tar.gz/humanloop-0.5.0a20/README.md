...
[![PyPI](https://img.shields.io/badge/PyPI-v0.5.0alpha.20-blue)](https://pypi.org/project/humanloop/0.5.0-alpha.20)
...
- [Reference](#reference)
  ...
  * [`humanloop.evaluations.list_testcases`](#humanloopevaluationslist_testcases)
  ...
  * [`humanloop.testsets.create_testcase`](#humanlooptestsetscreate_testcase)
  * [`humanloop.testsets.delete`](#humanlooptestsetsdelete)
  * [`humanloop.testsets.get`](#humanlooptestsetsget)
  * [`humanloop.testsets.list_all_for_project`](#humanlooptestsetslist_all_for_project)
  * [`humanloop.testsets.list_testcases`](#humanlooptestsetslist_testcases)
...
```sh
pip install humanloop==0.5.0-alpha.20
```
...
### `humanloop.evaluations.list_testcases`
...
```python
humanloop.testcases.delete(
    body=["testsets_delete_testcase_request_example"],
)
```
...
[TestcaseResponse](./humanloop/type/testcase_response.py)
...
##### inputs: [`UpdateTestcaseRequestInputs`](./humanloop/type/update_testcase_request_inputs.py)

##### messages: List[[`ChatMessage`](./humanloop/type/chat_message.py)]

The chat messages for this testcase.

##### target: [`UpdateTestcaseRequestTarget`](./humanloop/type/update_testcase_request_target.py)
...
[TestsetResponse](./humanloop/type/testset_response.py)
...
### `humanloop.testsets.create_testcase`
...
##### requestBody: [`TestsetsCreateTestcaseRequest`](./humanloop/type/testsets_create_testcase_request.py)

#### 🔄 Return

[TestsetsCreateTestcaseResponse](./humanloop/type/testsets_create_testcase_response.py)
...
### `humanloop.testsets.list_all_for_project`
...
[TestsetsGetForProjectResponse](./humanloop/type/testsets_get_for_project_response.py)
...
### `humanloop.testsets.list_testcases`
