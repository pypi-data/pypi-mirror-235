...
optimizing the weights. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 26, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 29, {"cards": cards})
...
is used to immediately remove a card from learning. '''
    ...
    def deck_config_estimated_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 43, {"num": num})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP = (11, 23)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 24)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 25)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 26)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 27)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 28)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 29)
    DECK_CONFIG_DAILY_LIMITS = (11, 30)
    DECK_CONFIG_DECK_ONLY = (11, 31)
    DECK_CONFIG_DEFAULT_NAME = (11, 32)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 33)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 34)
    DECK_CONFIG_DESIRED_RETENTION = (11, 35)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 36)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 37)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 38)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 39)
    DECK_CONFIG_DO_NOT_BURY = (11, 40)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 41)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 42)
    DECK_CONFIG_ESTIMATED_RETENTION = (11, 43)
