...
from forgejo_api.api.organization_api import OrganizationApi  # noqa: E501
...
class TestOrganizationApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forgejo_api.api.organization_api.OrganizationApi()  # noqa: E501
    ...
    def test_org_list_blocked_users(self):
    ...
    def test_org_unblock_user(self):
