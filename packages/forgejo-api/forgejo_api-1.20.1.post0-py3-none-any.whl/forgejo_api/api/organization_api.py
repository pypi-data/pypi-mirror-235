...
class OrganizationApi(object):
    ...
    def org_block_user(self, org, username, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.org_block_user_with_http_info(org, username, **kwargs)  # noqa: E501
            return data

    def org_block_user_with_http_info(self, org, username, **kwargs):  # noqa: E501
        """Blocks a user from the organization  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('org' not in params or
                                                       params['org'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org` when calling `org_block_user`")  # noqa: E501
        # verify the required parameter 'username' is set
        if self.api_client.client_side_validation and ('username' not in params or
                                                       params['username'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `username` when calling `org_block_user`")  # noqa: E501
    ...
    def org_list_blocked_users(self, org, **kwargs):  # noqa: E501
        """List the organization's blocked users  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.org_list_blocked_users(org, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.org_list_blocked_users_with_http_info(org, **kwargs)  # noqa: E501
        else:
            (data) = self.org_list_blocked_users_with_http_info(org, **kwargs)  # noqa: E501
            return data

    def org_list_blocked_users_with_http_info(self, org, **kwargs):  # noqa: E501
        """List the organization's blocked users  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.org_list_blocked_users_with_http_info(org, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method org_list_blocked_users" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if self.api_client.client_side_validation and ('org' not in params or
                                                       params['org'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org` when calling `org_list_blocked_users`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[BlockedUser]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def org_unblock_user(self, org, username, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.org_unblock_user_with_http_info(org, username, **kwargs)  # noqa: E501
            return data

    def org_unblock_user_with_http_info(self, org, username, **kwargs):  # noqa: E501
        """Unblock a user from the organization  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method org_unblock_user" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if self.api_client.client_side_validation and ('org' not in params or
                                                       params['org'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org` when calling `org_unblock_user`")  # noqa: E501
        # verify the required parameter 'username' is set
        if self.api_client.client_side_validation and ('username' not in params or
                                                       params['username'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `username` when calling `org_unblock_user`")  # noqa: E501
