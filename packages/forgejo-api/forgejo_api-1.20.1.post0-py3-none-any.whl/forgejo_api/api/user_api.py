...
class UserApi(object):
    ...
    def user_list_blocked_users(self, **kwargs):  # noqa: E501
        """List the authenticated user's blocked users  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_list_blocked_users(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_list_blocked_users_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.user_list_blocked_users_with_http_info(**kwargs)  # noqa: E501
            return data

    def user_list_blocked_users_with_http_info(self, **kwargs):  # noqa: E501
        """List the authenticated user's blocked users  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_list_blocked_users_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method user_list_blocked_users" % key
                )
            params[key] = val
        del params['kwargs']
