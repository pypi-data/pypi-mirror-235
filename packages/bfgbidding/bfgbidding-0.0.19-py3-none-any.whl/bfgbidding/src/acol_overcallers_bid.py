...
class OverCallersBid(Hand):
    ...
    def _overcall_suit_after_weak_two(self):
        ...
        elif self.suit_length(self.opener_suit_one) <=2 and self.hcp >= 12:
            bid = Double('2067')
        else:
            bid = Pass('2047')
        self.tracer(__name__, inspection(), bid, self.trace)
    ...
    def _can_make_weak_balanced_overcall(self):
        ...
        result = (self.hcp >= 12 and
                ...
                #    (self.opener_bid_one.level == 2 and self.opener_suit_one != self.club_suit)
    ...
    def _can_bid_suit_at_level_four(self, suit):
        ...
        result = (self.suit_length(self.opener_suit_one) <= 2 and
                  self._minimum_in_unbid_suits() and
    ...
    def _has_six_card_suit_can_overcall_weak_two(self):
        ...
        result = (self.hcp >= 10 and
                  # self.suit_points(self.opener_suit_one) >= 7 and
                  self.shape[0] >= 6 and
