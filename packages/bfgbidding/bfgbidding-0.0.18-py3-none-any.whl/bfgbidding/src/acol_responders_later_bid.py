...
class RespondersLaterBid(Hand):
    ...
    def suggested_bid(self):
        ...
        # elif (self.opener_bid_three.level == 4 and self.opener_suit_three.is_minor and
        #       self.suit_length(self.opener_suit_three) >= 3 and self.hcp >= 11):
        #     bid = self.next_level_bid(self.opener_suit_three, '3822')
    ...
    def _select_pass_bid(self):
        ...
        # Suit preference
              ...
              self.suit_holding[self.opener_suit_three] > self.suit_holding[self.opener_suit_one] + 1 and
              self.hcp <= 10):
            bid = Pass('3886')
