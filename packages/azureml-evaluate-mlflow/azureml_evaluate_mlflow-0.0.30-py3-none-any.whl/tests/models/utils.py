...
def image_od_model_uri():
    ...
    model_path = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/yolo-mobilenet-od/artifacts/pytorch_model.bin"
    config_path = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/yolo-mobilenet-od/artifacts/yolov3_mobilenetv2_320_300e_coco.py"
    model_metafile = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/yolo-mobilenet-od/artifacts/model_metadata.json"
    augementation_config = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/yolo-mobilenet-od/artifacts/augmentations.yaml"
    mlflow_dir = join(
        dirname(dirname(dirname(dirname(__file__)))),
        "azureml-acft-image-components",
        "azureml",
...
def image_is_model_uri():
    ...
    model_path = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/mask_rcnn_hrnetv2p_w18_1x_coco/artifacts/pytorch_model.bin"
    config_path = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/mask_rcnn_hrnetv2p_w18_1x_coco/artifacts/mask_rcnn_hrnetv2p_w18_1x_coco.py"
    model_metafile = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/mask_rcnn_hrnetv2p_w18_1x_coco/artifacts/model_metadata.json"
    augementation_config = "https://automlcesdkdataresources.blob.core.windows.net/finetuning-image-models/MMDetection-mlflow/mask_rcnn_hrnetv2p_w18_1x_coco/artifacts/augmentations.yaml"
    mlflow_dir = join(
        dirname(dirname(dirname(dirname(__file__)))),
        "azureml-acft-image-components",
        "azureml",
