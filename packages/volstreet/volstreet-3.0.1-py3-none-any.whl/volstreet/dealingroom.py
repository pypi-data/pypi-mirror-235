...
from volstreet.decorators import log_errors, timeit, increase_robustness
...
class Index:
    ...
    def intraday_strangle(
        ...
        if strike_selection == "equal":
            ...
            atm_strike = findstrike(self.fetch_ltp(), self.base)
            strangle = Strangle(atm_strike, atm_strike, self.name, expiry)
        else:
