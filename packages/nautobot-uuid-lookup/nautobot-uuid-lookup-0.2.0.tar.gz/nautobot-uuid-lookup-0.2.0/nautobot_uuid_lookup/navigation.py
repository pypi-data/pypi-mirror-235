"""Navigation Items to add to Nautobot for nautobot_uuid_lookup."""
...
menu_items = (
    PluginMenuItem(
        link='plugins:nautobot_uuid_lookup:model',  # A reverse compatible link to follow.
        ...
        buttons = (  # Optional: Iterable of PluginMenuButton instances to display.
            PluginMenuButton(
                'plugins:nautobot_uuid_lookup:model',  # A reverse compatible link to follow.
