...
from openmeteo_sdk.fb.ValueAndUnit import ValueAndUnit
...
class WeatherCurrent:
    ...
    # WeatherCurrent
    def ApparentTemperature(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Cape(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Cloudcover(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def CloudcoverHigh(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def CloudcoverLow(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def CloudcoverMid(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Dewpoint2m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DiffuseRadiation(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DiffuseRadiationInstant(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DirectNormalIrradiance(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DirectNormalIrradianceInstant(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DirectRadiation(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def DirectRadiationInstant(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Et0FaoEvapotranspiration(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Evapotranspiration(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def FreezinglevelHeight(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def GrowingDegreeDaysBase0Limit50(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def IsDay(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def LatentHeatflux(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def LeafWetnessProbability(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def LiftedIndex(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def LightningPotential(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Precipitation(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def PrecipitationProbability(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def PressureMsl(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Rain(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Relativehumidity2m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Runoff(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SensibleHeatflux(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def ShortwaveRadiation(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def ShortwaveRadiationInstant(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Showers(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SnowDepth(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SnowHeight(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Snowfall(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SnowfallHeight(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SnowfallWaterEquivalent(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture0To1cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture0To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture0To10cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture0To7cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture100To200cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture100To255cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture10To40cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture1To3cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture27To81cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture28To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture3To9cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture40To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture7To28cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoisture9To27cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoistureIndex0To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoistureIndex0To7cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoistureIndex100To255cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoistureIndex28To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilMoistureIndex7To28cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature0To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature0To10cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature0To7cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature0cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature100To200cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature100To255cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature10To40cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature18cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature28To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature40To100cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature54cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature6cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SoilTemperature7To28cm(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SurfacePressure(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def SurfaceTemperature(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature100m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature120m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature150m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature180m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature2m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature20m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature200m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature50m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature40m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Temperature80m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def TerrestrialRadiation(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def TerrestrialRadiationInstant(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def TotalColumnIntegratedWaterVapour(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Updraft(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def UvIndex(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def UvIndexClearSky(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def VaporPressureDeficit(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Visibility(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Weathercode(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection100m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection10m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection120m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection150m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection180m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection200m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection20m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection40m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection50m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Winddirection80m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windgusts10m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed100m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed10m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed120m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed150m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed180m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed200m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed20m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed40m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed50m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def Windspeed80m(self) -> ValueAndUnit | None:
    ...
    # WeatherCurrent
    def WetBulbTemperature2m(self) -> ValueAndUnit | None:
...
def WeatherCurrentAddTotalColumnIntegratedWaterVapour(
    builder: flatbuffers.Builder, totalColumnIntegratedWaterVapour: Any
):
