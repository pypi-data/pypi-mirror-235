...
class MarineCurrent:
    ...
    # MarineCurrent
    def WaveHeight(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WavePeriod(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WaveDirection(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WindWaveHeight(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WindWavePeriod(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WindWavePeakPeriod(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def WindWaveDirection(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def SwellWaveHeight(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def SwellWavePeriod(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def SwellWavePeakPeriod(self) -> ValueAndUnit | None:
    ...
    # MarineCurrent
    def SwellWaveDirection(self) -> ValueAndUnit | None:
