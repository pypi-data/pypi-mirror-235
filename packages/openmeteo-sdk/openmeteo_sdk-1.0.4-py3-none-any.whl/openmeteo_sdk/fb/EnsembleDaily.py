...
from openmeteo_sdk.fb.ValuesUnitAndMember import ValuesUnitAndMember
...
class EnsembleDaily:
    ...
    # EnsembleDaily
    def ApparentTemperatureMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def ApparentTemperatureMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def ApparentTemperatureMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CapeMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CapeMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CapeMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CloudcoverMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CloudcoverMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def CloudcoverMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Dewpoint2mMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Dewpoint2mMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Dewpoint2mMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Et0FaoEvapotranspiration(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Et0FaoEvapotranspirationSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def GrowingDegreeDaysBase0Limit50(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def LeafWetnessProbabilityMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PrecipitationHours(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PrecipitationProbabilityMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PrecipitationProbabilityMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PrecipitationProbabilityMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PrecipitationSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PressureMslMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PressureMslMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def PressureMslMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def RainSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def RelativeHumidity2mMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def RelativeHumidity2mMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def RelativeHumidity2mMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def ShortwaveRadiationSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def ShowersSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SnowfallSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SnowfallWaterEquivalentSum(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoisture0To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoisture0To10cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoisture0To7cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoisture28To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoisture7To28cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoistureIndex0To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoistureIndex0To7cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoistureIndex100To255cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoistureIndex28To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilMoistureIndex7To28cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilTemperature0To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilTemperature0To7cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilTemperature28To100cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SoilTemperature7To28cmMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SurfacePressureMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SurfacePressureMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def SurfacePressureMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Temperature2mMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Temperature2mMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Temperature2mMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def UpdraftMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def UvIndexClearSkyMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def UvIndexMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def VaporPressureDeficitMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def VisibilityMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def VisibilityMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def VisibilityMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Weathercode(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Winddirection10mDominant(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windgusts10mMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windgusts10mMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windgusts10mMin(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windspeed10mMax(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windspeed10mMean(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleDaily
    def Windspeed10mMin(self) -> ValuesUnitAndMember | None:
...
def EnsembleDailyAddEt0FaoEvapotranspirationSum(builder: flatbuffers.Builder, et0FaoEvapotranspirationSum: int):
    builder.PrependUOffsetTRelativeSlot(
        14, flatbuffers.number_types.UOffsetTFlags.py_type(et0FaoEvapotranspirationSum), 0
    )
...
def EnsembleDailyAddGrowingDegreeDaysBase0Limit50(builder: flatbuffers.Builder, growingDegreeDaysBase0Limit50: int):
    builder.PrependUOffsetTRelativeSlot(
        15, flatbuffers.number_types.UOffsetTFlags.py_type(growingDegreeDaysBase0Limit50), 0
    )
...
def EnsembleDailyAddLeafWetnessProbabilityMean(builder: flatbuffers.Builder, leafWetnessProbabilityMean: int):
    builder.PrependUOffsetTRelativeSlot(
        16, flatbuffers.number_types.UOffsetTFlags.py_type(leafWetnessProbabilityMean), 0
    )
...
def EnsembleDailyAddPrecipitationProbabilityMax(builder: flatbuffers.Builder, precipitationProbabilityMax: int):
    builder.PrependUOffsetTRelativeSlot(
        18, flatbuffers.number_types.UOffsetTFlags.py_type(precipitationProbabilityMax), 0
    )
...
def EnsembleDailyAddPrecipitationProbabilityMean(builder: flatbuffers.Builder, precipitationProbabilityMean: int):
    builder.PrependUOffsetTRelativeSlot(
        19, flatbuffers.number_types.UOffsetTFlags.py_type(precipitationProbabilityMean), 0
    )
...
def EnsembleDailyAddPrecipitationProbabilityMin(builder: flatbuffers.Builder, precipitationProbabilityMin: int):
    builder.PrependUOffsetTRelativeSlot(
        20, flatbuffers.number_types.UOffsetTFlags.py_type(precipitationProbabilityMin), 0
    )
...
def EnsembleDailyAddSnowfallWaterEquivalentSum(builder: flatbuffers.Builder, snowfallWaterEquivalentSum: int):
    builder.PrependUOffsetTRelativeSlot(
        32, flatbuffers.number_types.UOffsetTFlags.py_type(snowfallWaterEquivalentSum), 0
    )
...
def EnsembleDailyAddSoilMoisture28To100cmMean(builder: flatbuffers.Builder, soilMoisture28To100cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        36, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoisture28To100cmMean), 0
    )
...
def EnsembleDailyAddSoilMoistureIndex0To100cmMean(builder: flatbuffers.Builder, soilMoistureIndex0To100cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        38, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoistureIndex0To100cmMean), 0
    )
...
def EnsembleDailyAddSoilMoistureIndex0To7cmMean(builder: flatbuffers.Builder, soilMoistureIndex0To7cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        39, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoistureIndex0To7cmMean), 0
    )
...
def EnsembleDailyAddSoilMoistureIndex100To255cmMean(builder: flatbuffers.Builder, soilMoistureIndex100To255cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        40, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoistureIndex100To255cmMean), 0
    )
...
def EnsembleDailyAddSoilMoistureIndex28To100cmMean(builder: flatbuffers.Builder, soilMoistureIndex28To100cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        41, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoistureIndex28To100cmMean), 0
    )
...
def EnsembleDailyAddSoilMoistureIndex7To28cmMean(builder: flatbuffers.Builder, soilMoistureIndex7To28cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        42, flatbuffers.number_types.UOffsetTFlags.py_type(soilMoistureIndex7To28cmMean), 0
    )
...
def EnsembleDailyAddSoilTemperature0To100cmMean(builder: flatbuffers.Builder, soilTemperature0To100cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        43, flatbuffers.number_types.UOffsetTFlags.py_type(soilTemperature0To100cmMean), 0
    )
...
def EnsembleDailyAddSoilTemperature0To7cmMean(builder: flatbuffers.Builder, soilTemperature0To7cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        44, flatbuffers.number_types.UOffsetTFlags.py_type(soilTemperature0To7cmMean), 0
    )
...
def EnsembleDailyAddSoilTemperature28To100cmMean(builder: flatbuffers.Builder, soilTemperature28To100cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        45, flatbuffers.number_types.UOffsetTFlags.py_type(soilTemperature28To100cmMean), 0
    )
...
def EnsembleDailyAddSoilTemperature7To28cmMean(builder: flatbuffers.Builder, soilTemperature7To28cmMean: int):
    builder.PrependUOffsetTRelativeSlot(
        46, flatbuffers.number_types.UOffsetTFlags.py_type(soilTemperature7To28cmMean), 0
    )
