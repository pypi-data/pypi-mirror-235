...
class MarineHourly:
    ...
    # MarineHourly
    def WaveHeight(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WavePeriod(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WaveDirection(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WindWaveHeight(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WindWavePeriod(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WindWavePeakPeriod(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def WindWaveDirection(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def SwellWaveHeight(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def SwellWavePeriod(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def SwellWavePeakPeriod(self) -> ValuesAndUnit | None:
    ...
    # MarineHourly
    def SwellWaveDirection(self) -> ValuesAndUnit | None:
