...
from openmeteo_sdk.fb.ValuesAndLevelAndMember import ValuesAndLevelAndMember
from openmeteo_sdk.fb.ValuesUnitAndMember import ValuesUnitAndMember
from openmeteo_sdk.fb.ValuesUnitPressureLevelAndMember import (
...
class EnsembleHourly:
    ...
    # EnsembleHourly
    def ApparentTemperature(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Cape(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Cloudcover(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Dewpoint2m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DiffuseRadiation(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DiffuseRadiationInstant(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DirectNormalIrradiance(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DirectNormalIrradianceInstant(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DirectRadiation(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def DirectRadiationInstant(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def FreezinglevelHeight(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def IsDay(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Precipitation(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def PressureMsl(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Rain(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Relativehumidity2m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def ShortwaveRadiation(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def ShortwaveRadiationInstant(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Showers(self) -> ValuesAndLevelAndMember | None:
    ...
    # EnsembleHourly
    def SnowDepth(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Snowfall(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilMoisture0To10cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilMoisture100To200cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilMoisture10To40cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilMoisture40To100cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilTemperature0To10cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilTemperature100To200cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilTemperature10To40cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SoilTemperature40To100cm(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SurfacePressure(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def SurfaceTemperature(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Temperature120m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Temperature2m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Temperature80m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def UvIndex(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def UvIndexClearSky(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def VaporPressureDeficit(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Visibility(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Winddirection10m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Winddirection120m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Winddirection80m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Windgusts10m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Windspeed10m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Windspeed120m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def Windspeed80m(self) -> ValuesUnitAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelTemperature(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelDewpoint(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelRelativehumidity(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelCloudcover(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelWindspeed(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelWinddirection(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelVerticalVelocity(self) -> ValuesUnitPressureLevelAndMember | None:
    ...
    # EnsembleHourly
    def PressureLevelGeopotentialHeight(self) -> ValuesUnitPressureLevelAndMember | None:
...
def EnsembleHourlyAddDirectNormalIrradianceInstant(builder: flatbuffers.Builder, directNormalIrradianceInstant: int):
    builder.PrependUOffsetTRelativeSlot(
        8, flatbuffers.number_types.UOffsetTFlags.py_type(directNormalIrradianceInstant), 0
    )
...
def EnsembleHourlyAddShortwaveRadiationInstant(builder: flatbuffers.Builder, shortwaveRadiationInstant: int):
    builder.PrependUOffsetTRelativeSlot(
        19, flatbuffers.number_types.UOffsetTFlags.py_type(shortwaveRadiationInstant), 0
    )
...
def EnsembleHourlyAddSoilTemperature100To200cm(builder: flatbuffers.Builder, soilTemperature100To200cm: int):
    builder.PrependUOffsetTRelativeSlot(
        28, flatbuffers.number_types.UOffsetTFlags.py_type(soilTemperature100To200cm), 0
    )
...
def EnsembleHourlyAddPressureLevelRelativehumidity(builder: flatbuffers.Builder, pressureLevelRelativehumidity: int):
    builder.PrependUOffsetTRelativeSlot(
        52, flatbuffers.number_types.UOffsetTFlags.py_type(pressureLevelRelativehumidity), 0
    )
...
def EnsembleHourlyAddPressureLevelWinddirection(builder: flatbuffers.Builder, pressureLevelWinddirection: int):
    builder.PrependUOffsetTRelativeSlot(
        55, flatbuffers.number_types.UOffsetTFlags.py_type(pressureLevelWinddirection), 0
    )
...
def EnsembleHourlyAddPressureLevelVerticalVelocity(builder: flatbuffers.Builder, pressureLevelVerticalVelocity: int):
    builder.PrependUOffsetTRelativeSlot(
        56, flatbuffers.number_types.UOffsetTFlags.py_type(pressureLevelVerticalVelocity), 0
    )
...
def EnsembleHourlyAddPressureLevelGeopotentialHeight(
    builder: flatbuffers.Builder, pressureLevelGeopotentialHeight: int
):
    builder.PrependUOffsetTRelativeSlot(
        57, flatbuffers.number_types.UOffsetTFlags.py_type(pressureLevelGeopotentialHeight), 0
    )
