...
def extract_text_from_article(img_dir: str = None,
    ...
    """
    This function uses tesseract to perform OCR on the images contained in the provided directory. This
    function returns the ocr'd text as a string, as well as saves the text to a txt file.
