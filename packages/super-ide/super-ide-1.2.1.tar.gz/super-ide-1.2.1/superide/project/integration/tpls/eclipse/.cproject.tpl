...
<?fileVersion 4.0.0?><cproject storage_type_id="org.eclipse.cdt.core.XmlProjectDescriptionStorage">
				...
				<configuration artifactName="{{project_name}}" buildProperties="" description="" id="0.910961921" name="Default" parent="org.eclipse.cdt.build.core.prefbase.cfg">
					<folderInfo id="0.910961921." name="/" resourcePath="">
						<toolChain id="org.eclipse.cdt.build.core.prefbase.toolchain.952979152" name="No ToolChain" resourceTypeBasedDiscovery="false" superClass="org.eclipse.cdt.build.core.prefbase.toolchain">
							...
							<builder arguments="-f -c eclipse" cleanBuildTarget="run --target clean" command="superide" id="org.eclipse.cdt.build.core.settings.default.builder.1519453406" incrementalBuildTarget="run" keepEnvironmentInBuildfile="false" managedBuildOn="false" name="Gnu Make Builder" superClass="org.eclipse.cdt.build.core.settings.default.builder"/>
	...
	<storageModule moduleId="org.eclipse.cdt.make.core.buildtargets">
		<buildTargets>
			<target name="superide: Upload using Programmer" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
			...
			<target name="superide: Upload SPIFFS image" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Build" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Verbose Build" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Upload" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Verbose Upload" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Clean" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Test" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Remote" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Rebuild C/C++ Project Index" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: List Devices" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Update Project Libraries" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Update All" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="superide: Upgrade Core" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>superide</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
