...
%    if config.get("type", "") != "superide-debug"
%  ]
%
...
//
// Documentation: https://docs.superide.org/page/plus/debugging.html
// Configuration: https://docs.superide.org/page/projectconf/section_env_debug.html
