...
class Cohere:
    ...
    def embed(
        ...
        *,
        ...
        Parameters:
            ...
            - model: typing.Optional[str]. The identifier of the model. Smaller "light" models are faster, while larger models will perform better. [Custom models](/docs/training-custom-models) can also be supplied with their full ID.
    ...
    def chat(
        ...
        *,
        ...
        Parameters:
            ...
            - stream: typing.Optional[bool]. Defaults to `false`.
    ...
    def chat_stream(
        ...
        *,
        ...
        citation_quality: typing.Optional[ChatRequestCitationQuality] = OMIT,
        temperature: typing.Optional[float] = OMIT,
    ) -> typing.Iterator[NonStreamedChatResponse]:
        """
        The `chat` endpoint allows users to have conversations with a Large Language Model (LLM) from Cohere. Users can send messages as part of a persisted conversation using the `conversation_id` parameter, or they can pass in their own conversation history using the `chat_history` parameter.
    ...
    def summarize(
        ...
        *,
        ...
        Parameters:
            ...
            - model: typing.Optional[SummarizeRequestModel]. The identifier of the model to generate the summary with. Currently available models are `command` (default), `command-nightly` (experimental), `command-light`, and `command-light-nightly` (experimental). Smaller, "light" models are faster, while larger models will perform better.
...
class AsyncCohere:
    ...
    async def chat_stream(
        ...
        *,
        ...
        citation_quality: typing.Optional[ChatRequestCitationQuality] = OMIT,
        temperature: typing.Optional[float] = OMIT,
    ) -> typing.AsyncIterator[NonStreamedChatResponse]:
        """
        The `chat` endpoint allows users to have conversations with a Large Language Model (LLM) from Cohere. Users can send messages as part of a persisted conversation using the `conversation_id` parameter, or they can pass in their own conversation history using the `chat_history` parameter.
