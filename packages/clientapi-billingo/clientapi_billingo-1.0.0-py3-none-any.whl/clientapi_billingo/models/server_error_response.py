...
class ServerErrorResponse(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """ServerErrorResponse - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this ServerErrorResponse.  # noqa: E501


        :return: The error of this ServerErrorResponse.  # noqa: E501
        :rtype: ServerError
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this ServerErrorResponse.  # noqa: E501
        :type: ServerError
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerErrorResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerErrorResponse):
            return False
