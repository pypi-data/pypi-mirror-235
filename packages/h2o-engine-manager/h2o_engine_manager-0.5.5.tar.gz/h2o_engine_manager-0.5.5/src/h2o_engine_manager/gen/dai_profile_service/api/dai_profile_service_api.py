...
from h2o_engine_manager.gen.dai_profile_service.api_client import ApiClient, Endpoint as _Endpoint
from h2o_engine_manager.gen.dai_profile_service.model_utils import (  # noqa: F401
...
class DAIProfileServiceApi(object):
    ...
    def d_ai_profile_service_delete_dai_profile(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_profile_service_delete_dai_profile(name, async_req=True)
        >>> result = thread.get()
    ...
    def d_ai_profile_service_get_dai_profile(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_profile_service_get_dai_profile(name, async_req=True)
        >>> result = thread.get()
