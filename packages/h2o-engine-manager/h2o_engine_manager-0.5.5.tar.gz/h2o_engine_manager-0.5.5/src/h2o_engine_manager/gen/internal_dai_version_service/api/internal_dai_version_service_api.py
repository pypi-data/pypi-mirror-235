...
from h2o_engine_manager.gen.internal_dai_version_service.api_client import ApiClient, Endpoint as _Endpoint
from h2o_engine_manager.gen.internal_dai_version_service.model_utils import (  # noqa: F401
...
class InternalDAIVersionServiceApi(object):
    ...
    def internal_dai_version_service_delete_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_delete_internal_dai_version(name, async_req=True)
        >>> result = thread.get()

        Args:
            name (str): InternalDAIVersion resource name.
    ...
    def internal_dai_version_service_get_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_get_internal_dai_version(name, async_req=True)
        >>> result = thread.get()
