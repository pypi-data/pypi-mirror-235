...
from h2o_engine_manager.gen.internal_h2o_version_service.api_client import ApiClient, Endpoint as _Endpoint
from h2o_engine_manager.gen.internal_h2o_version_service.model_utils import (  # noqa: F401
...
class InternalH2OVersionServiceApi(object):
    ...
    def internal_h2_o_version_service_delete_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_delete_internal_h2_o_version(name, async_req=True)
        >>> result = thread.get()

        Args:
            name (str): InternalH2OVersion resource name.
    ...
    def internal_h2_o_version_service_get_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_get_internal_h2_o_version(name, async_req=True)
        >>> result = thread.get()
