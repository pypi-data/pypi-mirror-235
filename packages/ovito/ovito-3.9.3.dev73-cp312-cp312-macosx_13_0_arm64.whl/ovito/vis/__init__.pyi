...
__all__ = ['Viewport', 'OpenGLRenderer', 'DataVis', 'CoordinateTripodOverlay', 'PythonViewportOverlay', 'TextLabelOverlay', 'ViewportOverlay', 'TriangleMeshVis', 'ViewportOverlayInterface', 'LinesVis', 'SimulationCellVis', 'TrajectoryLinesVis', 'ColorLegendOverlay', 'SurfaceMeshVis', 'VoxelGridVis', 'ParticlesVis', 'VectorVis', 'BondsVis', 'TrajectoryVis', 'DislocationVis', 'OSPRayRenderer', 'TachyonRenderer']
...
Controls the visual appearance of lines. An instance of this class is attached to every :py:class:`Lines` data object. 
Lines objects can be created directly using the `DataCollection.lines`'s create method.

Alternatively, lines can be created by inserting the :py:class:`GenerateTrajectoryLinesModifier`
into a data pipeline. The modifier owns a :py:class:`LinesVis` element, which is used for 
