...
class CompanionAgent():
    ...
    def summarize_related_memories(self, observation: str, role: str = None, now: Optional[datetime] = None, intent_recognition = True) -> str:
        ...
        task_list += [tpe.submit(band, key='related', q1=Q4, queries=[q4], depth=1, most_recent_memories='', importance_weight=0.0, threshold=0.7, top_k=10)]
    ...
    def _generate_reaction(
        ...
        # )
        kwargs[self.memory.most_recent_memories_token_key] = 1
