...
from bitfount.federated.algorithms.hugging_face_algorithms.hugging_face_text_lora_fine_tuning import (  # noqa: B950
...
@dataclass
class HuggingFaceTextLoraFineTuningArgumentsConfig:
    """Configuration for the HuggingFaceTextLoraFineTuning algorithm arguments."""
...
@dataclass
class HuggingFaceTextLoraFineTuningAlgorithmConfig(AlgorithmConfig):
    """Configuration for the HuggingFaceTextLoraFineTuning algorithm."""

    name: str = desert.field(
        fields.String(
            validate=validate.Equal(AlgorithmType.HuggingFaceTextLoraFineTuning.value)
        )
    )

    arguments: Optional[HuggingFaceTextLoraFineTuningArgumentsConfig] = desert.field(
        fields.Nested(desert.schema_class(HuggingFaceTextLoraFineTuningArgumentsConfig))
    )
