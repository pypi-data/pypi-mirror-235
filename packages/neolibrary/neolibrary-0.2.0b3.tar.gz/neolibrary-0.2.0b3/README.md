...
![neolibrary-Version: 0.2.0b2](https://img.shields.io/badge/neolibrary-0.2.0b2-informational?style=flat-square)
![PyPI status](https://img.shields.io/pypi/status/ansicolortags.svg)
![Python 3.9](https://img.shields.io/badge/python-3.9.0lue.svg)[![Publish to PyPI](https://github.com/NeoMedSys/neolibrary/actions/workflows/pippackaging.yml/badge.svg?branch=main&event=push)](https://github.com/NeoMedSys/neolibrary/actions/workflows/pippackaging.yml)
