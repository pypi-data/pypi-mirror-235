...
class Phrase(Enum):
    ...
    args = [
        [
            r"(The\s+)?(Version|Arguments|Evidence|Position|Comment|Allegations)",
            r"(of|for)",
            r"the",
        ...
        [
            ...
            r"(Version|Arguments|Evidence|Position|Comment|Reply|Allegations)",
        ],
        [r"(The\s+)?Arguments?", r"of", r"the", r"Parties"],
    ]
    pleading = [
        [r"(The\s+)?Present", r"(Petition|Appeal)s?(\s+for\s+Review)?"],
        [r"(The\s+)?Petition", r"Before", r"the", r"Court"],
        [
            r"(The\s+)?(Complaint|Charge|Petition|Appeal|Information|Arraignment\s+and\s+Plea)s?",
        ],
    ]
    issue = [
        ...
        [r"(The\s*)?(Threshold|Core|Assigned)?", r"(Error|Issue)s?"],
        [r"(The\s+)?Issues?"],
    ]
    ruling = [
