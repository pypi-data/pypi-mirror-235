...
class Block(rx.Base):
    ...
    @classmethod
    def from_line(cls, line: str, line_number: int = 0, component_map: types.ComponentMap = {}) -> Block | None:
        ...
        if cls.starting_indicator is None or line.startswith(cls.starting_indicator):
            return cls(start_line_number=line_number, component_map=component_map).append(line)
