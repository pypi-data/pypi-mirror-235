            ...
            if type(x) == Placeholder:
                ...
                if x is None:
                    if defined:
                        ...
                        return None
            values = []
            list_values = x if type(x) == list else x.split(",")
...
def get_var_data(content, node_id=None):  # noqa: C901
    ...
    def _get_list_var_data(x):
        ...
        elif type(first_elem) == ast.Num:
            return [elem.n for elem in x.elts]
        elif type(first_elem) == ast.NameConstant or type(first_elem) == ast.Constant:
            return [elem.value for elem in x.elts]
        elif type(first_elem) == ast.Name:
