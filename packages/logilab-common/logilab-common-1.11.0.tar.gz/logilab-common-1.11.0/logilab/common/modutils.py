...
from logilab.common.deprecation import callable_deprecated, class_deprecated
...
class NoSourceFile(Exception, metaclass=class_deprecated):
    """exception raised when we are not able to get a python
    source file for a precompiled file
    """

    __deprecation_warning_version__ = "2.0"
...
@callable_deprecated(version="2.0")
