...
import { LaptopSimpleIcon } from '@datalayer/icons-react';
...
const JupyterSSH = (props: SSHProps) => {
    ...
    <>
      <ThemeProvider>
        <BaseStyles>
          <Box>
            <Box>
              <UnderlineNav aria-label="docker">
                ...
                <UnderlineNav.Item aria-label="about" aria-current={intTab === 2 ? "page" : undefined} icon={() => <LaptopSimpleIcon colored/>} onSelect={e => {e.preventDefault(); setTab(2.0);}}>
                  About
                </UnderlineNav.Item>
              </UnderlineNav>
            </Box>
