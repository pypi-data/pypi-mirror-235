...
const AboutTab = (props: Props): JSX.Element => {
  ...
  return (
    <>
      <Pagehead>🪐 💻 Jupyter SSH<Label sx={{marginLeft: 1}}>{version}</Label></Pagehead>
      <Box>
        <Text>Manage SSH from Jupyter.</Text>
      </Box>
      <Box mt={3}>
        {!pirate ?
      ...
      <Box>
        <Link href="https://github.com/datalayer/jupyter-ssh" target="_blank">
