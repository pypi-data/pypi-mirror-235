...
module.exports = {
  title: '🪐 💻 Jupyter SSH documentation',
  tagline: 'Jupyter SSH documentation',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/datalayer/jupyter-ssh',
          position: 'right',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/datalayer/jupyter-ssh/edit/main/',
        },
        theme: {
