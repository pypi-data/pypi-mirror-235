...
KerbSessionAth: user auth, this authenticates using kerberos and uses session cookies
...
class KerbSessionAuth(SessionAuthBase):
    def __init__(self, url=None, hostname="auth.cern.ch", realm="cern"):
        super().__init__(hostname=hostname, realm=realm)
