from merrymake.merrymimetype import MerryMimetype
...
class MerryMimetypes:
    ...
    _3gp = MerryMimetype("video", "3gpp")
    _3g2 = MerryMimetype("video", "3gpp2")
    _7z = MerryMimetype("application", "x-7z-compressed")
