...
def enrich_with_gpt(domain: str) -> None:
    ...
    class Review:
        ...
        services: str # csv of the services offered by the company. services are intangible goods sold by the company. do not list products here.
        customers: str # csv of the customers of the company. customers are the people or companies that buy the products or services. do not list suppliers here.
    """
