...
class Function:
    ...
    def __init__(self, function, cluster_kwargs, keepalive, environ, local: bool = False):
...
def function(
    *,
    ...
    def decorator(func) -> Function:
        ...
        return functools.wraps(func)(Function(func, cluster_kwargs, keepalive=keepalive, environ=environ, local=local))
