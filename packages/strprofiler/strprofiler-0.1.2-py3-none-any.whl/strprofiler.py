...
#     elements = [
#         s.strip()[:-2] if s.strip().endswith('.0') else s.strip() for s in x.split(",")
#     ]
#     # Remove duplicates.
...
def _clean_element(x):
    ...
    # Remove duplicates from string elements and sort them
    ...
    # Combine sorted numeric and sorted string elements
