...
class TestGenerator(unittest.TestCase):
    ...
    def test_generate(self):
        parsed_patent_479 = parser.parse_patent_from_pdf_path(self.patent_479_path)
        parsed_patent_131 = parser.parse_patent_from_pdf_path(self.patent_131_path)

        claims_479 = parser.parse_claims_from_parsed_patent(parsed_patent_479)
        claim_element_479 = parser.serialize_claim_elements(claims_479.claims[0])

        passages = generator.generate_passages(parsed_patent_479, parsed_patent_131, claim_element_479)
