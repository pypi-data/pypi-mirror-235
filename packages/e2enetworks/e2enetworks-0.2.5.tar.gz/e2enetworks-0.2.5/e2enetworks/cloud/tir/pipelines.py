...
class PipelineClient:
    ...
    def help():
        ...
        1. create_pipeline_version(name, description, file_path, pipeline_id)
           - Create a new pipeline version.
        2. list_pipeline_version(pipeline_id)
           - List all versions of a pipeline.
        3. get_pipeline_version(pipeline_id, version_id)
           - Get details of a specific pipeline version.
        4. delete_pipeline_version(pipeline_id, version_id)
           - Delete a specific pipeline version.
        5. create_experiment(name, description=None)
           - Create a new experiment.
        6. list_experiments()
           - List existing experiments.
        7. get_experiment(experiment_id='')
           - Get details of a specific experiment.
        8. delete_experiment(experiment_id='')
           - Delete a specific experiment.
        9. create_run(name='', description='', experiment_id='', pipeline_version_id='', service_account='')
           - Create a new run.
        10. list_runs()
            - List existing runs.
        11. get_run(run_id='')
