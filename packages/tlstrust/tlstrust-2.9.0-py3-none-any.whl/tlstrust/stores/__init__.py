...
from .android_15 import __version__ as android15_version
from .android_latest import __version__ as android_version
from .cloudflare import __version__ as cfssl_version
from .cloudflare_ios import __version__ as cfssl_ios_version
from .cloudflare_osx import __version__ as cfssl_osx_version
from .cloudflare_nss import __version__ as cfssl_nss_version
from .cloudflare_ubuntu import __version__ as cfssl_ubuntu_version
from .cloudflare_windows import __version__ as cfssl_windows_version
...
VERSIONS = {
    ...
    context.ANDROID_VANILLA_ICE_CREAM: android15_version,
    ...
    context.CLOUDFLARE: cfssl_version,
    context.CFSSL_IOS: cfssl_ios_version,
    context.CFSSL_OSX: cfssl_osx_version,
    context.CFSSL_NSS: cfssl_nss_version,
    context.CFSSL_UBUNTU: cfssl_ubuntu_version,
    context.CFSSL_WINDOWS: cfssl_windows_version,
    context.CFSSL_DOCKER_BUILDX: cfssl_version,
    context.CFSSL_K8S_BUILDX: cfssl_version,
    context.CFSSL_K8S_ETCD: cfssl_version,
    context.CFSSL_DOCKER_COMPOSE: cfssl_version,
    context.PY_HTTPX: certifi_version,
    context.GO_HTTPX: cfssl_version,
    context.GO_TLSX: cfssl_version,
}
