...
class PortfolioStats:
    ...
    def __init__(self, prices: DataFrame, log: bool = False, annualization_factor: int = 252) -> None:
        ...
        Parameters:
            prices (DataFrame): Price data for assets.
    ...
    def _calculate(self) -> DataFrame:
        ...
        Returns:
            DataFrame: Portfolio statistics for each asset.
        """
    ...
    def _get_ann_ret(self, data: Series) -> float:
        ...
        Parameters:
            data (Series): Return data for an asset.
    ...
    def _get_ann_risk(self, data: Series) -> float:
    ...
    def _get_simple_cumu_ret(self, data: Series) -> float:
    ...
    def _get_log_cumu_ret(self, data: Series) -> float:
    ...
    def _get_simple_dd(self, data: Series) -> float:
    ...
    def _get_log_dd(self, data: Series) -> float:
    ...
    def _get_sharpe(self, data: Series) -> float:
