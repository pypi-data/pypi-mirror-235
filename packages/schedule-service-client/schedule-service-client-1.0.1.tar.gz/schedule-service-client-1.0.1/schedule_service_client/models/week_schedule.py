...
class WeekSchedule(BaseModel):
    ...
    year_range: Optional[Any] = None
    subjects: Optional[List[Subject]] = None
    coordinates: Optional[Any]
    __properties: ClassVar[List[str]] = ["date", "datetime", "year_range", "subjects", "coordinates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if year_range (nullable) is None
        # and model_fields_set contains the field
        if self.year_range is None and "year_range" in self.model_fields_set:
            _dict['year_range'] = None
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "year_range": AnyOf.from_dict(obj.get("year_range")) if obj.get("year_range") is not None else None,
