...
class ScheduleApi:
    ...
    @validate_call
    async def get_weeks_schedule_api_v1_schedule_get(
        self,
        course: Optional[StrictInt] = None,
        semester: Optional[StrictInt] = None,
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_weeks_schedule_api_v1_schedule_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return await self.get_weeks_schedule_api_v1_schedule_get_with_http_info.raw_function(
            course,
            semester,
            **kwargs,
        )
    ...
    @validate_call
    async def get_weeks_schedule_api_v1_schedule_get_with_http_info(
        self,
        course: Optional[StrictInt] = None,
        semester: Optional[StrictInt] = None,
        **kwargs,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_weeks_schedule_api_v1_schedule_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
