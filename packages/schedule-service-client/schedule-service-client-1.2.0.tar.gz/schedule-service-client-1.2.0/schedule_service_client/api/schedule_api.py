...
class ScheduleApi:
    ...
    async def get_days_week_api_v1_schedule_day_week_get(
        self,
        course: Optional[StrictStr],
        semester: Optional[StrictStr],
        platoon: Optional[StrictStr] = None,
        **kwargs,
    ) -> List[WeekDate]:
    ...
    async def get_schedule_api_v1_schedule_get(
        ...
        course: Optional[StrictStr],
        semester: Optional[StrictStr],
        update_cache: Optional[StrictBool] = None,
    ...
    async def get_schedule_api_v1_schedule_get_with_http_info(
        ...
        **kwargs,
        ...
        # process the query parameters
        _query_params: List[Tuple[str, str]] = []
        if _params.get('update_cache') is not None:  # noqa: E501
            _query_params.append(('update_cache', _params['update_cache']))
