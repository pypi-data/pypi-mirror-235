...
class ScheduleApi:
    ...
    @validate_call
    async def get_days_week_api_v1_schedule_days_week_get(
        self,
        course: StrictInt,
        semester: StrictInt,
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_days_week_api_v1_schedule_days_week_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return await self.get_days_week_api_v1_schedule_days_week_get_with_http_info.raw_function(
            course,
            semester,
            platoon,
            **kwargs,
    ...
    @validate_call
    async def get_days_week_api_v1_schedule_days_week_get_with_http_info(
        self,
        course: StrictInt,
        semester: StrictInt,
        platoon: Annotated[Optional[StrictInt], Field(description="`e.g 222`")] = None,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_days_week_api_v1_schedule_days_week_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
