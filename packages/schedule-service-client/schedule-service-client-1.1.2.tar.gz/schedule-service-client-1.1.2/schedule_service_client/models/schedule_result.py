...
class ScheduleResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["week", "result"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "week": obj.get("week"),
            "result": [WeekScheduleResult.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None
        })
        return _obj
