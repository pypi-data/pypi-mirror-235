...
class ServicequotasTemplateAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param skip_destroy: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/servicequotas_template_association#skip_destroy ServicequotasTemplateAssociation#skip_destroy}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
