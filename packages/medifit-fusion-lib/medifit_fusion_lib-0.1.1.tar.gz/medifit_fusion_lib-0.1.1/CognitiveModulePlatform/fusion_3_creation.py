...
class Fusion2Algorithm:
    def __init__(self, training_file1, training_file2, training_file3, training_file4, validation_file1, validation_file2,
                 validation_file3, validation_file4):
        self.data_training1 = load(training_file1)
        self.data_training2 = load(training_file2)
        self.data_training3 = load(training_file3)
        self.data_training4 = load(training_file4)
        ...
        self.data_validation4 = load(validation_file4)
    ...
    def process(self):
        ...
        labels_training4, features_training4 = self.extract_labels_features(self.data_training4)
        ...
        labels_validation4, features_validation4 = self.extract_labels_features(self.data_validation4)

        combined_features_training = self.combine_features(features_training1, features_training2, features_training3, features_training4)
        combined_features_validation = self.combine_features(features_validation1, features_validation2,
                                                             features_validation3, features_validation4)
...
class Fusion2AlgorithmExternal:
    ...
    def process(self):
        self.combined_features_training = self.combine_features(self.data_training1, self.data_training2,
                                                                self.data_training3, self.data_training4)
