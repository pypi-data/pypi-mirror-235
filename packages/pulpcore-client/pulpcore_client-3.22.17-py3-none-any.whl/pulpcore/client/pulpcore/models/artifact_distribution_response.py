...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_url=None, base_path=None, pulp_href=None, pulp_created=None, pulp_labels=None, name=None, local_vars_configuration=None):  # noqa: E501
