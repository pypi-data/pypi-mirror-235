...
class LLMServingParams(BaseModel):
    ...
    loramodel_path: str = Field(..., description="Path to the LoRA model can be a huggingface model or a custom model link", examples=["qblocks/OpenPlatypus_LLAMA2_7b"])
    ...
    api_auth_token: str = Field(str(uuid.uuid4()), description="API authentication token, auto-generated")
