    ...
    def cpu_consumption_profile_v1_consumption_profile_cpu_post(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the cpu_consumption_profile_v1_consumption_profile_cpu_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.cpu_consumption_profile_v1_consumption_profile_cpu_post_with_http_info.raw_function(
            verbose,
