...
class BatchProposal(BatchProposalMixin):
    ...
    def __init__(self, id=None, gear_id=None, state=None, config=None, origin=None, priority=None, proposal=None, ambiguous=None, matched=None, not_matched=None, optional_input_policy=None, improper_permissions=None, created=None, modified=None):  # noqa: E501
    ...
    @property
    def priority(self):
        """Gets the priority of this BatchProposal.


        :return: The priority of this BatchProposal.
        :rtype: str
        """
    ...
    def priority(self, priority):
        """Sets the priority of this BatchProposal.


        :param priority: The priority of this BatchProposal.  # noqa: E501
        :type: str
        """
