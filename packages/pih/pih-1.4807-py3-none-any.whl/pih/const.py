...
class SETTINGS(Enum):
    ...
    POLIBASE_PERSON_REVIEW_NOTIFICATION_TEXT: StorageVariableHolder = StorageVariableHolder(
    ...
    #
    PRINTER_REPORT_PERIOD_IN_MINUTES: IntStorageVariableHolder = IntStorageVariableHolder(
    ...
    POLIBASE_PERSON_VISIT_NOTIFICATION_TEXT: StorageVariableHolder = StorageVariableHolder(
    ...
    POLIBASE_PERSON_TAKE_TELEGRAM_BOT_URL_TEXT: StorageVariableHolder = StorageVariableHolder(
    ...
    #
    EMPLOYEE_CHECK_STATUS_WANTER_USER_LIST: IntStorageVariableHolder = (
        StorageVariableHolder("EMPLOYEE_CHECK_STATUS_WANTER_USER_LIST", ["nak", "vvs"])
    )
    ...
    POLIBASE_PERSON_VISIT_NEED_CONFIRMATION_STATUS_TO_SEND_NOTIFICATION: BoolStorageVariableHolder = BoolStorageVariableHolder(
    ...
    POLIBASE_WAS_RESTARTED_NOTIFICATION_TEXT: StorageVariableHolder = StorageVariableHolder(
...
class Events(Enum):
    ...
    IT_NOTIFY_ABOUT_CREATE_TEMPORARY_MARK: EventDescription = EventDescription(
        ...
        LogMessageChannels.IT,
        LogMessageFlags.NOTIFICATION.value,
        (PARAM_ITEMS.NAME, ParamItem("tab_number", ""), PARAM_ITEMS.TELEPHONE_NUMBER),
    )
    ...
    IT_NOTIFY_ABOUT_TEMPORARY_MARK_RETURN: EventDescription = EventDescription(
        ...
        LogMessageChannels.IT,
        LogMessageFlags.NOTIFICATION.value,
        (PARAM_ITEMS.NAME, ParamItem("tab_number", "")),
    )
    ...
    POLIBASE_PERSON_WAS_CREATED: EventDescription = EventDescription(
        ...
        LogMessageChannels.POLIBASE,
        LogMessageFlags.NOTIFICATION,
        (PARAM_ITEMS.NAME, ParamItem("pin", ""), ParamItem("value", "")),
    )
    ...
    CARD_REGISTRY_FOLDER_WAS_SET_FOR_POLIBASE_PERSON: EventDescription = (
        EventDescription(
            ...
            LogMessageFlags.SAVE,
            [PARAM_ITEMS.PERSON_PIN, PARAM_ITEMS.CARD_REGISTRY_FOLDER],
        )
    )
