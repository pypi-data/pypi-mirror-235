...
class Scte35Profile:
    ...
    def __init__(self):
        ...
        A Scte35Profile
        """
        self.parse_cues = False  # Show SCTE-35 Cues fully expanded.
    ...
    def format4profile(self, this, that):
        if this is None or that is None:
            return
        this = this.lower()
        if this.startswith("parse") or this.startswith("show"):
    ...
    def _parse_manifest(self, manifest):
        ...
        with reader(manifest) as m3u8:
            ...
            with open(self.flat, "a") as flat:
                [flat.write(line) for line in m3u8_lines]
