...
import azcam
from azcam_console.tools.tools import Tools
...
class ObserveQt(QMainWindow, Tools, ObserveCommon):
    ...
    def closeEvent(self, event):
        ...
        azcam.db.parameters.set_local_par("observe", "number_cycles", self.number_cycles)
    ...
    def set_azalt(self, flag=1):
        ...
        if self.azalt_mode:
            ___qtablewidgetitem9.setText(QCoreApplication.translate("observe", "AZ", None))
            ___qtablewidgetitem10.setText(QCoreApplication.translate("observe", "ALT", None))
        else:
            ___qtablewidgetitem9.setText(QCoreApplication.translate("observe", "RA", None))
            ___qtablewidgetitem10.setText(QCoreApplication.translate("observe", "DEC", None))
