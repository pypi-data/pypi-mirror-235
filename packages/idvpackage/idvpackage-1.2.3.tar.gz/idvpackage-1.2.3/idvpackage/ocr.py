...
class IdentityVerification:
    ...
    def extract_document_info(self, image, document_type, side, country, nationality):
        document_data = {}
    ...
    def extract_ocr_info(self, data, video, country, report_names=['document', 'facial'], face_match_threshold=0.60):
        document_report = {}
        facial_report = {}
