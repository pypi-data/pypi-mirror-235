...
# Create displacements
    phonon.create_displacements(args.force_expansion)

# get the number of displacements
    disp = phonon.disp_files()

# Generate the job file
    job = phonon.phonopy_submit(args.cores, args.mesh)
    ...
    if args.bec:
        ...
        with open('INCAR', 'a') as f:
            f.write('ENCUT = {}\n'.format(str(args.encut)))
        core.generate_job('BEC', args.bec_cores, 'vasp_std', conv=False)
        os.chdir('..')
