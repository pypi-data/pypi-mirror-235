...
class functionCalling:
    def __init__(self, test_cases, prompts, functions, model_test="gpt-3.5-turbo", model_test_temperature=0.6, model_test_max_tokens=1000, best_prompts=2, function_call="auto"):
