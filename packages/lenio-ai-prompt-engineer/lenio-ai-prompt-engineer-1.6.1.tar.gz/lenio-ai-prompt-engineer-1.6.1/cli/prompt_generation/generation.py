...
def generate_candidate_prompts(system_gen_system_prompt, test_cases, description, model_generation='gpt-4', model_generation_temperature=1.2, model_generation_max_tokens=500, number_of_prompts=4, prompt_features=None):
        ...
        if prompt_features is not None:
            ...
            outputs = openai_call.create_chat_completion(model, messages, max_tokens, temperature, n)
        else:
