...
if __name__ == '__main__':
    ...
    origin_video = os.path.join("images", "DVA修改.mp4")
    target_video = os.path.join("images", "cat修改.mp4")
    ...
    quick_v = QuickVerifyVideo(verify_engine_list, 0.8, crop_place=None, background_similar=1.1, auto_crop=True)
