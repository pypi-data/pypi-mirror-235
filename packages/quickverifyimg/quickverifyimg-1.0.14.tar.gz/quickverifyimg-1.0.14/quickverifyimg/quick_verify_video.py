...
from quickverifyimg.utils.crop_utils import get_auto_crop_image
...
class QuickVerifyVideo():
    ...
    def _is_image_similar(self, image1, image2, verify_engine_list, is_background=False, skip_auto_crop=False):
        image1_crop = image1
        image2_crop = image2
