...
class DataIngestFilter:
    ...
    def run_common(self, in_np_merged):
        ...
        logger.info(f"Projections df shape: (1, {str(projections_df.shape)[1:]}")
        logger.info(f"Projections arr shape: {proj_arr.shape}")
        logger.info(f"Coreset shape: (1, {str(coreset_modified.shape)[1:]}")
        logger.info(f"Sketch shape: (1, {str(self.fast_sketch.sketch.shape)[1:]}")
