...
class RecordingMediumDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tags", "languageOfPerformance", "isrc", "recordingPartyEntities", "genres", "releaseDate", "titles", "tracks", "musicalFeatures", "spotifyId", "genrePredictions"]
