...
class AdminApiCreateUserDTO(BaseModel):
    """
    ...
    trusted_to_set_ids: Optional[StrictBool] = Field(default=None, alias="trustedToSetIds")
    confirmed: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["password", "email", "fullName", "language", "isAdmin", "widgetsAllowed", "fullSearchAllowed", "voiceSearchAllowed", "recordingDetailAllowed", "artistDetailAllowed", "playlistPredictionAllowed", "signupAllowed", "uploadAllowed", "fingerprintAllowed", "audiotaggingAllowed", "insightsAllowed", "genresAllowed", "moodsAllowed", "instrumentationAllowed", "soundFeaturesAllowed", "tonalFeaturesAllowed", "rhythmFeaturesAllowed", "audienceAllowed", "originAllowed", "qualityAllowed", "b2bAllowed", "editorAllowed", "reducedMusicalFeatures", "trustedToSetIds", "confirmed"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "trustedToSetIds": obj.get("trustedToSetIds"),
