...
class SaveFileDTO(BaseModel):
    """
    Extensive details on a file object.  # noqa: E501
    """
    ...
    fingerprint_status: Optional[StrictStr] = Field(default=None, alias="fingerprintStatus")
    ...
    inference_status: Optional[StrictStr] = Field(default=None, alias="inferenceStatus")
    ...
    __properties: ClassVar[List[str]] = ["name", "folder", "extension", "objectKey", "customer", "uploadStartTime", "uploadEndTime", "fingerprintStatus", "fingerprintStartTime", "fingerprintEndTime", "inferenceStatus", "inferenceStartTime", "inferenceEndTime"]
