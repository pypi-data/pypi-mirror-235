...
class FileSmallDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "extension", "error_message", "folder", "fingerprintEndTime", "inferenceStatus", "inferenceStartTime", "inferenceEndTime", "error_time", "objectKey", "uploadStartTime", "uploadEndTime", "fingerprintStatus", "fingerprintStartTime"]
