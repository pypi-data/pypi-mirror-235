...
class AdminUsersControllerApi:
    ...
    def create_user(
        self,
        admin_api_create_user_dto: AdminApiCreateUserDTO,
        **kwargs,
    ) -> AdminApiUserDTO:
        ...
        >>> thread = api.create_user(admin_api_create_user_dto, async_req=True)
        >>> result = thread.get()

        :param admin_api_create_user_dto: (required)
        :type admin_api_create_user_dto: AdminApiCreateUserDTO
    ...
    def create_user_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.create_user_with_http_info(admin_api_create_user_dto, async_req=True)
        >>> result = thread.get()
        ...
        _body_params = None
        if _params['admin_api_create_user_dto'] is not None:
            _body_params = _params['admin_api_create_user_dto']
    ...
    def get_user(
        ...
        **kwargs,
        ...
        """show details of a user  # noqa: E501
        ...
        return self.get_user_with_http_info.raw_function(
            id,
            **kwargs,
        )
    ...
    def get_users(
        ...
        **kwargs,
        ...
        >>> thread = api.get_users(page, size, sort, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_users_with_http_info.raw_function(
            page,
            size,
            sort,
            **kwargs,
    ...
    def get_users_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_users_with_http_info(page, size, sort, async_req=True)
        >>> result = thread.get()
    ...
    def update_user(
        self,
        id: StrictInt,
        admin_api_update_user_dto: AdminApiUpdateUserDTO,
        **kwargs,
    ) -> AdminApiUserDTO:
        ...
        >>> thread = api.update_user(id, admin_api_update_user_dto, async_req=True)
        >>> result = thread.get()

        :param id: (required)
        :type id: int
        :param admin_api_update_user_dto: (required)
        :type admin_api_update_user_dto: AdminApiUpdateUserDTO
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
    ...
    def update_user_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.update_user_with_http_info(id, admin_api_update_user_dto, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['admin_api_update_user_dto'] is not None:
            _body_params = _params['admin_api_update_user_dto']
