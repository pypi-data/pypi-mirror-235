...
from songtradr_api_client_python.models.admin_api_update_user_dto import AdminApiUpdateUserDTO  # noqa: E501

class TestAdminApiUpdateUserDTO(unittest.TestCase):
    """AdminApiUpdateUserDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminApiUpdateUserDTO:
        """Test AdminApiUpdateUserDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminApiUpdateUserDTO`
        """
        model = AdminApiUpdateUserDTO()  # noqa: E501
        if include_optional:
            return AdminApiUpdateUserDTO(
                username = '',
                email = '',
                password = '',
                full_name = '',
    ...
    def testAdminApiUpdateUserDTO(self):
        """Test AdminApiUpdateUserDTO"""
