...
from songtradr_api_client_python.models.save_file_dto import SaveFileDTO  # noqa: E501

class TestSaveFileDTO(unittest.TestCase):
    """SaveFileDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveFileDTO:
        """Test SaveFileDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveFileDTO`
        """
        model = SaveFileDTO()  # noqa: E501
        if include_optional:
            return SaveFileDTO(
                name = '',
                folder = '',
