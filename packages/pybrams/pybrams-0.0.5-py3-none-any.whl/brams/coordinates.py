...
class GeocentricCoordinates:
    ...
    def __add__(self, o):
        ...
        return GeocentricCoordinates(self.x + o.x, self.y + o.y, self.z + o.z)
...
class Coordinates:
    ...
    dourbocentric: GeocentricCoordinates
    ...
    @staticmethod
    def geodetic2Geocentric(coordinates: GeodeticCoordinates) -> GeocentricCoordinates:
    ...
    @staticmethod
    def geodetic2Dourbocentric(geodetic: GeodeticCoordinates) -> GeocentricCoordinates:
        ...
        return GeocentricCoordinates(C3[1], C3[2], C3[0])
